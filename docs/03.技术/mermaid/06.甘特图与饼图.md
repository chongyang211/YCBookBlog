...
gantt
    ...
    section 基础建设
    项目初始化       :done, a1, 2025-01-01, 7d
    技术选型         :done, a2, after a1, 3d
    section 核心功能
    用户模块         :active, b1, 2025-01-10, 14d
    商品模块         :b2, 2025-01-10, 14d
    订单模块         :b3, after b1, 14d
    section 测试上线
    联调测试         :c1, 2025-02-07, 7d
    灰度发布         :c2, after c1, 3d
    正式上线         :milestone, c3, 2025-02-17, 0d
```
...
a1, 2025-01-01, 7d                       指定起始日期 + 持续天数

after a1, 5d                             在任务a1之后开始
until a2                                 直到任务a2完成时结束
2025-01-01, 2025-01-15                   起始→终止日期
```
...
gantt
    ...
    section 技术选型
    VuePress调研          :done,    t1, 2025-01-05, 3d
    ...
    Git系列撰写             :crit,    m2, 2025-01-20, 30d
...
> 🏃 下一篇：[其他图表合集](./07.其他图表合集.md)——脑图、时间线、用户旅程图、C4架构图、Git图、需求图、桑基图。
