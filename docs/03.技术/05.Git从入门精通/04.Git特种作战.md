...
---
# 第5章 · Git 特种作战：stash、cherry-pick、bisect 三件套

## 一、问题现场：我刚写到一半，Leader 让我立刻修 bug
...
## 三、武器二：`git cherry-pick`——精准移植一个 commit
...
## 四、武器三：`git bisect`——二分法定位引入 bug 的提交
...
## 六、武器五：`git reflog` 进阶——30 天的终极救生艇
