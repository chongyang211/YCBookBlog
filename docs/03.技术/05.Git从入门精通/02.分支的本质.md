...
---
# 第3章 · 分支：Git 的灵魂——像开平行宇宙一样开发

## 一、问题现场：两个火烧眉毛的任务同时砸过来
...
## 九、综合实战：一个完整的「feature + hotfix」双线开发
