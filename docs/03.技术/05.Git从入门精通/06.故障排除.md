...
---
# 第7章 · Git 故障排除：遇到报错不再慌的急诊手册

## 一、问题现场：周五下午 5 点半的连环崩溃
...
## 三、症状二：merge conflict 的五种场景及解决方案
...
## 六、症状五：`unrelated histories`——两个不认识的仓库
...
## 八、症状七：`already up to date` 但明明远程有新代码
