...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 Buffer Pool 太小引发的血案](#11-buffer-pool-太小引发的血案)
  - [1.2 为什么要深入存储引擎](#12-为什么要深入存储引擎)
- [02.什么是存储引擎](#02什么是存储引擎)
  - [2.1 存储引擎的职责](#21-存储引擎的职责)
  - [2.2 MySQL的插件式引擎架构](#22-mysql的插件式引擎架构)
  - [2.3 为什么InnoDB是默认引擎](#23-为什么innodb是默认引擎)
- [03.InnoDB存储架构](#03innodb存储架构)
  - [3.1 表空间的五层结构](#31-表空间的五层结构)
  - [3.2 表空间文件详解](#32-表空间文件详解)
  - [3.3 段Segment和区Extent](#33-段segment和区extent)
- [04.InnoDB数据页结构](#04innodb数据页结构)
  - [4.1 16KB页的完整布局](#41-16kb页的完整布局)
  - [4.2 页目录——页内二分查找](#42-页目录页内二分查找)
  - [4.3 记录格式——COMPACT与REDUNDANT](#43-记录格式compact与redundant)
  - [4.4 行溢出与BLOB页](#44-行溢出与blob页)
- [05.Buffer Pool——InnoDB的心脏](#05buffer-poolinnodb的心脏)
  - [5.1 Buffer Pool的三大链表](#51-buffer-pool的三大链表)
  - [5.2 冷热分离的LRU](#52-冷热分离的lru)
  - [5.3 预读机制](#53-预读机制)
  - [5.4 脏页刷新策略](#54-脏页刷新策略)
  - [5.5 Buffer Pool的预热](#55-buffer-pool的预热)
  - [5.6 多实例Buffer Pool](#56-多实例buffer-pool)
- [06.Change Buffer——写入加速器](#06change-buffer写入加速器)
  - [6.1 什么是Change Buffer](#61-什么是change-buffer)
  - [6.2 Change Buffer vs 直接写磁盘](#62-change-buffer-vs-直接写磁盘)
  - [6.3 Change Buffer的适用场景](#63-change-buffer的适用场景)
- [07.Double Write Buffer](#07double-write-buffer)
  - [7.1 为什么需要Double Write](#71-为什么需要double-write)
  - [7.2 Double Write的工作流程](#72-double-write的工作流程)
- [08.自适应哈希索引](#08自适应哈希索引)
  - [8.1 AHI的工作原理](#81-ahi的工作原理)
  - [8.2 AHI的开关与监控](#82-ahi的开关与监控)
- [09.InnoDB vs MyISAM](#09innodb-vs-myisam)
  - [9.1 八大维度对比](#91-八大维度对比)
  - [9.2 为什么MyISAM的COUNT快](#92-为什么myisam的count快)
  - [9.3 什么时候选MyISAM](#93-什么时候选myisam)
- [10.其他存储引擎速览](#10其他存储引擎速览)
  - [10.1 Memory引擎](#101-memory引擎)
  - [10.2 Archive引擎](#102-archive引擎)
  - [10.3 MySQL 8.0引擎新格局](#103-mysql-80引擎新格局)
- [11.综合案例大促前的Buffer Pool调优](#11综合案例大促前的buffer-pool调优)
  - [11.1 场景与排查](#111-场景与排查)
  - [11.2 调优方案与效果](#112-调优方案与效果)
...
## 05.Buffer Pool——InnoDB的心脏

### 5.1 Buffer Pool的三大链表
...
## 07.Double Write Buffer

### 7.1 为什么需要Double Write
