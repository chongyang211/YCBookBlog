...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 首页加载5秒——一条SQL引发的血案](#11-首页加载5秒一条sql引发的血案)
  - [1.2 为什么要学查询优化](#12-为什么要学查询优化)
- [02.EXPLAIN深度解读](#02explain深度解读)
  - [2.1 EXPLAIN是什么](#21-explain是什么)
  - [2.2 id——表的执行顺序](#22-id表的执行顺序)
  - [2.3 select_type——查询类型](#23-select_type查询类型)
  - [2.4 type——访问类型（最重要的字段）](#24-type访问类型最重要的字段)
  - [2.5 possible_keys与key——选了什么索引](#25-possible_keys与key选了什么索引)
  - [2.6 key_len——用了索引的多少字节](#26-key_len用了索引的多少字节)
  - [2.7 rows——估算扫描行数](#27-rows估算扫描行数)
  - [2.8 Extra——额外信息（第二重要的字段）](#28-extra额外信息第二重要的字段)
  - [2.9 EXPLAIN FORMAT=JSON——更精确的信息](#29-explain-formatjson更精确的信息)
- [03.慢查询日志](#03慢查询日志)
  - [3.1 开启与配置](#31-开启与配置)
  - [3.2 mysqldumpslow分析工具](#32-mysqldumpslow分析工具)
  - [3.3 pt-query-digest——慢查询之王](#33-pt-query-digest慢查询之王)
- [04.SQL优化实战——索引篇](#04sql优化实战索引篇)
  - [4.1 索引失效的排查清单](#41-索引失效的排查清单)
  - [4.2 JOIN优化](#42-join优化)
  - [4.3 ORDER BY与GROUP BY优化](#43-order-by与group-by优化)
  - [4.4 子查询优化](#44-子查询优化)
- [05.SQL优化实战——改写篇](#05sql优化实战改写篇)
  - [5.1 LIMIT 大偏移量优化](#51-limit-大偏移量优化)
  - [5.2 COUNT优化](#52-count优化)
  - [5.3 IN vs EXISTS](#53-in-vs-exists)
  - [5.4 分页查询的正确姿势](#54-分页查询的正确姿势)
  - [5.5 多值INSERT——批量写入加速](#55-多值insert批量写入加速)
- [06.查询优化器追踪](#06查询优化器追踪)
  - [6.1 Optimizer Trace——为什么选了全表扫描](#61-optimizer-trace为什么选了全表扫描)
  - [6.2 强制索引的边界](#62-强制索引的边界)
- [07.综合案例多表关联订单查询优化](#07综合案例多表关联订单查询优化)
  - [7.1 场景与原始SQL](#71-场景与原始sql)
  - [7.2 优化全流程](#72-优化全流程)
...
### 2.9 EXPLAIN FORMAT=JSON——更精确的信息
