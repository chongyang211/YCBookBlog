...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 加了一个索引查询反而变慢了](#11-加了一个索引查询反而变慢了)
  - [1.2 为什么要学数据库架构原理](#12-为什么要学数据库架构原理)
- [02.数据库的宏观架构](#02数据库的宏观架构)
  - [2.1 数据库是什么](#21-数据库是什么)
  - [2.2 MySQL的分层架构](#22-mysql的分层架构)
  - [2.3 一条SQL的完整生命周期](#23-一条sql的完整生命周期)
- [03.连接器——数据库的门卫](#03连接器数据库的门卫)
  - [3.1 连接是什么](#31-连接是什么)
  - [3.2 连接池与长连接](#32-连接池与长连接)
  - [3.3 连接的代价](#33-连接的代价)
- [04.解析器——SQL的翻译官](#04解析器sql的翻译官)
  - [4.1 词法分析](#41-词法分析)
  - [4.2 语法分析——AST抽象语法树](#42-语法分析ast抽象语法树)
  - [4.3 语法错误的代价](#43-语法错误的代价)
- [05.优化器——数据库的大脑](#05优化器数据库的大脑)
  - [5.1 优化器做什么](#51-优化器做什么)
  - [5.2 基于成本的优化CBO](#52-基于成本的优化cbo)
  - [5.3 优化器的经典陷阱](#53-优化器的经典陷阱)
  - [5.4 用EXPLAIN看懂优化器决策](#54-用explain看懂优化器决策)
- [06.执行器——SQL翻译成存储引擎操作](#06执行器sql翻译成存储引擎操作)
  - [6.1 执行器的工作](#61-执行器的工作)
  - [6.2 全表扫描vs索引扫描](#62-全表扫描vs索引扫描)
- [07.存储引擎——数据真正存在哪](#07存储引擎数据真正存在哪)
  - [7.1 InnoDB架构概览](#71-innodb架构概览)
  - [7.2 页——磁盘IO的最小单位](#72-页磁盘io的最小单位)
  - [7.3 Buffer Pool——热数据的避风港](#73-buffer-pool热数据的避风港)
  - [7.4 WAL与redo log](#74-wal与redo-log)
- [08.事务与ACID](#08事务与acid)
  - [8.1 什么是事务](#81-什么是事务)
  - [8.2 ACID拆解](#82-acid拆解)
  - [8.3 隔离级别与并发问题](#83-隔离级别与并发问题)
- [09.综合案例慢查询排查全链路](#09综合案例慢查询排查全链路)
  - [9.1 场景用户列表接口慢](#91-场景用户列表接口慢)
  - [9.2 排查→修复→知识图谱](#92-排查修复知识图谱)
- [10.思考题与作业](#10思考题与作业)
