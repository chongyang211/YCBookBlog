...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 一次崩溃后数据丢了](#11-一次崩溃后数据丢了)
  - [1.2 为什么要学日志系统](#12-为什么要学日志系统)
- [02.三种日志概述](#02三种日志概述)
  - [2.1 redo log / undo log / binlog 的职责](#21-redo-log--undo-log--binlog-的职责)
  - [2.2 三种日志的对比](#22-三种日志的对比)
  - [2.3 日志写在什么位置](#23-日志写在什么位置)
- [03.WAL机制](#03wal机制)
  - [3.1 为什么先写日志再写数据](#31-为什么先写日志再写数据)
  - [3.2 WAL的全流程](#32-wal的全流程)
  - [3.3 WAL的性能优势](#33-wal的性能优势)
- [04.Redo Log——持久性的守护者](#04redo-log持久性的守护者)
  - [4.1 Redo Log的结构](#41-redo-log的结构)
  - [4.2 Redo Log的写入流程](#42-redo-log的写入流程)
  - [4.3 Redo Log的循环写入](#43-redo-log的循环写入)
  - [4.4 Checkpoint机制](#44-checkpoint机制)
  - [4.5 组提交Group Commit](#45-组提交group-commit)
  - [4.6 Redo Log的三层缓冲区](#46-redo-log的三层缓冲区)
- [05.Binlog——主从复制的基石](#05binlog主从复制的基石)
  - [5.1 Binlog的三种格式](#51-binlog的三种格式)
  - [5.2 Binlog的写入时机——两阶段提交](#52-binlog的写入时机两阶段提交)
  - [5.3 Binlog vs Redo Log](#53-binlog-vs-redo-log)
- [06.Undo Log回顾](#06undo-log回顾)
  - [6.1 Undo Log的双重使命](#61-undo-log的双重使命)
  - [6.2 三种日志协同完成一次UPDATE](#62-三种日志协同完成一次update)
- [07.崩溃恢复完整流程](#07崩溃恢复完整流程)
  - [7.1 恢复的总流程](#71-恢复的总流程)
  - [7.2 Redo Log重放——已提交的必须恢复](#72-redo-log重放已提交的必须恢复)
  - [7.3 Undo Log回滚——未提交的必须撤销](#73-undo-log回滚未提交的必须撤销)
  - [7.4 三种崩溃场景分析](#74-三种崩溃场景分析)
- [08.综合案例机房断电后的恢复](#08综合案例机房断电后的恢复)
  - [8.1 场景与排查](#81-场景与排查)
