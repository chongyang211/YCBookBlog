...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 一次线上事故——库存超卖](#11-一次线上事故库存超卖)
  - [1.2 为什么要学事务原理](#12-为什么要学事务原理)
- [02.什么是事务](#02什么是事务)
  - [2.1 事务的定义](#21-事务的定义)
  - [2.2 为什么需要事务](#22-为什么需要事务)
  - [2.3 MySQL中如何开启事务](#23-mysql中如何开启事务)
- [03.ACID四大特性](#03acid四大特性)
  - [3.1 原子性Atomicity](#31-原子性atomicity)
  - [3.2 一致性Consistency](#32-一致性consistency)
  - [3.3 隔离性Isolation](#33-隔离性isolation)
  - [3.4 持久性Durability](#34-持久性durability)
  - [3.5 ACID的实现机制总览](#35-acid的实现机制总览)
- [04.并发事务的问题](#04并发事务的问题)
  - [4.1 脏读Dirty Read](#41-脏读dirty-read)
  - [4.2 不可重复读Non-Repeatable Read](#42-不可重复读non-repeatable-read)
  - [4.3 幻读Phantom Read](#43-幻读phantom-read)
  - [4.4 丢失更新Lost Update](#44-丢失更新lost-update)
  - [4.5 四种问题对比总结](#45-四种问题对比总结)
- [05.四种隔离级别](#05四种隔离级别)
  - [5.1 SQL标准定义](#51-sql标准定义的隔离级别)
  - [5.2 READ UNCOMMITTED 读未提交](#52-read-uncommitted-读未提交)
  - [5.3 READ COMMITTED 读已提交](#53-read-committed-读已提交)
  - [5.4 REPEATABLE READ 可重复读](#54-repeatable-read-可重复读)
  - [5.5 SERIALIZABLE 串行化](#55-serializable-串行化)
  - [5.6 InnoDB下RR的特殊表现](#56-innodb下rr的特殊表现)
- [06.MVCC多版本并发控制](#06mvcc多版本并发控制)
  - [6.1 MVCC的核心思想](#61-mvcc的核心思想)
  - [6.2 隐藏列与undo log](#62-隐藏列与undo-log)
  - [6.3 Read View——事务的快照](#63-read-view事务的快照)
  - [6.4 RC下的Read View](#64-rc下的read-view)
  - [6.5 RR下的Read View](#65-rr下的read-view)
  - [6.6 为什么RR能部分防幻读](#66-为什么rr能部分防幻读)
- [07.Undo Log——MVCC的基石](#07undo-logmvcc的基石)
  - [7.1 Undo Log的结构](#71-undo-log的结构)
  - [7.2 Undo Log的版本链](#72-undo-log的版本链)
  - [7.3 Undo Log的清理——purge线程](#73-undo-log的清理purge线程)
  - [7.4 长事务为什么是灾难](#74-长事务为什么是灾难)
- [08.隔离级别的选择](#08事务隔离级别的选择)
  - [8.1 隔离级别与并发性能的权衡](#81-隔离级别与并发性能的权衡)
  - [8.2 不同场景的选型](#82-不同场景的选型建议)
  - [8.3 查看与修改](#83-查看与修改隔离级别)
- [09.综合案例秒杀系统](#09综合案例秒杀系统的库存扣减)
  - [9.1 场景与问题分析](#91-场景与问题分析)
  - [9.2 五种方案对比](#92-五种方案对比)
