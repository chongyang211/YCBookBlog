...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 一个慢查询差点拖垮订单系统](#11-一个慢查询差点拖垮订单系统)
  - [1.2 为什么学了SQL还要学索引原理](#12-为什么学了sql还要学索引原理)
- [02.什么是索引](#02什么是索引)
  - [2.1 索引的本质](#21-索引的本质)
  - [2.2 索引的三种类比](#22-索引的三种类比)
  - [2.3 索引设计的核心权衡](#23-索引设计的核心权衡)
- [03.二分查找与二叉搜索树](#03二分查找与二叉搜索树)
...
- [04.B+Tree深度解析](#04btree深度解析)
  ...
  - [4.2 为什么是B+Tree而不是B-Tree](#42-为什么是btree而不是b-tree)
  - [4.3 为什么比红黑树更适合磁盘](#43-为什么比红黑树更适合磁盘)
  - [4.4 B+Tree的查找成本](#44-btree的查找成本)
  - [4.5 B+Tree的插入过程](#45-btree的插入过程)
  - [4.6 页分裂——最贵的操作](#46-页分裂最贵的操作)
  - [4.7 B+Tree的删除与页合并](#47-btree的删除与页合并)
- [05.聚簇索引与二级索引](#05聚簇索引与二级索引)
  - [5.1 聚簇索引——数据即索引](#51-聚簇索引数据即索引)
  - [5.2 二级索引——需要回表](#52-二级索引需要回表)
  - [5.3 回表的代价量化](#53-回表的代价量化)
  - [5.4 为什么建议用自增主键](#54-为什么建议用自增主键)
- [06.联合索引与最左前缀](#06联合索引与最左前缀)
  - [6.1 联合索引的物理结构](#61-联合索引的物理结构)
  - [6.2 最左前缀原理](#62-最左前缀原理)
  - [6.3 范围查询断点效应](#63-范围查询断点效应)
  - [6.4 索引字段顺序的设计原则](#64-索引字段顺序的设计原则)
- [07.覆盖索引与索引下推](#07覆盖索引与索引下推)
  - [7.1 覆盖索引——不回表的优化](#71-覆盖索引不回表的优化)
  - [7.2 索引下推ICP](#72-索引下推icp)
  - [7.3 MRR多范围读](#73-mrr多范围读)
- [08.Hash索引与自适应哈希](#08hash索引与自适应哈希)
  - [8.1 Hash索引的极致速度](#81-hash索引的极致速度)
  - [8.2 Hash索引的致命缺陷](#82-hash索引的致命缺陷)
  - [8.3 InnoDB自适应哈希索引](#83-innodb自适应哈希索引)
- [09.索引失效的十大场景](#09索引失效的十大场景)
  - [9.1 函数与运算导致失效](#91-函数与运算导致失效)
  - [9.2 隐式类型转换](#92-隐式类型转换)
  - [9.3 模糊查询左模糊](#93-模糊查询左模糊)
  - [9.4 十大场景速查表](#94-十大场景速查表)
- [10.优化器如何选索引](#10优化器如何选索引)
  - [10.1 基数Cardinality](#101-基数cardinality)
  - [10.2 优化器的选错与纠正](#102-优化器的选错与纠正)
  - [10.3 索引选择跟踪](#103-索引选择跟踪)
- [11.综合案例订单表索引优化](#11综合案例订单表索引优化)
