...
> 上一篇 [10.可测试性设计](https://yccoding.com/pages/24ae4b/) 让你的代码"可以验收"。  
...
🔗 配套延伸：[设计模式实战](https://yccoding.com//YCDesignBlog) | [yccoding.com](https://yccoding.com)
