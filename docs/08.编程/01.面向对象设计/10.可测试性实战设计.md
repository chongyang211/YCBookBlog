...
> 本篇是「面向对象设计」系列第 10 篇。  
> 上一篇 [09.重构十二式的实战](https://yccoding.com/pages/82ced2/) 教你"如何把烂代码救回来"。  
...
下一篇 [11.DDD与战术建模](https://yccoding.com/pages/d522e9/)——把 SOLID 推到限界上下文层级，用聚合根、领域事件、仓储等战术工具，让**业务的"形"决定代码的"型"**。本篇 §8.4 三道思考题答案，也将在下一篇 §0 揭晓。
