...
详见 [03.命令查询职责分离](https://yccoding.com/pages/arch-cqrs/)。
...
> **下一篇**：我们已经知道了"服务之间怎么通过事件解耦"，下一步进入 [05.微服务拆分策略](https://yccoding.com/pages/arch-micro/)——把"什么时候该拆、按什么维度拆、拆到多细"剖到决策树级别。
