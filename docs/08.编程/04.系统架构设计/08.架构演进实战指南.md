...
> **系列收官**：本系列从 [01.分层架构](https://yccoding.com/pages/e35f71/) 起步，经过 [02.六边形](https://yccoding.com/pages/f46f82/)、[03.CQRS](https://yccoding.com/pages/a57f93/)、[04.事件驱动](https://yccoding.com/pages/b68fa4/)、[05.微服务拆分](https://yccoding.com/pages/c79fb5/)、[06.DDD 战略](https://yccoding.com/pages/d8afc6/)、[07.架构评审](https://yccoding.com/pages/e9bfd7/)，到本篇收官——**架构设计的"知"与"行"完整闭环**。**架构不是终点，是与业务共同生长的工程哲学**。
