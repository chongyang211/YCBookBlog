...
> **系列收官**：本系列从 [01.分层架构](https://yccoding.com/pages/arch-layer/) 起步，经过 [02.六边形](https://yccoding.com/pages/arch-hex/)、[03.CQRS](https://yccoding.com/pages/arch-cqrs/)、[04.事件驱动](https://yccoding.com/pages/arch-event/)、[05.微服务拆分](https://yccoding.com/pages/arch-micro/)、[06.DDD 战略](https://yccoding.com/pages/arch-ddd/)、[07.架构评审](https://yccoding.com/pages/arch-review/)，到本篇收官——**架构设计的"知"与"行"完整闭环**。**架构不是终点，是与业务共同生长的工程哲学**。
