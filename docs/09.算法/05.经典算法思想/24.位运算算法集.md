---
title: 位运算算法集
date: 2018-01-06 15:28:52
permalink: /pages/7e86fd/
categories:
  - book
  - 通用技术的提升
  - 数据结构算法
...
> **回扣 [23.动态规划范式](https://yccoding.com/pages/c381b1/)**：那里讲了状压 DP 在背包、Grid 染色的应用；本篇用 TSP 补全状压 DP 三大代表（**旅行商 / 集合覆盖 / 状压排列**）。
...
- [23.DP](https://yccoding.com/pages/c381b1/)：状态 + 转移
- **24.位运算**：以上四种的"乘法器"
...
> 衔接下一篇 → [25.算法工程化案例](25.算法工程化案例.md)：把卷五五大经典算法思想（分治/贪心/回溯/DP/位运算）综合应用到三大工业系统——限流（令牌桶+滑窗位运算）+ 缓存（LRU+布隆+一致性哈希）+ 调度（拓扑+优先队列+状压），看看真实工程是怎样把这些范式编织到一起的。
