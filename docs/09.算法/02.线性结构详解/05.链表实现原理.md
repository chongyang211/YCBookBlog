...
- [05. 哈希加双链工业版](#05-哈希加双链工业版)
  ...
  - [5.3 Java容器设计实战](#53-java容器设计实战)
  - [5.4 C++容器设计实战](#54-c容器设计实战)
...
> LRU 是"链表 + 哈希"这个黄金组合的第一次亮相，但不是最后一次——下一篇《06.栈常见的操作实践》会切到另一种线性结构详解，但你会发现它底层仍然是**数组或链表的受限接口**：弹出+压入这对操作，看似简单，实则能撬动整个递归、表达式求值、浏览器历史、撤销重做等一大片世界。
