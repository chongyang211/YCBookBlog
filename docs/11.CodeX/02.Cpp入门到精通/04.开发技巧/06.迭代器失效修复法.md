...
> **下一篇**：本篇讲了"容器修改后旧句柄怎么办"，至此排查篇六件套（[01.信号崩溃快速排查](https://yccoding.com/pages/cppsignal/) → [02.ASan内存诊断](https://yccoding.com/pages/cpp-asan/) → [03.GDB命令速查表](https://yccoding.com/pages/cpp-gdb/) → [04.CoreDump破案实录](https://yccoding.com/pages/cpp-core/) → [05.perf火焰图速查](https://yccoding.com/pages/cpp-perf/) → 06.迭代器失效修复法）已经形成完整闭环：**事前阻断 → 现场调试 → 事后破案 → 持续优化 → 容器陷阱**。配套阅读：[01.进程地址空间布局](https://yccoding.com/pages/53783a/)（理解堆 buffer 何时 free、为何 glibc tcache 让 UAF 看起来"暂时正常"）。
