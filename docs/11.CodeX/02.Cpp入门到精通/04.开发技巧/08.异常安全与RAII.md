...
智能指针是 RAII 应用于"堆内存"的标准实现。详细选型请见 [07.智能指针选型指南](https://yccoding.com/pages/cpp-smart-ptr/)——本章只聚焦"异常安全"维度。
...
> **下一篇**：到此 [01.信号崩溃](https://yccoding.com/pages/cppsignal/) → [02.ASan内存](https://yccoding.com/pages/cpp-asan/) → [03.GDB速查](https://yccoding.com/pages/cpp-gdb/) → [04.CoreDump](https://yccoding.com/pages/cpp-core/) → [05.perf火焰](https://yccoding.com/pages/cpp-perf/) → [06.迭代器失效](https://yccoding.com/pages/cpp-iter-fail/) → [07.智能指针选型](https://yccoding.com/pages/cpp-smart-ptr/) → [08.异常安全与RAII](https://yccoding.com/pages/cpp-exception/)，**C++ 工程排查与设计八件套**形成完整闭环：从"怎么从信号定位行号"到"怎么从所有权设计杜绝泄漏"再到"怎么用 RAII 让异常路径也正确"。配套阅读：[01.进程地址空间布局](https://yccoding.com/pages/53783a/)（理解栈、堆的真实形状，所有 RAII 与异常展开都要落到这张图上）。
