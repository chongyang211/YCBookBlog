...
> **下一篇**：到此 [01.信号崩溃](https://yccoding.com/pages/cppsignal/) → [02.ASan内存](https://yccoding.com/pages/cpp-asan/) → [03.GDB速查](https://yccoding.com/pages/cpp-gdb/) → [04.CoreDump](https://yccoding.com/pages/cpp-core/) → [05.perf火焰](https://yccoding.com/pages/cpp-perf/) → [06.迭代器失效](https://yccoding.com/pages/cpp-iter-fail/) → [07.智能指针选型](https://yccoding.com/pages/cpp-smart-ptr/)，**C++ 工程排查七件套**形成完整闭环：从"怎么从信号定位行号"到"怎么从所有权设计杜绝泄漏"。配套阅读：[01.进程地址空间布局](https://yccoding.com/pages/53783a/)（理解栈、堆、共享内存的真实形状，所有权与释放都要落到这张图上）。
