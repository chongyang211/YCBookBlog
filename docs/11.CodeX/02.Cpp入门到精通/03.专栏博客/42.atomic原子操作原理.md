---
title: atomic原子操作原理
date: 2026-06-06 10:44:48
permalink: /pages/13cfe3/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：原子操作的指令说清了。下一篇进入 [43.mutex 与条件变量](https://yccoding.com/pages/6047f5/)——mutex 的底层 futex 实现原理、自旋锁 vs 阻塞锁的切换阈值、recursive_mutex 和 shared_mutex 的适用场景、condition_variable 的 spurious wakeup 根因与正确用法。
