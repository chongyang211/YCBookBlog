---
title: weak_ptr与this增强
date: 2026-06-06 08:12:52
permalink: /pages/57608b/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：this 的增强方案说清了。下一篇进入 [31.五种存储期管理](https://yccoding.com/pages/941edc/)——static/thread/automatic/dynamic/temporary 五种存储期的完整对比、静态局部变量的线程安全初始化机制（双重检查锁汇编）、TLS 在 Linux/Windows 的不同实现。
