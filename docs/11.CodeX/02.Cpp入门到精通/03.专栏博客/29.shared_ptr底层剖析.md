...
> **下一篇**：共享所有权的引用计数说清了。下一篇进入 [30.weak_ptr 与 this 增强](https://yccoding.com/pages/57608b/)——`enable_shared_from_this` 的 CRTP 实现细节、`weak_from_this` 的引入（C++17）、二级指针失效检测、Observer 场景的最佳实践。
