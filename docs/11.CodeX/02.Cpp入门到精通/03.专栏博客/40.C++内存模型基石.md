---
title: C++内存模型基石
date: 2026-06-06 10:32:57
permalink: /pages/47a1e2/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：CPU 缓存和 MESI 是硬件基础。下一篇进入 [41.六大内存序详解](https://yccoding.com/pages/f2c492/)——relaxed/consume/acquire/release/acq_rel/seq_cst 每种内存序的精确语义、happens-before 与 synchronizes-with 的证明、acquire-release 配对的正确姿势、什么时候用 relaxed 是安全的。
