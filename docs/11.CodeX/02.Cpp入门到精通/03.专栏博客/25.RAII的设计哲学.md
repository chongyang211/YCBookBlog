...
> **下一篇**：RAII 是资源管理的第一性原理。下一篇进入 [26.对象构造与析构](https://yccoding.com/pages/bf4d47/)——把 RAII 的「构造获取、析构释放」下沉到对象模型级别：基类和成员的构造析构顺序、初始化列表的本质、委托构造与继承构造的规则、三五法则里编译器到底帮你生成了什么。
