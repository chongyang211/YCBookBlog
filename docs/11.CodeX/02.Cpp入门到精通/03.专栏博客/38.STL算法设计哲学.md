...
> **下一篇**：算法设计哲学说清了。下一篇进入卷五收官篇 [39.Allocator 分配器机制](https://yccoding.com/pages/5ad73f/)——std::allocator 的内部流程、PMR polymorphic allocator、memory_resource 的多态分配、scoped_allocator——把容器的内存分配路径从头走一遍。
