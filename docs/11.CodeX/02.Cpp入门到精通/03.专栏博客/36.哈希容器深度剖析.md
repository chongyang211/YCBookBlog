...
> **下一篇**：哈希表的内部结构说清了。下一篇进入 [37.迭代器五大类别](https://yccoding.com/pages/2124e2/)——input/output/forward/bidirectional/random 五种 iterator tag 的分派机制、ranges 视图如何复合迭代器、迭代器失效的完整族谱。
