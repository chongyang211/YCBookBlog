---
title: deque分段连续设计
date: 2026-06-06 09:10:09
permalink: /pages/5940a6/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：deque 的两端操作魔法说清了。下一篇进入 [34.list 与 forward_list](https://yccoding.com/pages/8864cc/)——双向链表的节点布局与 splice O(1) 的奇技淫巧、为什么 list 有 sort 成员函数而 vector 没有、节点级分配器的定制。
