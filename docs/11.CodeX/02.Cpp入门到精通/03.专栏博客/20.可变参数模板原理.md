...
> **下一篇**：本篇我们把"运行时变长"压到了编译期。下一步进入 [21.constexpr编译期计算](https://yccoding.com/pages/5c3598/)——把"可变参之外的所有运行时计算"也搬到编译期，看看 C++20 的 constexpr 能走多远，从 std::sort 到 std::vector 全程编译期会发生什么。
