...
> **下一篇**：有序和有序说清了。下一篇进入 [36.哈希容器深度剖析](https://yccoding.com/pages/f26383/)——`unordered_map` 的拉链法与开放寻址、load_factor 与 rehash、哈希函数定制、Abseil flat_hash_map 为什么比标准 unordered_map 快 3×。
