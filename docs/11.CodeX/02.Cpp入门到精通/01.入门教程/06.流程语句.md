...
- [第 6 章 C++ 流程语句](#第-6-章-c-流程语句)
  ...
  - [6.6 思考题](#66-思考题)
  - [6.7 卷一改造增补：现代 C++ 流程控制三件套](#67-卷一改造增补现代-c-流程控制三件套)
    - [6.7.1 `if` / `switch` 带初始化语句（C++17）](#671-if--switch-带初始化语句c17)
    - [6.7.2 `if constexpr`（C++17）：编译期分支](#672-if-constexprc17编译期分支)
    - [6.7.3 结构化绑定（Structured Bindings, C++17）](#673-结构化绑定structured-bindings-c17)
    - [6.7.4 推荐阅读](#674-推荐阅读)
  - [6.8 新手陷阱 Top 5](#68-新手陷阱-top-5)
...
- 卷一 [`18.特性图谱`](https://yccoding.com/pages/5812d7/) §C++17 部分
- 卷一第 7 章 [`07.函数.md`](https://yccoding.com/pages/d2b384/) —— 多返回值与 tuple
