...
## 目录
- [1. 案例引入](#1-案例引入)
  - [1.1 一个"改了代码不生效"的线上事故](#11-一个改了代码不生效的线上事故)
...
- [3. Makefile 三要素](#3-makefile-三要素)
  - [3.1 目标、依赖、命令](#31-目标依赖命令)
  - [3.2 Make 的时间戳决策模型](#32-make-的时间戳决策模型)
  - [3.3 变量与条件判断](#33-变量与条件判断)
  - [3.4 .PHONY 与伪目标](#34-phony-与伪目标)
- [4. 自动变量与模式规则](#4-自动变量与模式规则)
  - [4.1 $@ $< $^ $? 四兄弟](#41---四兄弟)
  - [4.2 模式规则与隐式规则库](#42-模式规则与隐式规则库)
  - [4.3 递归 Make 的变量传递与陷阱](#43-递归-make-的变量传递与陷阱)
...
- [5. CMake 最小工程](#5-cmake-最小工程)
  ...
  - [5.3 生成器表达式与条件配置](#53-生成器表达式与条件配置)
  - [5.4 out-of-source build 的原理与收益](#54-out-of-source-build-的原理与收益)
...
- [7. 构建类型与交叉编译](#7-构建类型与交叉编译)
  - [7.1 Debug/Release/RelWithDebInfo/MinSizeRel](#71-debugreleaserelwithdebinfominsizerel)
  - [7.2 交叉编译工具链文件](#72-交叉编译工具链文件)
  - [7.3 多平台条件编译的最佳实践](#73-多平台条件编译的最佳实践)
...
### 5.4 out-of-source build 的原理与收益
