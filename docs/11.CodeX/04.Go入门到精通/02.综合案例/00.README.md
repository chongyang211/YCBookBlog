...
> 本卷是**卷一《语法卷》**的配套实战篇。学完卷一 18 章基础语法后，通过 **5 个循序渐进的项目**把散落的知识点串起来，形成"能独立写项目"的能力。其中 **05.静态博客生成引擎** 是"集大成的毕业设计"，一篇覆盖卷一全部 18 章。
...
| # | 案例 | 难度 | 预估时长 | 字数 | 主导领域 |
|---|------|------|---------|------|---------|
| 01 | [`gotodo` 命令行待办事项](https://yccoding.com/pages/cf3286/) | ⭐⭐ | 4 h | ~1.5 万 | CLI 工具 + JSON 持久化 |
| 02 | [`golog` 高性能日志分析流水线](https://yccoding.com/pages/98420a/) | ⭐⭐⭐ | 6 h | ~1.5 万 | 数据处理 + 流式 IO + 泛型 |
| 03 | [`goshort` 短链服务](https://yccoding.com/pages/b00ee4/) | ⭐⭐⭐ | 8 h | ~1.8 万 | HTTP 服务 + 并发安全 |
| 04 | [`gocron` 可观测的并发任务调度器](https://yccoding.com/pages/1bdea1/) | ⭐⭐⭐⭐ | 12 h | ~2 万 | 并发系统 + 中间件 |
| 05 | [`gosite` 静态博客生成器](https://yccoding.com/pages/005994/) 🎓 | ⭐⭐⭐⭐⭐ | 16-20 h | ~2.5 万 | 工程化全家桶（毕业设计） |
...
| 文件 | 行数预估 | 角色 |
|------|---------|------|
| [`01.终端待办任务清单.md`](https://yccoding.com/pages/cf3286/) | ~1500 | 案例 01 入门 |
| [`02.日志分析处理工具.md`](https://yccoding.com/pages/98420a/) | ~1500 | 案例 02 数据处理 |
| [`03.短链服务并发设计.md`](https://yccoding.com/pages/b00ee4/) | ~1800 | 案例 03 HTTP 服务 |
| [`04.并发任务调度引擎.md`](https://yccoding.com/pages/1bdea1/) | ~2000 | 案例 04 并发系统 |
| [`05.静态博客生成引擎.md`](https://yccoding.com/pages/005994/) | ~2500 | 案例 05 毕业设计 |
...
➡ 下一章：[案例 01 · `gotodo` 命令行待办事项管理器](https://yccoding.com/pages/cf3286/)
