...
- 第 4 章 [运算符](https://yccoding.com/pages/70de21/)（位运算、为什么没有指针算术）
- 第 5 章 [复合类型](https://yccoding.com/pages/dbb4ca/)（slice/map/struct 与字符串的呼应）

### 跨卷

- 卷三第 4 章 [字符串与切片底层](https://yccoding.com/pages/60504e/)（深挖 `stringStruct` 与零拷贝）
