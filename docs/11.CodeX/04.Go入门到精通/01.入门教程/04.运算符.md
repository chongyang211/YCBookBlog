...
- 第 3 章 [数据类型](https://yccoding.com/pages/21a7d7/)（整数、浮点的取值范围与零值）
- 第 5 章 [复合类型](https://yccoding.com/pages/dbb4ca/)（slice / map 为什么不可比较）
- 第 8 章 [指针与逃逸](https://yccoding.com/pages/b16981/)（`&` / `*` 的完整语义与逃逸分析）

### 跨卷

- 卷三第 4 章 [字符串与切片底层](https://yccoding.com/pages/60504e/)（`==` 在底层如何对比 `stringStruct`）
