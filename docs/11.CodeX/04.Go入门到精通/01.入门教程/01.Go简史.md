...
➡ 下一章：[第 2 章 基础语法与 Hello World](https://yccoding.com/pages/88a8fb/)
...
- 第 2 章 [基础语法与 Hello World](https://yccoding.com/pages/88a8fb/)
- 第 17 章 [工程化与模块](https://yccoding.com/pages/409ec3/)（go.mod / MVS 算法）
- 第 18 章 [特性图谱](https://yccoding.com/pages/5812d7/)（按版本与重要度索引）

### 跨卷

- 卷三第 6 章 [GMP 调度器原理](../03.专栏博客/06.GMP调度器原理.md)（讲清 1.14 异步抢占）
- 卷三第 7 章 [GC 三色标记演进](../03.专栏博客/07.GC三色标记演进.md)（讲清 1.5/1.8 GC 演进）
- 卷三第 11 章 [泛型与类型约束](https://yccoding.com/pages/1ccf26/)（讲清 1.18 泛型实现）
