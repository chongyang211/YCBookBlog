...
详见 [第 14 章 同步 sync 包](https://yccoding.com/pages/e36f54/)。
...
嵌入字段是 Go 实现"代码复用"的方式，不是继承——详见 [第 9 章](https://yccoding.com/pages/0f3c3e/)。
...
> ➡ 卷三第 4 章 [字符串与切片底层](https://yccoding.com/pages/60504e/) 详讲。
...
### 卷内
- 卷一第 7 章 [函数](https://yccoding.com/pages/d2b384/)（slice 作为参数）
- 卷一第 9 章 [结构体与方法](https://yccoding.com/pages/0f3c3e/)（struct 接收者）
- 卷一第 14 章 [同步 sync 包](https://yccoding.com/pages/e36f54/)（map 并发安全）
- 卷一第 16 章 [标准库与泛型](https://yccoding.com/pages/763a81/)（`slices` / `maps` 包）

### 跨卷
- 卷三第 3 章 [结构体与对齐](../03.专栏博客/03.结构体与对齐.md)
- 卷三第 4 章 [字符串与切片底层](https://yccoding.com/pages/60504e/)
