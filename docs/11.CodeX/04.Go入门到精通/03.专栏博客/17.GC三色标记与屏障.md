...
> **下一篇**：我们已经掌握了三色标记、三种写屏障、GC 演进史和 GOGC/GOMEMLIMIT 调优，下一步进入 [18.内存分配器深挖](https://yccoding.com/pages/7d8067/)——把 tcmalloc 思想的落地实现、size class 的 67 个等级、tiny allocator 的组合优化剖开。
