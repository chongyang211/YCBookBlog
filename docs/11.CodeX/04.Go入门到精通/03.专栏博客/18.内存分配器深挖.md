...
> **下一篇**：我们已经把 Go 分配器的四级结构、67 个 size class、三条分配路径和 mallocgc 主流程剖开，下一步进入 [19.defer延迟执行机制](19.defer延迟执行机制.md)——把 `_defer` 链表、栈分配 defer（1.13）、开放编码 defer（1.14+）的三代演进剖开。
