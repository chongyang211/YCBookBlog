...
#### 目录介绍
- [1. 案例与疑问引入](#1-案例与疑问引入)
  - [1.1 一个 JSON](#11-一个-json)
  - [1.2 顺藤摸到根因](#12-顺藤摸到根因)
  - [1.3 我们要回答什么](#13-我们要回答什么)
- [2. 架构全景概览](#2-架构全景概览)
  - [2.1 proto](#21-proto)
  - [2.2 为什么 JS 选](#22-为什么-js-选)
- [3. 属性查找算法](#3-属性查找算法)
  - [3.1 [[Get]]](#31-get)
  - [3.2 V8 隐藏类](#32-v8-隐藏类)
  - [3.3 hasOwnPr](#33-hasownpr)
- [4. new底层步骤](#4-new底层步骤)
  - [4.1 四步拆解 + 手](#41-四步拆解-手)
  - [4.2 构造函数返回对象](#42-构造函数返回对象)
  - [4.3 new.targ](#43-newtarg)
- [5. 五种继承演进](#5-五种继承演进)
  - [5.1 原型链继承 →](#51-原型链继承)
  - [5.2 为什么寄生组合是](#52-为什么寄生组合是)
- [6. class脱糖](#6-class脱糖)
  - [6.1 _classCa](#61-_classca)
  - [6.2 为什么 clas](#62-为什么-clas)
  - [6.3 class 字段](#63-class-字段)
- [7. super原理](#7-super原理)
  - [7.1 [[HomeOb](#71-homeob)
  - [7.2 construc](#72-construc)
  - [7.3 多重继承下 su](#73-多重继承下-su)
- [8. 属性描述符详解](#8-属性描述符详解)
  - [8.1 数据描述符 vs](#81-数据描述符-vs)
  - [8.2 freeze](#82-freeze)
  - [8.3 getter](#83-getter)
- [9. Mixin与安全](#9-mixin与安全)
  - [9.1 对象混入 vs](#91-对象混入-vs)
  - [9.2 原型污染攻击](#92-原型污染攻击)
  - [9.3 Object.c](#93-objectc)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 案例真相揭晓](#101-案例真相揭晓)
  - [10.2 实现 Vue-s](#102-实现-vue-s)
...
**下一步**：属性描述符有局限——检测不到新增和删除的属性。ES6 给了我们一个更强大的工具——Proxy 能拦截 13 种操作。进入 [07.Proxy 元编程与迭代协议](https://yccoding.com/pages/js-core-07/)。
