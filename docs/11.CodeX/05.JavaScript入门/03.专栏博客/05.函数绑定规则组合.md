...
#### 目录介绍
- [1. 案例引入](#1-案例引入)
  - [1.1 React 类组](#11-react-类组)
  - [1.2 顺藤摸到根因](#12-顺藤摸到根因)
  - [1.3 我们要回答什么](#13-我们要回答什么)
- [2. 架构概览](#2-架构概览)
  - [2.1 this 四规则](#21-this-四规则)
  - [2.2 为什么 JS 的](#22-为什么-js-的)
- [3. 默认绑定](#3-默认绑定)
  - [3.1 严格模式 thi](#31-严格模式-thi)
  - [3.2 为什么 V8 这](#32-为什么-v8-这)
- [4. 隐式绑定丢失](#4-隐式绑定丢失)
  - [4.1 赋值 / 回调](#41-赋值-回调)
  - [4.2 隐式丢失的根因](#42-隐式丢失的根因)
- [5. 显式绑定](#5-显式绑定)
  - [5.1 手写 call](#51-手写-call)
  - [5.2 手写 apply](#52-手写-apply)
  - [5.3 手写 bind](#53-手写-bind)
  - [5.4 bind 两次绑](#54-bind-两次绑)
- [6. new绑定](#6-new绑定)
  - [6.1 [[Constr](#61-constr)
  - [6.2 构造函数返回对象](#62-构造函数返回对象)
  - [6.3 手写 new 操](#63-手写-new-操)
- [7. 箭头词法this](#7-箭头词法this)
  - [7.1 箭头函数不自带](#71-箭头函数不自带)
  - [7.2 React 类组](#72-react-类组)
  - [7.3 箭头函数为什么不](#73-箭头函数为什么不)
- [8. 高阶函数](#8-高阶函数)
  - [8.1 map / fi](#81-map-fi)
  - [8.2 compose](#82-compose)
  - [8.3 用 compos](#83-用-compos)
- [9. 柯里化偏函数](#9-柯里化偏函数)
  - [9.1 柯里化 vs 偏](#91-柯里化-vs-偏)
  - [9.2 日志格式化器的柯](#92-日志格式化器的柯)
  - [9.3 尾调用优化（TCO）——V8 为什么放弃 TCO + trampoline 作为替代方案](#93-尾调用优化tcov8-为什么放弃-tco-trampoline-作为替代方案)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 案例真相揭晓](#101-案例真相揭晓)
  - [10.2 日志管线从 10](#102-日志管线从-10)
