...
- [6. 新生代 Scav](#6-新生代-scav)
  - [6.1 Cheney](#61-cheney)
  - [6.2 晋升条件（两轮存活](#62-晋升条件两轮存活)
  - [6.3 写屏障（Write](#63-写屏障write)
- [7. 老生代回收详解](#7-老生代回收详解)
  - [7.1 三色标记法全流程](#71-三色标记法全流程)
  - [7.2 增量标记与并发标记](#72-增量标记与并发标记)
  - [7.3 压缩（Compa](#73-压缩compa)
- [8. 并行回收Oilp](#8-并行回收oilp)
...
**下一步**：对象怎么存、怎么回收已经完全清楚了。那么 JS 的「类型系统」——为什么 `0.1 + 0.2 !== 0.3`？`[] == ![]` 为什么是 true？进入 [03.类型隐式转换精算](https://yccoding.com/pages/js-core-03/)。
