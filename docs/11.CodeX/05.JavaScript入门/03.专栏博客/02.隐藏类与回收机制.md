...
#### 目录介绍
- [1. 案例引入](#1-案例引入)
  - [1.1 同一构造函数的](#11-同一构造函数的)
  - [1.2 顺藤摸到根因](#12-顺藤摸到根因)
  - [1.3 我们要回答什么](#13-我们要回答什么)
- [2. 架构概览](#2-架构概览)
  - [2.1 V8 堆区全景图](#21-v8-堆区全景图)
  - [2.2 为什么要有新生代](#22-为什么要有新生代)
- [3. 隐藏类与Map](#3-隐藏类与map)
  - [3.1 隐藏类的变迁链规则](#31-隐藏类的变迁链规则)
  - [3.2 属性顺序实验](#32-属性顺序实验)
  - [3.3 隐藏类变迁的不可](#33-隐藏类变迁的不可)
- [4. 属性存储三态](#4-属性存储三态)
  - [4.1 In-object](#41-in-object)
  - [4.2 Fast 属性](#42-fast-属性)
  - [4.3 Slow/Dic](#43-slowdic)
  - [4.4 三态切换的条件与](#44-三态切换的条件与)
- [5. 元素六态](#5-元素六态)
  - [5.1 PACKED_S](#51-packed_s)
  - [5.2 HOLEY_SMI](#52-holey_smi)
  - [5.3 不可逆的退化路径](#53-不可逆的退化路径)
- [6. 新生代 Scavenge 回收](#6-新生代-scavenge-回收)
  - [6.1 Cheney](#61-cheney)
...
- [8. 并行回收Oilpan](#8-并行回收oilpan)
  - [8.1 V8 10.x](#81-v8-10x)
  - [8.2 Oilpan](#82-oilpan)
- [9. 编码启示与反模式](#9-编码启示与反模式)
  - [9.1 对隐藏类友好的代](#91-对隐藏类友好的代)
  - [9.2 导致 Eleme](#92-导致-eleme)
  - [9.3 短命对象 vs](#93-短命对象-vs)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 案例真相揭晓](#101-案例真相揭晓)
  - [10.2 一个对象从 ne](#102-一个对象从-ne)
