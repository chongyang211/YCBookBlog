...
**下一步**：闭包让函数记住了外部环境。但函数内部还有一个更诡的话题——**this**。为什么 `obj.method()` 和 `const fn = obj.method; fn()` 的 this 不一样？进入 [05.this 四规则与函数组合](https://yccoding.com/pages/js-core-05/)。
