...
#### 目录介绍
- [1. 案例引入](#1-案例引入)
  - [1.1 一张卡到 8fp](#11-一张卡到-8fp)
  - [1.2 顺藤摸到根因](#12-顺藤摸到根因)
  - [1.3 我们要回答什么](#13-我们要回答什么)
- [2. 架构概览](#2-架构概览)
  - [2.1 Critical](#21-critical)
  - [2.2 为什么分五步而不](#22-为什么分五步而不)
- [3. HTML到DOM](#3-html到dom)
  - [3.1 HTML 解析器](#31-html-解析器)
  - [3.2 脚本阻塞解析的精](#32-脚本阻塞解析的精)
  - [3.3 Document](#33-document)
- [4. CSS到CSSOM](#4-css到cssom)
  - [4.1 CSSOM 的构](#41-cssom-的构)
  - [4.2 从右向左匹配](#42-从右向左匹配)
  - [4.3 CSS 阻塞渲染](#43-css-阻塞渲染)
- [5. 渲染树合拢](#5-渲染树合拢)
  - [5.1 不可见元素的排除](#51-不可见元素的排除)
  - [5.2 伪元素在 Ren](#52-伪元素在-ren)
  - [5.3 RenderOb](#53-renderob)
- [6. 布局与重排](#6-布局与重排)
  - [6.1 包含块 + BF](#61-包含块-bf)
  - [6.2 布局脏位（Dirty Bit）——浏览器怎么知道该重新计算谁](#62-布局脏位dirty-bit浏览器怎么知道该重新计算谁)
  - [6.3 强制同步布局](#63-强制同步布局)
- [7. 绘制与合成](#7-绘制与合成)
  - [7.1 PaintLay](#71-paintlay)
  - [7.2 仅触发 Comp](#72-仅触发-comp)
  - [7.3 will-cha](#73-will-cha)
- [8. 事件系统](#8-事件系统)
  - [8.1 捕获 → 目标](#81-捕获-目标)
  - [8.2 addEvent](#82-addevent)
  - [8.3 passive](#83-passive)
- [9. 事件委托与 Observer 三剑客](#9-事件委托与-observer-三剑客)
  - [9.1 事件委托原理](#91-事件委托原理)
  - [9.2 Mutation](#92-mutation)
  - [9.3 批量 DOM 操](#93-批量-dom-操)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 案例真相揭晓](#101-案例真相揭晓)
  - [10.2 用 Perfor](#102-用-perfor)
