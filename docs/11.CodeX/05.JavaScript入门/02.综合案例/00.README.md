...
| # | 案例 | 难度 | 时长 | 字数 | 主导领域 |
|---|------|------|------|------|---------|
| 01 | [待办清单事件驱动](./01.待办清单事件驱动.md) | ⭐⭐ | 5 h | ~1.5 万 | DOM / 事件委托 / ESM / 命令模式 |
| 02 | [异步订阅流式解析](./02.异步订阅流式解析.md) | ⭐⭐⭐⭐ | 10 h | ~2 万 | Promise / fetch / 生成器 / 流式 |
| 03 | [视频播放器自实现](./03.视频播放器自实现.md) | ⭐⭐⭐⭐ | 12 h | ~2 万 | MSE / 视频流 / Canvas / Web API |
| 04 | [图表看板全栈开发](./04.图表看板全栈开发.md) 🎓 | ⭐⭐⭐⭐⭐ | 16 h | ~2.5 万 | Proxy 响应式 / Canvas / WebSocket / Worker（毕业设计） |
...
➡ 下一章：[案例 01 · 待办清单事件驱动](./01.待办清单事件驱动.md)
