...
> **阅读前置条件**：已学完卷一第 02、04、07、09、10、12、15 章；已完成案例 01 [待办清单事件驱动](https://yccoding.com/pages/js-case-jstodo/)。
>
...
点击以下条目即可跳转。
- [01. 项目最终效果展示](#01-项目最终效果展示)
- [02. 项目结构与启动](#02-项目结构与启动)
- [03. http.js · fetch 三件套：超时 / 重试 / 取消](#03-httpjs-fetch-三件套超时-重试-取消)
  - [3.1 fetch 为什](#31-fetch-为什)
  - [3.2 第一步：写最简版](#32-第一步写最简版)
  - [3.3 第二步：加上指数](#33-第二步加上指数)
- [04. errors.js · 自定义错误体系](#04-errorsjs-自定义错误体系)
  - [4.1 为什么不直接用](#41-为什么不直接用)
  - [4.2 写 errors](#42-写-errors)
  - [4.3 把 http.j](#43-把-httpj)
- [05. parser.js · 三种 Feed 格式解析](#05-parserjs-三种-feed-格式解析)
  - [5.1 为什么 Feed](#51-为什么-feed)
  - [5.2 写 parser](#52-写-parser)
  - [5.3 故意造 bug](#53-故意造-bug)
- [06. pipeline.js · 限流并发流水线](#06-pipelinejs-限流并发流水线)
  - [6.1 为什么不能 `P](#61-为什么不能-p)
  - [6.2 第一步：手写 p](#62-第一步手写-p)
  - [6.3 第二步：写 pi](#63-第二步写-pi)
  - [6.4 第三步：跑通](#64-第三步跑通)
  - [6.5 故意造 bug](#65-故意造-bug)
- [07. cache.js · 离线缓存与熔断器](#07-cachejs-离线缓存与熔断器)
  - [7.1 写 cache.](#71-写-cache)
  - [7.2 写一个最简熔断器](#72-写一个最简熔断器)
  - [7.3 把 cache](#73-把-cache)
- [08. pager.js · 异步生成器实现无限滚动](#08-pagerjs-异步生成器实现无限滚动)
  - [8.1 为什么用生成器](#81-为什么用生成器)
  - [8.2 写 pager.](#82-写-pager)
  - [8.3 接到 view](#83-接到-view)
  - [8.4 main.js](#84-mainjs)
- [09. streaming.js · 流式 reader 处理大文件](#09-streamingjs-流式-reader-处理大文件)
  - [9.1 为什么需要流](#91-为什么需要流)
  - [9.2 写 stream](#92-写-stream)
  - [9.3 接入 pipel](#93-接入-pipel)
- [10. 项目总结分析](#10-项目总结分析)
  - [10.1 整体目录结构（最](#101-整体目录结构最)
  - [10.2 异步演进三代对照](#102-异步演进三代对照)
  - [10.3 核心原理一句话总结](#103-核心原理一句话总结)
- [11. 项目技术思考](#11-项目技术思考)
  - [11.1 Promise.](#111-promise)
  - [11.2 为什么不用 Rx](#112-为什么不用-rx)
  - [11.3 为什么生成器在](#113-为什么生成器在)
- [12. 卷一章节反向索引](#12-卷一章节反向索引)
- [13. 衔接与延伸](#13-衔接与延伸)
  - [13.1 与下一案例 js](#131-与下一案例-js)
...
>
> ➡ 下一章：[案例 03 · 视频播放器自实现](https://yccoding.com/pages/js-case-jsplayer/)
