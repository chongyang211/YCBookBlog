...
### 3.3 Step 2.2：track / trigger 收集依赖
...
### 3.4 Step 2.3：故意造 bug —— Map vs WeakMap
...
### 4.2 Step 3.1：effect 嵌套与 activeEffect 栈
...
### 6.2 Step 5.1：LineChart 第一版（故意有 bug）
...
### 7.2 Step 6.1：HttpSource 复用 pLimit
...
### 7.4 Step 6.3：IndexedDB Promise 化封装
...
### 8.3 Step 7.2：Transferable 零拷贝修复
...
### 9.4 Step 8.3：Inspector 计 effect 次数
...
### 11.1 Map vs WeakMap：为什么响应式必须 WeakMap
...
### 11.2 Proxy vs Object.defineProperty：为什么 Vue 3 全面重写
...
### 11.3 EventTarget vs 自实现 EventEmitter：选型矩阵
...
### 11.4 ArrayBuffer 与 Transferable：Worker 性能的天花板
