...
- [01. 项目需求和功能](#01-项目需求和功能)
  ...
  - [1.3 模块分工说明](#13-模块分工说明)
  - [1.4 知识点速查](#14-知识点速查)
- [02. HTML 骨架与 ESM 入口](#02-html-骨架与-esm-入口)
  - [2.1 创建项目空文件](#21-创建项目空文件)
  - [2.2 写 index.](#22-写-index)
  - [2.3 写最小 main](#23-写最小-main)
  - [2.4 写一点点 CSS](#24-写一点点-css)
- [03. state.js 数据层](#03-statejs-数据层)
  - [3.1 为什么要单独建](#31-为什么要单独建)
  - [3.2 写第一版 sta](#32-写第一版-sta)
  - [3.3 在 main.j](#33-在-mainj)
- [04. view.js 静态渲染](#04-viewjs-静态渲染)
  - [4.1 为什么不用 in](#41-为什么不用-in)
  - [4.2 写第一版 vie](#42-写第一版-vie)
  - [4.3 在 main.j](#43-在-mainj)
- [05. 添加 todo](#05-添加-todo)
  - [5.1 为什么是 sub](#51-为什么是-sub)
  - [5.2 表单事件绑定](#52-表单事件绑定)
  - [5.3 接通 state](#53-接通-state)
- [06. 事件委托 - 删除与勾选](#06-事件委托-删除与勾选)
  - [6.1 故意造 bug](#61-故意造-bug)
  - [6.2 改成事件委托](#62-改成事件委托)
- [07. store.js 持久化](#07-storejs-持久化)
  - [7.1 为什么单独建 s](#71-为什么单独建-s)
  - [7.2 写 store.](#72-写-store)
  - [7.3 把 state.](#73-把-state)
- [08. 命令模式撤销重做](#08-命令模式撤销重做)
  - [8.1 为什么需要命令模式](#81-为什么需要命令模式)
  - [8.2 写 Comman](#82-写-comman)
  - [8.3 改造 main.](#83-改造-main)
- [09. 增量 DOM diff](#09-增量-dom-diff)
  - [9.1 为什么需要 di](#91-为什么需要-di)
  - [9.2 先测量再优化](#92-先测量再优化)
  - [9.3 改成增量 diff](#93-改成增量-diff)
- [10. 项目总结分析](#10-项目总结分析)
  - [10.1 整体目录结构（最](#101-整体目录结构最)
  - [10.2 核心原理一句话总结](#102-核心原理一句话总结)
  - [10.3 优缺点分析总结](#103-优缺点分析总结)
- [11. 项目技术思考](#11-项目技术思考)
  - [11.1 闭包 vs cl](#111-闭包-vs-cl)
  - [11.2 事件委托的代价](#112-事件委托的代价)
  - [11.3 命令模式 vs](#113-命令模式-vs)
...
export class DeleteCommand extends Command {
  ...
  undo() {
    ...
    // 真正容器设计实战会让 state 提供 "按指定 id 恢复" 的 API
...
>
> ➡ 下一章：[案例 02 · 异步订阅流式解析](https://yccoding.com/pages/js-case-jsfeed/)
