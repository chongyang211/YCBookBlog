...
- **前置阅读**：
  - [`卷三·01 渲染管线与原理`](01.渲染管线与原理.md)（动画本质是连续帧渲染）
  - [`卷三·03 卡顿捕获与归因`](03.卡顿捕获与归因.md)（交互延迟是卡顿的特殊场景）
- **本文核心命题**：
  > **动画 = 反馈快 + 帧顺滑 + 业务异步**。  
...
**代码**：见 [`卷三·02 §16.2`](02.FPS与帧率检测.md) 动态读刷新率。
...
**机理**：见 [`卷三·05 §13.2`](05.页面UI与布局优化.md) IdleHandler。
...
**代码**：见 [`卷二·06 §13.1`](../02.资源专项篇/06.IO与存储性能.md) StrictMode。
...
- [`卷三·01 渲染管线与原理`](01.渲染管线与原理.md)：动画的渲染基础
- [`卷三·02 FPS 与帧率检测`](02.FPS与帧率检测.md)：动画的量化
- [`卷三·03 卡顿捕获与归因`](03.卡顿捕获与归因.md)：交互延迟是卡顿特殊场景
- [`卷三·05 页面 UI 与布局优化`](05.页面UI与布局优化.md)：UI 优化是动画基础
- [`卷四·04 列表与滚动性能`](../04.业务专项篇/04.列表与滚动性能.md)：高频滚动专项
- [`卷二·06 IO 与存储性能`](../02.资源专项篇/06.IO与存储性能.md)：业务异步基础
