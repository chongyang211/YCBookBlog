---
title: WebView核心设计
date: 2025-03-19 16:19:15
permalink: /pages/2bf0f1/
categories:
  - book
  - Android提升进阶
  - 专栏博客
...
- [01.整体概述](#01整体概述)
    ...
    - [1.4 设计目标](#14-设计目标)
    - [1.5 收益分析](#15-收益分析)
- [02.WebView痛点](#02webview痛点)
    - [2.1 为何WebView难搞](#21-为何webview难搞)
    - [2.2 loadUrl过程复杂](#22-loadurl过程复杂)
    - [2.4 异常Error场景多](#24-异常error场景多)
    - [2.6 H5为何加载速度慢](#26-h5为何加载速度慢)
- [03.技术点分析](#03技术点分析)
    - [3.1 js交互介绍说明](#31-js交互介绍说明)
    - [3.2 Android调用Js](#32-android调用js)
    - [3.3 Js调用Android](#33-js调用android)
    - [3.4 Js交互方案对比](#34-js交互方案对比)
    - [3.5 Js调用时机分析](#35-js调用时机分析)
- [04.封装思路介绍](#04封装思路介绍)
    - [4.1 封装整体思路](#41-封装整体思路)
    - [4.2 封装功能介绍](#42-封装功能介绍)
    - [4.4 Native和Js交互](#44-native和js交互)
    - [4.5 缓存设计思路](#45-缓存设计思路)
    - [4.6 OkHttp缓存策略](#46-okhttp缓存策略)
    - [4.7 加载进度条设计](#47-加载进度条设计)
- [05.方案基础设计](#05方案基础设计)
    - [5.1 整体架构图](#51-整体架构图)
