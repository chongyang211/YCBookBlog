...
- [1. 急诊病例](#1-急诊病例)
  - [1.1 一次支付超时的连锁事故](#11-一次支付超时的连锁事故)
  - [1.2 catch(Exception) 出现 89 处](#12-catchexception-出现-89-处)
  - [1.3 本篇待答疑问](#13-本篇待答疑问)
- [2. 病理诊断](#2-病理诊断)
  - [2.1 错误处理的四大反模式](#21-错误处理的四大反模式)
  - [2.2 E01-E10 病案编号登记](#22-e01-e10-病案编号登记)
- [3. 病因追溯](#3-病因追溯)
  - [3.1 从吞异常到全链路失明](#31-从吞异常到全链路失明)
  - [3.2 错误码规范为何形同虚设](#32-错误码规范为何形同虚设)
- [4. 治疗方案总纲](#4-治疗方案总纲)
  - [4.1 异常/返回值/Result 三选一](#41-异常返回值result-三选一)
  - [4.2 边界防线三层布防](#42-边界防线三层布防)
- [5. 住院医查房](#5-住院医查房)
  - [5.1 别再返回 null 了](#51-别再返回-null-了)
  - [5.2 异常信息必须带上下文](#52-异常信息必须带上下文)
  - [5.3 初级带走清单](#53-初级带走清单)
- [6. 主治查房](#6-主治查房)
  - [6.1 Checked vs Unchecked 之争](#61-checked-vs-unchecked-之争)
  - [6.2 Result 类型与错误代数](#62-result-类型与错误代数)
  - [6.3 高级带走清单](#63-高级带走清单)
- [7. 主任查房](#7-主任查房)
  - [7.1 系统级错误契约设计](#71-系统级错误契约设计)
  - [7.2 事故文化与免责复盘](#72-事故文化与免责复盘)
  - [7.3 架构师带走清单](#73-架构师带走清单)
- [8. 术后康复曲线](#8-术后康复曲线)
  - [8.1 事故率 7/11→1/11 的变化](#81-事故率-7111的变化)
  - [8.2 MTTR 从 4 小时到 20 分钟](#82-mttr-从-4-小时到-20-分钟)
- [9. 病案归档](#9-病案归档)
  - [9.1 本篇病案编号 E01-E10](#91-本篇病案编号-e01-e10)
  - [9.2 关联病案索引](#92-关联病案索引)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 病例真相揭晓](#101-病例真相揭晓)
  - [10.2 一次异常的完整生命周期](#102-一次异常的完整生命周期)
...
**上一篇 ←** [第 03 篇 · 函数与职责](/pages/quality-03/) ｜ **下一篇 →** [第 05 篇 · 条件与多态](/pages/quality-05/)
