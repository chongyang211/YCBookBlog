...
- [1. 急诊病例](#1-急诊病例)
  - [1.1 78% 覆盖率的假象](#11-78-覆盖率的假象)
  - [1.2 一份"没有断言"的测试报告](#12-一份没有断言的测试报告)
  - [1.3 本篇待答疑问](#13-本篇待答疑问)
- [2. 病理诊断](#2-病理诊断)
  - [2.1 行/分支/路径/变异四种覆盖率](#21-行分支路径变异四种覆盖率)
  - [2.2 T01-T06 病案编号登记](#22-t01-t06-病案编号登记)
- [3. 病因追溯](#3-病因追溯)
  - [3.1 覆盖率 KPI 化的堕落](#31-覆盖率-kpi-化的堕落)
  - [3.2 "写测试是为了通过 CI"](#32-写测试是为了通过-ci)
- [4. 治疗方案总纲](#4-治疗方案总纲)
  - [4.1 覆盖率的正确使用姿势](#41-覆盖率的正确使用姿势)
  - [4.2 变异测试作为质量哨兵](#42-变异测试作为质量哨兵)
- [5. 住院医查房](#5-住院医查房)
  - [5.1 一个好断言长什么样](#51-一个好断言长什么样)
  - [5.2 AAA 与 FIRST 原则](#52-aaa-与-first-原则)
  - [5.3 初级带走清单](#53-初级带走清单)
- [6. 主治查房](#6-主治查房)
  - [6.1 从行覆盖到分支覆盖](#61-从行覆盖到分支覆盖)
  - [6.2 PIT 变异测试实战](#62-pit-变异测试实战)
  - [6.3 高级带走清单](#63-高级带走清单)
- [7. 主任查房](#7-主任查房)
  - [7.1 测试策略的战略地位](#71-测试策略的战略地位)
  - [7.2 覆盖率 SLO 与预算](#72-覆盖率-slo-与预算)
  - [7.3 架构师带走清单](#73-架构师带走清单)
- [8. 术后康复曲线](#8-术后康复曲线)
  - [8.1 有效覆盖率的真实提升](#81-有效覆盖率的真实提升)
  - [8.2 引入变异测试后的收益](#82-引入变异测试后的收益)
- [9. 病案归档](#9-病案归档)
  - [9.1 本篇病案编号 T01-T06](#91-本篇病案编号-t01-t06)
  - [9.2 关联病案索引](#92-关联病案索引)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 病例真相揭晓](#101-病例真相揭晓)
  - [10.2 一个测试用例的诞生](#102-一个测试用例的诞生)
...
**上一篇 ←** [第 07 篇 · 静态分析度量](/pages/quality-07/) ｜ **下一篇 →** [第 09 篇 · 技术债量化](/pages/quality-09/)
