...
- [1. 急诊病例](#1-急诊病例)
  - [1.1 47 个 else if 的优惠计算](#11-47-个-else-if-的优惠计算)
  - [1.2 一次改动引发的超发事故](#12-一次改动引发的超发事故)
  - [1.3 本篇待答疑问](#13-本篇待答疑问)
- [2. 病理诊断](#2-病理诊断)
  - [2.1 条件式失控的六种形态](#21-条件式失控的六种形态)
  - [2.2 F15-F20 病案编号登记](#22-f15-f20-病案编号登记)
- [3. 病因追溯](#3-病因追溯)
  - [3.1 "再加一个 if 就好了"的陷阱](#31-再加一个-if-就好了的陷阱)
  - [3.2 缺失抽象的业务表达](#32-缺失抽象的业务表达)
- [4. 治疗方案总纲](#4-治疗方案总纲)
  - [4.1 从 if-else 到策略模式](#41-从-if-else-到策略模式)
  - [4.2 五种条件重构手法地图](#42-五种条件重构手法地图)
- [5. 住院医查房](#5-住院医查房)
  - [5.1 卫语句代替嵌套 if](#51-卫语句代替嵌套-if)
  - [5.2 分解条件表达式](#52-分解条件表达式)
  - [5.3 初级带走清单](#53-初级带走清单)
- [6. 主治查房](#6-主治查房)
  - [6.1 以多态取代条件式](#61-以多态取代条件式)
  - [6.2 策略/责任链/规则引擎选型](#62-策略责任链规则引擎选型)
  - [6.3 高级带走清单](#63-高级带走清单)
- [7. 主任查房](#7-主任查房)
  - [7.1 抽象等级与团队协作成本](#71-抽象等级与团队协作成本)
  - [7.2 何时该拒绝"加一个 if"](#72-何时该拒绝加一个-if)
  - [7.3 架构师带走清单](#73-架构师带走清单)
- [8. 术后康复曲线](#8-术后康复曲线)
  - [8.1 分支数 47→7 的曲线](#81-分支数-477-的曲线)
  - [8.2 新增券种上线时间对比](#82-新增券种上线时间对比)
- [9. 病案归档](#9-病案归档)
  - [9.1 本篇病案编号](#91-本篇病案编号)
  - [9.2 关联病案索引](#92-关联病案索引)
- [10. 综合案例串讲](#10-综合案例串讲)
  - [10.1 病例真相揭晓](#101-病例真相揭晓)
  - [10.2 一张券的生命历程](#102-一张券的生命历程)
...
**上一篇 ←** [第 04 篇 · 错误与边界](/pages/quality-04/) ｜ **下一篇 →** [第 06 篇 · 遗留代码急救](/pages/quality-06/)
