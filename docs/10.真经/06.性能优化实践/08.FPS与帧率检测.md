...
- **前置阅读**：
  - [`卷三·01 渲染管线与原理`](https://yccoding.com/pages/4553ff/)（FPS 是流水线的产出度量）
  - [`卷三·03 卡顿捕获与归因`](https://yccoding.com/pages/b16f1c/)（卡顿是 FPS 抖动的极端形态）
- **本文核心命题**：
...
**机理**：无 Vsync 请求时帧回调不触发，需配合卡顿监控（[`卷三·03`](https://yccoding.com/pages/b16f1c/)）。
...
- [`卷三·01 渲染管线与原理`](https://yccoding.com/pages/4553ff/)：FPS 是流水线的产出度量
- [`卷三·03 卡顿捕获与归因`](https://yccoding.com/pages/b16f1c/)：卡顿是 FPS 抖动的极端形态
- [`卷三·04 ANR 监控与治理`](https://yccoding.com/pages/3c584b/)：极端长帧（5s+）的处理
- [`卷三·05 页面 UI 与布局优化`](https://yccoding.com/pages/1069cc/)：UI 优化的应用层落地
- [`卷三·06 动画交互响应优化`](https://yccoding.com/pages/87faf2/)：交互动效专项
- [`卷四·05 功耗与电量优化`](https://yccoding.com/pages/98337a/)：高刷的能耗代价

---

> **下一篇预告**：[`卷三·06 动画交互响应优化`](https://yccoding.com/pages/87faf2/) —— 把"用户操作到画面响应"的最后一公里做好。
