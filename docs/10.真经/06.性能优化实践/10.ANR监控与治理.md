...
[`卷四·01 §14.3`](https://yccoding.com/pages/b3414a/) 已述。**核心思想**：
...
| 场景 | 应对 |
|---|---|
| 启动 hang | 优化启动期（[`卷四·01`](https://yccoding.com/pages/b3414a/)）|
...
**收益**：详见 [`卷四·01 §13`](https://yccoding.com/pages/b3414a/)。冷启动篇的金融 App 案例 4.2s→1.4s 直接降低 D 类 ANR。
...
提出**统一假设**："SDK 分级 init + 主线程减负"（同 [`卷四·01 §18.2`](https://yccoding.com/pages/b3414a/) 案例）。
