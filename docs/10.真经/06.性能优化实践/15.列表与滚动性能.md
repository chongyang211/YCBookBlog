...
- **前置阅读**：[`卷三·01 渲染管线原理`](../03.流水线专项/01.渲染管线原理.md)、[`卷四·03 图片性能解码优化`](https://yccoding.com/pages/babc84/)
- **本文核心命题**：
...
- 第 4 层（图片治理 §16）：滚动期暂停解码（[`卷四·03 §6.4`](https://yccoding.com/pages/babc84/)），停止后批量加载。
...
**机理**：避免加载比 ImageView 实际尺寸大几倍的高清图（详见 [`卷四·03 §6.2`](https://yccoding.com/pages/babc84/)）。
