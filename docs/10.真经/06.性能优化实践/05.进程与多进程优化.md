...
- **前置阅读**：
  - [`卷二·04 线程模型与调度优化`](https://yccoding.com/pages/218aca/)（进程 vs 线程的对比）
  - [`卷二·03 OOM 异常与低内存治理`](https://yccoding.com/pages/ea200a/)（多进程是 OOM 隔离重要手段）
...
- 见 [`卷四·01 冷启动`](https://yccoding.com/pages/b3414a/)
...
**代码**：见 [`卷四·01`](https://yccoding.com/pages/b3414a/) 冷启动篇分级初始化策略。
...
- [`卷二·04 线程模型与调度优化`](https://yccoding.com/pages/218aca/)：进程 vs 线程的对比
- [`卷二·03 OOM 异常与低内存治理`](https://yccoding.com/pages/ea200a/)：多进程是 OOM 隔离重要手段
- [`卷四·01 App 冷启动优化`](https://yccoding.com/pages/b3414a/)：进程启动开销是冷启大头
- [`卷三·04 ANR 监控与治理`](https://yccoding.com/pages/3c584b/)：跨进程同步 IPC 是 ANR 常见原因
- [`卷四·05 功耗与电量优化`](https://yccoding.com/pages/98337a/)：保活伤电池

---

> **下一篇预告**：[`卷二·06 IO 与存储性能`](https://yccoding.com/pages/d9c9d8/) —— 让"持久化"不成为性能瓶颈。
