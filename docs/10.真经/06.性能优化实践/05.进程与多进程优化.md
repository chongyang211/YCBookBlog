...
- 见 [`卷四·01 冷启动`](https://yccoding.com/pages/perf/)
...
**代码**：见 [`卷四·01`](https://yccoding.com/pages/perf/) 冷启动篇分级初始化策略。
...
- [`卷二·04 线程模型与调度优化`](https://yccoding.com/pages/218aca/)：进程 vs 线程的对比
- [`卷二·03 OOM 异常与低内存治理`](https://yccoding.com/pages/ea200a/)：多进程是 OOM 隔离重要手段
- [`卷四·01 App 冷启动优化`](https://yccoding.com/pages/perf/)：进程启动开销是冷启大头
