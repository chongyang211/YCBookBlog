...
- **前置阅读**：
  - [`卷一·02 稳定性专项建设`](https://yccoding.com/pages/d892d4/)（崩溃是稳定性的具体形式）
- **本文核心命题**：
...
- **机理**：见 [`卷一·02 §5.5`](https://yccoding.com/pages/d892d4/) 错误聚合粒度。
...
- 用分级初始化（详见 [`卷四·01`](https://yccoding.com/pages/b3414a/)）异步化。
