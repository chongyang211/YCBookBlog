...
- [8.CAS技术总结](#8cas-技术总结)
  ...
  - [8.3 局限性剖析](#83-局限性剖析)
- [9.案例驱动：CAS 的实战陷阱](#9案例驱动cas-的实战陷阱)
  - [9.1 案例：AtomicInteger双11热点](#91-案例atomicinteger双11热点)
  - [9.2 案例：ABA事故与无锁栈崩溃](#92-案例aba事故与无锁栈崩溃)
  - [9.3 案例：C++ memory_order选错导致race](#93-案例c-memory_order选错导致race)
- [10.CAS 与现代并发原语的关系](#10cas-与现代并发原语的关系)
  - [10.1 CAS 是无锁世界的基石](#101-cas-是无锁世界的基石)
  - [10.2 与未来：CAS-2 与多字 CAS](#102-与未来cas-2-与多字-cas)
- [11.设计哲学：CAS教会我们三件事](#11设计哲学cas教会我们三件事)
  - [11.1 乐观主义在工程中的胜利](#111-乐观主义在工程中的胜利)
  - [11.2 硬件抽象的下沉](#112-硬件抽象的下沉)
  - [11.3 简单接口背后的精密配合](#113-简单接口背后的精密配合)
- [12.跨语言 CAS 陷阱速查表](#12跨语言-cas-陷阱速查表)
- [13.七字真言 × 多语言映射](#13七字真言-多语言映射)
- [14.一句话终极总结](#14一句话终极总结)
