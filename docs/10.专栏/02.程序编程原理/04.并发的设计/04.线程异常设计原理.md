...
- [11.一句话总结](#11一句话总结)
- [12.事故复盘：异常吞噬的代价](#12事故复盘异常吞噬的代价)
  - [12.1 案例：吞噬NPE让DB静默错乱](#121-案例吞噬npe让db静默错乱)
  - [12.2 案例：finally报异常掩盖原始](#122-案例finally报异常掩盖原始)
  - [12.3 案例：Go panic跨goroutine不传染](#123-案例go-panic跨goroutine不传染)
- [13.结构化异常处理的未来](#13结构化异常处理的未来)
  - [13.1 结构化并发自动汇集异常](#131-结构化并发自动汇集异常)
  - [13.2 错误代数：Result/Either/Try](#132-错误代数resulteithertry)
  - [13.3 跨语言线程异常陷阱速查表](#133-跨语言线程异常陷阱速查表)
  - [13.4 七字真言 × 多语言映射](#134-七字真言--多语言映射)
