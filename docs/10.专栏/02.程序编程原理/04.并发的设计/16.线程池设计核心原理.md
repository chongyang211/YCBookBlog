...
- [02.ThreadPoolExecutor源码级解剖](#02threadpoolexecutor源码级解剖)
- [03.execute流程的三段论设计](#03execute流程的三段论设计)
- [04.Worker内部类：复用与不可重入](#04worker内部类复用与不可重入)
- [05.状态流转：5状态4转换状态机](#05状态流转5状态4转换状态机)
...
| 真言（来自 §8.3） | Java JUC | Go (runtime + worker pool) | Netty EventLoop | Tomcat StandardThreadExecutor | .NET ThreadPool | Python concurrent.futures |
|---|---|---|---|---|---|---|
