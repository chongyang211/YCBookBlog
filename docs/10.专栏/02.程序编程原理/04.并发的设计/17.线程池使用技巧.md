...
#### 目录介绍
- [01.从一次大促前夜的事故说起](#01从一次大促前夜的事故说起)
  - [1.1 一行Executors引发的雪崩](#11-一行executors引发的雪崩)
  - [1.2 三个被忽视的本质问题](#12-三个被忽视的本质问题)
- [02.快速了解线程池](#02快速了解线程池)
  - [2.1 学习本节课目标](#21-学习本节课目标)
  - [2.2 为什么不能直接new Thread](#22-为什么不能直接new-thread)
  - [2.3 定量看创建线程的成本](#23-定量看创建线程的成本)
  - [2.4 线程数与吞吐量的量化关系](#24-线程数与吞吐量的量化关系)
  - [2.5 线程池解决了哪几个问题](#25-线程池解决了哪几个问题)
  - [2.6 线程池的优势](#26-线程池的优势)
  - [2.7 线程池业务类型](#27-线程池业务类型)
  - [2.8 本节课问题思考](#28-本节课问题思考)
- [03.线程池核心类](#03线程池核心类)
  - [3.1 线程池设计架构](#31-线程池设计架构)
  - [3.2 线程创建规则设计](#32-线程创建规则设计)
  - [3.3 线程池管理器](#33-线程池管理器)
  - [3.4 任务队列设计](#34-任务队列设计)
  - [3.5 线程工厂设计](#35-线程工厂设计)
  - [3.6 拒绝策略设计](#36-拒绝策略设计)
  - [3.7 理解线程优化级](#37-理解线程优化级)
  - [3.8 线程池整体架构图](#38-线程池整体架构图)
- [04.ThreadPoolExecutor](#04threadpoolexecutor)
  - [4.1 ThreadPoolExecutor参数](#41-threadpoolexecutor参数)
  - [4.2 ThreadPoolExecutor使用](#42-threadpoolexecutor使用)
  - [4.3 execute和submit区别](#43-execute和submit区别)
  - [4.4 CPU密集型线程池](#44-cpu密集型线程池)
  - [4.5 IO密集型线程池](#45-io密集型线程池)
  - [4.6 各种线程池类用途](#46-各种线程池类用途)
- [05.四种线程池类说明](#05四种线程池类说明)
  - [5.1 newFixedThreadPool](#51-newfixedthreadpool)
  - [5.2 newCachedThreadPool](#52-newcachedthreadpool)
  - [5.3 newScheduledThreadPool](#53-newscheduledthreadpool)
  - [5.4 newSingleThreadExecutor](#54-newsinglethreadexecutor)
  - [5.5 newWorkStealingPool](#55-newworkstealingpool)
  - [5.6 线程池如何选择](#56-线程池如何选择)
  - [5.7 如何给线程赋予名字](#57-如何给线程赋予名字)
  - [5.8 线程池状态获取](#58-线程池状态获取)
...
- [07.一句话总结与决策清单](#07一句话总结与决策清单)
  ...
  - [7.2 生产级决策清单（拿走即用）](#72-生产级决策清单拿走即用)
  - [7.3 七大反模式生产事故TOP7](#73-七大反模式生产事故top7)
  - [7.4 跨语言调优速查（不只 Java！）](#74-跨语言调优速查不只-java)
  - [7.5 跨语言线程池调优陷阱速查表](#75-跨语言线程池调优陷阱速查表)
  - [7.6 七字真言 × 多语言调优映射表](#76-七字真言--多语言调优映射表)
  - [7.7 进阶阅读](#77-进阶阅读)
