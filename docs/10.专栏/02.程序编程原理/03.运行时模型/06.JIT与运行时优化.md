...
> 🔗 **延伸阅读**：← [2.5 字节码虚拟机执行](./05.字节码虚拟机执行.md) · → [2.7 反射元编程核心设计](./07.反射元编程核心设计.md) · → [2.8 异常机制核心设计](./08.异常机制核心设计.md) · → [4.x 缓存局部性原理](../05.内存的真相/)
...
这就是 [2.7 反射元编程核心设计](./07.反射元编程核心设计.md) 要回答的——**当程序需要在运行时操纵自身的结构**，会发生什么、付出什么代价。

---

## 🔗 延伸阅读

- 同卷上篇：[2.5 字节码虚拟机执行](./05.字节码虚拟机执行.md)
- 同卷下篇：[2.7 反射元编程核心设计](./07.反射元编程核心设计.md) ｜ [2.8 异常机制核心设计](./08.异常机制核心设计.md)
