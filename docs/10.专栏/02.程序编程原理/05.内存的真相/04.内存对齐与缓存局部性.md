...
- [02.Cache Line：缓存最小搬运单位](#02cache-line缓存最小搬运单位)
- [03.内存对齐：硬件隐形税](#03内存对齐硬件隐形税)
- [04.伪共享：多核隐形杀手](#04伪共享多核隐形杀手)
- [05.数据布局优化的工程实践](#05数据布局优化的工程实践)
- [06.跨语言对照与Disruptor案例](#06跨语言对照与disruptor案例)
...
### 6.6 五语言 Cache Line / 对齐 API 入口速查表
