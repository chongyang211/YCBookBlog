...
- [10.综合案例串讲：图片浏览 App 的内存全景设计](#10综合案例串讲图片浏览-app-的内存全景设计)
- [11.一句话总结](#11一句话总结)
...
### 10.7 L5：虚引用——Bitmap native 堆的终极兜底
