...
> 🔗 **延伸阅读**：← [15.并发编程设计思想](./15.并发编程设计思想.md) · ← [16.并发Bug源头由来](./16.并发Bug源头由来.md) · → [32.堆和栈内存的设计](./32.堆和栈内存的设计.md) · → [33.内存回收机制设计](./33.内存回收机制设计.md)
...
- → [32.堆和栈内存的设计](./32.堆和栈内存的设计.md)：深入第一层契约的"栈vs堆"取舍
- → [33.内存回收机制设计](./33.内存回收机制设计.md)：堆区如何自动回收（GC 算法）
- ↘ [15.并发编程设计思想](./15.并发编程设计思想.md)：第二层契约的应用范式
- ↘ [16.并发Bug源头由来](./16.并发Bug源头由来.md)：本章 §0 NPE 的同类陷阱合集
- ↘ [17.并发编程安全设计](./17.并发编程安全设计.md)：volatile/锁/无锁三大流派
- ↘ [20.理解CAS设计由来](./20.理解CAS设计由来.md)：memory_order 在硬件 CAS 上的落地
