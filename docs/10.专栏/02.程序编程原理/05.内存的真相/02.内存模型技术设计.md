...
- [07.并发内存模型核心](#07并发内存模型核心)
  - [7.1 happens-before 偏序关系](#71-happens-before-偏序关系)
  - [7.2 volatile 的真正语义](#72-volatile-的真正语义)
  - [7.3 final 的内存语义](#73-final-的内存语义)
  - [7.4 C++ memory_order 六档](#74-c-memory_order-六档)
  - [7.5 跨语言并发内存模型对照](#75-跨语言并发内存模型对照)
- [08.经典陷阱与反模式](#08经典陷阱与反模式)
  - [8.1 OOM 五大类型](#81-oom-五大类型)
  - [8.2 内存泄漏三大场景](#82-内存泄漏三大场景)
  - [8.3 误区 双重检查锁](#83-误区-双重检查锁)
  - [8.4 误区 ThreadLocal 不清理](#84-误区-threadlocal-不清理)
- [09.一句话总结与全卷收束](#09一句话总结与全卷收束)
