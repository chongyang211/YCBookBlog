...
- **前置阅读**：
  ...
  - [`卷二·01 CPU 监控与分析`](https://yccoding.com/pages/af0b85/)
- **本文核心命题**：
...
按 [`卷零·02 §3`](https://yccoding.com/pages/42e7bc/) 的统一指标体系，内存问题应使用以下组合：
...
回到 [`卷零·01`](https://yccoding.com/pages/perf/) 的"资源 × 时间 × 流水线"模型，内存恰好在 **资源（空间）+ 时间（生命周期）** 两个维度同时存在问题。
