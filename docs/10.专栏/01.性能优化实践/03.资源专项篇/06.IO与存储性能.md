...
- **前置阅读**：
  - [`卷二·02 内存监控与治理`](https://yccoding.com/pages/01936d/)（mmap 是内存与 IO 的桥梁）
  - [`卷二·03 OOM 异常与低内存治理`](https://yccoding.com/pages/ea200a/)（IO 与 mmap 共享地址空间）
- **本文核心命题**：
...
**收益**：见 [`卷四·02 §6.1 策略 1.4`](https://yccoding.com/pages/8c546c/)。
...
- [`卷二·02 内存监控与治理`](https://yccoding.com/pages/01936d/)：mmap 是内存与 IO 的桥梁
- [`卷二·03 OOM 异常与低内存治理`](https://yccoding.com/pages/ea200a/)：mmap 共享地址空间
- [`卷二·04 线程模型调度优化`](https://yccoding.com/pages/218aca/)：IO 必须异步线程
- [`卷三·04 ANR 监控与治理`](https://yccoding.com/pages/3c584b/)：IO 是 ANR 的高频根因
- [`卷四·01 App 冷启动优化`](https://yccoding.com/pages/b3414a/)：启动期 IO 是大头
- [`卷四·05 功耗与电量优化`](https://yccoding.com/pages/98337a/)：IO 频次直接影响功耗
