...
- **前置阅读**：
  - [`卷三·01 渲染管线与原理`](https://yccoding.com/pages/4553ff/)（UI 优化是渲染优化的应用层落地）
  - [`卷三·03 卡顿捕获与归因`](https://yccoding.com/pages/b16f1c/)（UI 卡顿的归因）
- **本文核心命题**：
...
无论 View / UIView / DOM / LVGL Object，UI 都是一棵树。Measure / Layout / Draw / Compose 都是树形递归算法。**节点数越多，单帧成本越高**（详见 [`卷三·01 §5.1`](https://yccoding.com/pages/4553ff/) 实验）。
...
UI 操作必须在主线程（详见 [`卷三·01 §2.1`](https://yccoding.com/pages/4553ff/)）。这意味着：
...
使用系统提供的"阶段级"数据，看 Layout / Draw / Sync 各阶段耗时（详见 [`卷三·01 §3.1`](https://yccoding.com/pages/4553ff/)）。**所有应用线上监控的核心方案**。
...
- [`卷三·01 渲染管线与原理`](https://yccoding.com/pages/4553ff/)：UI 优化的渲染基础
- [`卷三·02 FPS 与帧率检测`](https://yccoding.com/pages/9a6e5d/)：UI 性能的量化
- [`卷三·03 卡顿捕获与归因`](https://yccoding.com/pages/b16f1c/)：UI 卡顿归因
- [`卷三·04 ANR 监控与治理`](https://yccoding.com/pages/3c584b/)：极端卡顿
- [`卷三·06 动画交互响应优化`](https://yccoding.com/pages/87faf2/)：交互动效专项
- [`卷四·04 列表与滚动性能`](https://yccoding.com/pages/598e44/)：列表专项

---

> **下一篇预告**：[`卷三·06 动画交互响应优化`](https://yccoding.com/pages/87faf2/) —— 把"用户感知流畅"的最后一公里做好。
