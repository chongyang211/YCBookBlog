...
permalink: /pages/html-link-resource/
categories:
  - book
  - Web开发和进阶
  - HTML工具手册
...
> 合并原 09.<a>链接 + 10.link资源：<a>标签(href/target/rel/download/邮件/电话链接)、<link>标签(样式表/图标/预加载preload/prefetch/preconnect/dns-prefetch)。
