...
> **专栏完结**。回顾 8 篇：[01.TS类型系统基础](https://yccoding.com/pages/ts-basics/) → [02.TS接口与对象类型](https://yccoding.com/pages/ts-interface/) → [03.TS函数与类实战](https://yccoding.com/pages/ts-function-class/) → [04.TS泛型编程实战](https://yccoding.com/pages/ts-generics/) → [05.TS高级类型编程](https://yccoding.com/pages/ts-advanced-types/) → [06.TS类型守卫机制](https://yccoding.com/pages/ts-type-guards/) → [07.TS模块系统详解](https://yccoding.com/pages/ts-modules/) → [08.TS工程配置实践](https://yccoding.com/pages/ts-config/)
