...
- [7.1 基本概念](#71-基本概念)
  ...
  - [7.1.5 优点和缺点](#715-优点和缺点)
- [7.2 信号与槽使用](#72-信号与槽使用)
  - [7.2.1 声明信号与槽](#721-声明信号与槽)
  - [7.2.2 连接信号与槽](#722-连接信号与槽)
  - [7.2.3 Lambda表达式](#723-lambda表达式)
- [7.3 信号与槽特性](#73-信号与槽特性)
  - [7.3.1 自动连接](#731-自动连接)
  - [7.3.2 参数传递](#732-参数传递)
  - [7.3.3 多对多连接](#733-多对多连接)
  - [7.3.4 断开连接](#734-断开连接)
- [7.4 跨线程通信](#74-跨线程通信)
  - [7.4.1 连接类型](#741-连接类型)
  - [7.4.2 跨线程通信案例](#742-跨线程通信案例)
- [7.5 信号槽和事件](#75-信号槽和事件)
  - [7.5.1 两者关系](#751-两者关系)
- [7.5 信号槽综合案例](#75-信号槽综合案例)
  - [7.5.1 项目结构](#751-项目结构)
  - [7.5.2 代码实现](#752-代码实现)
  - [7.5.3 运行结果](#753-运行结果)
  - [7.5.4 代码解析](#754-代码解析)
  - [7.5.5 断开连接](#755-断开连接)
  - [7.5.6 综合案例总结](#756-综合案例总结)
