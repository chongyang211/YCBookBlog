...
- [5.2 协议支持](#52-协议支持)
  - [5.2.1 QUrl](#521-qurl)
  - [5.2.2 QUrlQuery](#522-qurlquery)
  - [5.2.3 QHostInfo](#523-qhostinfo)
  - [5.2.4 QNetworkInterface](#524-qnetworkinterface)
- [5.3 序列化与数据格式](#53-序列化与数据格式)
  - [5.3.1 二进制序列化](#531-二进制序列化)
  - [5.3.2 JSON序列化](#532-json序列化)
  - [5.3.3 XML序列化](#533-xml序列化)
  - [5.3.4 自定义序列化](#534-自定义序列化)
  - [5.3.5 序列化总结](#535-序列化总结)
