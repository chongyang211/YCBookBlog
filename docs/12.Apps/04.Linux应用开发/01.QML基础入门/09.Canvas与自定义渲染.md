...
#### 目录介绍
- [9.1 案例引入](#91-案例引入)
  - [9.1.1 实时心电图从 30Hz 掉到 5Hz](#911-实时心电图从-30hz-掉到-5hz)
  - [9.1.2 揭开谜底：Canvas FBO 重绘代价](#912-揭开谜底canvas-fbo-重绘代价)
  - [9.1.3 本章要回答的三个问题](#913-本章要回答的三个问题)
- [9.2 Canvas 2D 绘制引擎](#92-canvas-2d-绘制引擎)
  - [9.2.1 Context2D API 全景](#921-context2d-api-全景)
  - [9.2.2 FBO 离屏缓冲与纹理上传](#922-fbo-离屏缓冲与纹理上传)
  - [9.2.3 Canvas 性能特性与缓存策略](#923-canvas-性能特性与缓存策略)
  - [9.2.4 综合案例：音频频谱波形](#924-综合案例音频频谱波形)
- [9.3 Shape 矢量路径](#93-shape-矢量路径)
  - [9.3.1 ShapePath 的 GPU 加速矢量渲染](#931-shapepath-的-gpu-加速矢量渲染)
  - [9.3.2 Shape vs Canvas 性能对比](#932-shape-vs-canvas-性能对比)
- [9.4 QQuickPaintedItem 命令式渲染](#94-qquickpainteditem-命令式渲染)
  - [9.4.1 QPainter API 与 FBO 路径](#941-qpainter-api-与-fbo-路径)
  - [9.4.2 从 Qt Widget 迁移的适配策略](#942-从-qt-widget-迁移的适配策略)
- [9.5 自定义 QQuickItem + QSGNode](#95-自定义-qquickitem--qsgnode)
  - [9.5.1 updatePaintNode 的零拷贝路径](#951-updatepaintnode-的零拷贝路径)
  - [9.5.2 QSGGeometry 顶点缓冲直接写入](#952-qsggeometry-顶点缓冲直接写入)
  - [9.5.3 线程安全的脏标记与渲染同步](#953-线程安全的脏标记与渲染同步)
- [9.6 综合实战：200Hz 实时心电波形](#96-综合实战200hz-实时心电波形)
- [9.7 三种路径对比与选型](#97-三种路径对比与选型)
- [9.8 本章新手陷阱 Top 5](#98-本章新手陷阱-top-5)
- [9.9 训练题](#99-训练题)
- [9.10 速查表](#910-速查表)
...
## 9.4 QQuickPaintedItem 命令式渲染

### 9.4.1 QPainter API 与 FBO 路径
...
## 9.5 自定义 QQuickItem + QSGNode

### 9.5.1 updatePaintNode 的零拷贝路径
