...
#### 目录介绍
- [12.1 案例引入](#121-案例引入)
    - [12.1.1 x86 完美运行的代码在 ARM 板黑屏](#1211-x86-完美运行的代码在-arm-板黑屏)
    - [12.1.2 根因分析](#1212-根因分析)
    - [12.1.3 三大问题](#1213-三大问题)
- [12.2 交叉编译原理](#122-交叉编译原理)
    - [12.2.1 Host → Target 编译链路](#1221-host-target-编译链路)
    - [12.2.2 Qt 交叉编译的特殊性](#1222-qt-交叉编译的特殊性)
- [12.3 构建交叉编译 Qt](#123-构建交叉编译-qt)
    - [12.3.1 sysroot 准备](#1231-sysroot-准备)
    - [12.3.2 设备配置与编译](#1232-设备配置与编译)
    - [12.3.3 多平台 CMake 集成](#1233-多平台-cmake-集成)
- [12.4 部署到 ARM 设备](#124-部署到-arm-设备)
    - [12.4.1 最小依赖检查](#1241-最小依赖检查)
    - [12.4.2 Qt 插件部署](#1242-qt-插件部署)
    - [12.4.3 自包含打包](#1243-自包含打包)
- [12.5 OTA 远程更新](#125-ota-远程更新)
- [12.6 综合实战：Raspberry Pi 4 部署全流程](#126-综合实战raspberry-pi-4-部署全流程)
- [12.7 新手陷阱](#127-新手陷阱)
- [12.8 训练题](#128-训练题)
- [12.9 速查表](#129-速查表)
...
## 12.6 综合实战：Raspberry Pi 4 部署全流程
