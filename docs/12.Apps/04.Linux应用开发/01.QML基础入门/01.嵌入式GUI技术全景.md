...
- [1.1 案例引入](#11-案例引入)
    ...
    - [1.1.3 核心问题](#113-核心问题)
- [1.2 GUI本质](#12-gui本质)
    - [1.2.1 嵌入式定位](#121-嵌入式定位)
    - [1.2.2 嵌入式差异](#122-嵌入式差异)
    - [1.2.3 硬件基础](#123-硬件基础)
- [1.3 方案对比](#13-方案对比)
    - [1.3.1 裸机方案](#131-裸机方案)
    - [1.3.2 LVGL 方案](#132-lvgl-方案)
    - [1.3.3 Qt Widgets](#133-qt-widgets)
    - [1.3.4 Qt QML](#134-qt-qml)
    - [1.3.5 HTML5 方案](#135-html5-方案)
    - [1.3.6 Flutter 方案](#136-flutter-方案)
- [1.4 选型评估](#14-选型评估)
    - [1.4.1 六维评估](#141-六维评估)
    - [1.4.2 决策树](#142-决策树)
    - [1.4.3 场景推荐](#143-场景推荐)
- [1.5 Qt 全景](#15-qt-全景)
    - [1.5.1 模块家族](#151-模块家族)
    - [1.5.2 Qt5 与 Qt6](#152-qt5-与-qt6)
    - [1.5.3 设计哲学](#153-设计哲学)
- [1.6 渲染概览](#16-渲染概览)
    - [1.6.1 从代码到像素](#161-从代码到像素)
    - [1.6.2 批处理原理](#162-批处理原理)
    - [1.6.3 与 HTML5 对比](#163-与-html5-对比)
- [1.7 运行环境](#17-运行环境)
    - [1.7.1 QPA 层](#171-qpa-层)
    - [1.7.2 EGLFS 后端](#172-eglfs-后端)
    - [1.7.3 LinuxFB 后端](#173-linuxfb-后端)
    - [1.7.4 Wayland 后端](#174-wayland-后端)
- [1.8 生态能力](#18-生态能力)
    - [1.8.1 硬件通信](#181-硬件通信)
    - [1.8.2 多媒体](#182-多媒体)
    - [1.8.3 网络 OTA](#183-网络-ota)
    - [1.8.4 数据存储](#184-数据存储)
- [1.9 完整示例](#19-完整示例)
    - [1.9.1 项目结构](#191-项目结构)
    - [1.9.2 CMake 配置](#192-cmake-配置)
    - [1.9.3 入口代码](#193-入口代码)
    - [1.9.4 QML 界面](#194-qml-界面)
    - [1.9.5 交叉编译](#195-交叉编译)
- [1.10 学习路径](#110-学习路径)
    - [1.10.1 十周路径](#1101-十周路径)
    - [1.10.2 选型速查](#1102-选型速查)
    - [1.10.3 专栏路线](#1103-专栏路线)
