...
#### 目录介绍
- [1.1 案例引入](#11-案例引入)
  - [1.1.1 一个嵌入式项目的 GUI 选型困境](#111-一个嵌入式项目的-gui-选型困境)
  - [1.1.2 五大主流方案的"第一印象"](#112-五大主流方案的第一印象)
  - [1.1.3 本文要回答的核心问题](#113-本文要回答的核心问题)
- [1.2 嵌入式 GUI 的本质](#12-嵌入式-gui-的本质)
  - [1.2.1 GUI 在嵌入式中的定位](#121-gui-在嵌入式中的定位)
  - [1.2.2 嵌入式与桌面 GUI 的本质差异](#122-嵌入式与桌面-gui-的本质差异)
  - [1.2.3 图形渲染的硬件基础](#123-图形渲染的硬件基础)
- [1.3 主流技术方案深度对比](#13-主流技术方案深度对比)
  - [1.3.1 裸机方案：直接操作 Framebuffer](#131-裸机方案直接操作-framebuffer)
  - [1.3.2 LVGL：轻量级嵌入式图形库](#132-lvgl轻量级嵌入式图形库)
  - [1.3.3 Qt Widgets：传统桌面控件体系](#133-qt-widgets传统桌面控件体系)
  - [1.3.4 Qt QML：声明式 GPU 加速界面](#134-qt-qml声明式-gpu-加速界面)
  - [1.3.5 HTML5/Electron：Web 技术栈方案](#135-html5electronweb-技术栈方案)
  - [1.3.6 Flutter Embedded：跨平台新势力](#136-flutter-embedded跨平台新势力)
- [1.4 选型决策与量化评估](#14-选型决策与量化评估)
  - [1.4.1 六维评估模型](#141-六维评估模型)
  - [1.4.2 选型决策树](#142-选型决策树)
  - [1.4.3 典型场景推荐](#143-典型场景推荐)
- [1.5 Qt/QML 技术栈全景](#15-qtqml-技术栈全景)
  - [1.5.1 Qt 框架模块家族](#151-qt-框架模块家族)
  - [1.5.2 Qt5 vs Qt6 核心差异](#152-qt5-vs-qt6-核心差异)
  - [1.5.3 QML 的设计哲学](#153-qml-的设计哲学)
- [1.6 QML 渲染管线概览](#16-qml-渲染管线概览)
  - [1.6.1 从 .qml 文件到屏幕像素](#161-从-qml-文件到屏幕像素)
  - [1.6.2 Scene Graph 批处理原理](#162-scene-graph-批处理原理)
  - [1.6.3 QML vs HTML5 渲染管线对比](#163-qml-vs-html5-渲染管线对比)
- [1.7 嵌入式运行环境](#17-嵌入式运行环境)
  - [1.7.1 QPA 平台抽象层](#171-qpa-平台抽象层)
  - [1.7.2 EGLFS：无窗口系统的 GPU 渲染](#172-eglfs无窗口系统的-gpu-渲染)
  - [1.7.3 LinuxFB：纯软件渲染退路](#173-linuxfb纯软件渲染退路)
  - [1.7.4 Wayland：现代合成器方案](#174-wayland现代合成器方案)
- [1.8 QML 嵌入式生态能力](#18-qml-嵌入式生态能力)
  - [1.8.1 硬件通信（串口/CAN/GPIO）](#181-硬件通信串口cangpio)
  - [1.8.2 多媒体（摄像头/音视频）](#182-多媒体摄像头音视频)
  - [1.8.3 网络与 OTA 升级](#183-网络与-ota-升级)
  - [1.8.4 数据库与本地存储](#184-数据库与本地存储)
- [1.9 完整项目示例](#19-完整项目示例)
  - [1.9.1 项目结构](#191-项目结构)
  - [1.9.2 CMakeLists.txt](#192-cmakeliststxt)
  - [1.9.3 main.cpp](#193-maincpp)
  - [1.9.4 QML 界面](#194-qml-界面)
  - [1.9.5 交叉编译与运行](#195-交叉编译与运行)
- [1.10 学习路径与速查表](#110-学习路径与速查表)
  - [1.10.1 从 0 到 1 的十周路径](#1101-从-0-到-1-的十周路径)
  - [1.10.2 技术选型速查表](#1102-技术选型速查表)
  - [1.10.3 本专栏路线图](#1103-本专栏路线图)
