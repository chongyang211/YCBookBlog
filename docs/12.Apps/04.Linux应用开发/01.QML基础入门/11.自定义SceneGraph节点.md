...
#### 目录介绍
- [11.1 案例引入](#111-案例引入)
    - [11.1.1 摄像头预览在 ARM 板上只 8fps](#1111-摄像头预览在-arm-板上只-8fps)
    - [11.1.2 根因分析](#1112-根因分析)
    - [11.1.3 三大问题](#1113-三大问题)
- [11.2 QSGNode 体系深化](#112-qsgnode-体系深化)
    - [11.2.1 节点类型与生命周期](#1121-节点类型与生命周期)
    - [11.2.2 树状结构与子节点挂载](#1122-树状结构与子节点挂载)
    - [11.2.3 preprocess 与节点变换](#1123-preprocess-与节点变换)
- [11.3 自定义 QQuickItem + updatePaintNode 全流程](#113-自定义-qquickitem-updatepaintnode-全流程)
    - [11.3.1 节点复用与资源管理](#1131-节点复用与资源管理)
    - [11.3.2 QSGGeometry 顶点缓冲深入](#1132-qsggeometry-顶点缓冲深入)
    - [11.3.3 综合案例：实时频谱柱状图](#1133-综合案例实时频谱柱状图)
- [11.4 自定义材质与着色器](#114-自定义材质与着色器)
    - [11.4.1 QSGMaterial 体系](#1141-qsgmaterial-体系)
    - [11.4.2 QSGMaterialShader 着色器编写](#1142-qsgmaterialshader-着色器编写)
    - [11.4.3 uniform 传递与 compare 批处理合并](#1143-uniform-传递与-compare-批处理合并)
    - [11.4.4 综合案例：发光矩形自定义材质](#1144-综合案例发光矩形自定义材质)
- [11.5 零拷贝纹理渲染](#115-零拷贝纹理渲染)
    - [11.5.1 createTextureFromNativeObject 原理](#1151-createtexturefromnativeobject-原理)
    - [11.5.2 摄像头帧到 QML 的完整链路](#1152-摄像头帧到-qml-的完整链路)
    - [11.5.3 综合案例：摄像头实时预览](#1153-综合案例摄像头实时预览)
- [11.6 综合实战：粒子系统](#116-综合实战粒子系统)
- [11.7 线程安全与脏标记](#117-线程安全与脏标记)
- [11.8 新手陷阱](#118-新手陷阱)
- [11.9 训练题](#119-训练题)
- [11.10 速查表](#1110-速查表)
...
## 11.3 自定义 QQuickItem + updatePaintNode 全流程
...
### 11.4.2 QSGMaterialShader 着色器编写
...
### 11.4.3 uniform 传递与 compare 批处理合并
...
### 11.5.1 createTextureFromNativeObject 原理
