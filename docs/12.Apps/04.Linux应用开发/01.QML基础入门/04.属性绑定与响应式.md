...
#### 目录介绍
- [4.1 案例引入](#41-案例引入)
  - [4.1.1 一个"绑定被吃掉"的神秘 Bug](#411-一个绑定被吃掉的-mystery-bug)
  - [4.1.2 揭开谜底：赋值覆盖绑定](#412-揭开谜底赋值覆盖绑定)
  - [4.1.3 本章要回答的三个问题](#413-本章要回答的三个问题)
- [4.2 绑定机制原理](#42-绑定机制原理)
  - [4.2.1 依赖收集：引擎如何"读取你的意图"](#421-依赖收集引擎如何读取你的意图)
  - [4.2.2 脏标记与惰性求值](#422-脏标记与惰性求值)
  - [4.2.3 绑定与赋值的底层冲突](#423-绑定与赋值的底层冲突)
  - [4.2.4 综合案例：验证依赖收集三阶段](#424-综合案例验证依赖收集三阶段)
- [4.3 依赖图引擎内部](#43-依赖图引擎内部)
  - [4.3.1 QQmlNotifier 通知链路](#431-qqmlnotifier-通知链路)
  - [4.3.2 绑定作用域与求值时机](#432-绑定作用域与求值时机)
  - [4.3.3 Binding 类型 vs 声明式绑定](#433-binding-类型-vs-声明式绑定)
  - [4.3.4 综合案例：绑定与帧同步追踪](#434-综合案例绑定与帧同步追踪)
- [4.4 绑定恢复与双向绑定](#44-绑定恢复与双向绑定)
  - [4.4.1 Qt.binding() 恢复绑定](#441-qtbinding-恢复绑定)
  - [4.4.2 Binding QML 类型与双向绑定](#442-binding-qml-类型与双向绑定)
  - [4.4.3 综合案例：车机仪表盘绑定系统](#443-综合案例车机仪表盘绑定系统)
- [4.5 性能陷阱与优化](#45-性能陷阱与优化)
  - [4.5.1 绑定求值频率问题](#451-绑定求值频率问题)
  - [4.5.2 绑定循环检测与避免](#452-绑定循环检测与避免)
  - [4.5.3 综合案例：200 个绑定属性的 Dashboard 优化](#453-综合案例200-个绑定属性的-dashboard-优化)
- [4.6 本章新手陷阱 Top 5](#46-本章新手陷阱-top-5)
- [4.7 训练题](#47-训练题)
- [4.8 综合思考题](#48-综合思考题)
- [4.9 速查表](#49-速查表)
...
### 4.5.3 综合案例：200 个绑定属性的 Dashboard 优化
