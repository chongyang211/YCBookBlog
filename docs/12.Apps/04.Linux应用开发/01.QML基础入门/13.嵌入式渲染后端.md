...
#### 目录介绍
- [13.1 案例引入](#131-案例引入)
    - [13.1.1 同一套 QML 在桌面完美、ARM 板画面撕裂](#1311-同一套-qml-在桌面完美arm-板画面撕裂)
    - [13.1.2 根因分析](#1312-根因分析)
    - [13.1.3 三大问题](#1313-三大问题)
- [13.2 嵌入式 GUI 运行环境](#132-嵌入式-gui-运行环境)
    - [13.2.1 有桌面 vs 无桌面](#1321-有桌面-vs-无桌面)
    - [13.2.2 QPA 平台抽象层](#1322-qpa-平台抽象层)
- [13.3 EGLFS 后端详解](#133-eglfs-后端详解)
    - [13.3.1 EGL 初始化到 Swap 全流程](#1331-egl-初始化到-swap-全流程)
    - [13.3.2 eglfs_kms vs eglfs_viv](#1332-eglfs_kms-vs-eglfs_viv)
    - [13.3.3 输入设备直接读取 /dev/input/event*](#1333-输入设备直接读取-devinputevent)
    - [13.3.4 多屏显示配置](#1334-多屏显示配置)
- [13.4 LinuxFB 后端详解](#134-linuxfb-后端详解)
    - [13.4.1 CPU 直接写 /dev/fb0](#1341-cpu-直接写-devfb0)
    - [13.4.2 性能实测与适用场景](#1342-性能实测与适用场景)
- [13.5 Wayland 后端详解](#135-wayland-后端详解)
    - [13.5.1 Wayland 协议与 Qt Wayland Compositor](#1351-wayland-协议与-qt-wayland-compositor)
    - [13.5.2 多窗口嵌入式场景](#1352-多窗口嵌入式场景)
- [13.6 GPU 驱动适配](#136-gpu-驱动适配)
    - [13.6.1 开源驱动 vs 闭源驱动对比](#1361-开源驱动-vs-闭源驱动对比)
    - [13.6.2 DRM/KMS 框架与 Qt 的对接](#1362-drmkms-框架与-qt-的对接)
    - [13.6.3 常见驱动问题排查](#1363-常见驱动问题排查)
- [13.7 综合实战：双屏车机渲染方案](#137-综合实战双屏车机渲染方案)
- [13.8 新手陷阱](#138-新手陷阱)
- [13.9 训练题](#139-训练题)
- [13.10 速查表](#1310-速查表)
...
### 13.1.1 同一套 QML 在桌面完美、ARM 板画面撕裂
...
### 13.3.3 输入设备直接读取 /dev/input/event*
...
### 13.5.1 Wayland 协议与 Qt Wayland Compositor
