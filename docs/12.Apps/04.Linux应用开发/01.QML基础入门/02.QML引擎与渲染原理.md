...
- [2.1 案例引入](#21-案例引入)
    - [2.1.1 性能困惑](#211-性能困惑)
    - [2.1.2 批处理中断](#212-批处理中断)
    - [2.1.3 三大问题](#213-三大问题)
- [2.2 引擎角色分工](#22-引擎角色分工)
    - [2.2.1 三大引擎](#221-三大引擎)
    - [2.2.2 编译链路](#222-编译链路)
    - [2.2.3 对象渲染两树](#223-对象渲染两树)
    - [2.2.4 绑定依赖图](#224-绑定依赖图)
    - [2.2.5 编译与运行](#225-编译与运行)
    - [2.2.6 综合案例](#226-综合案例)
- [2.3 渲染管线](#23-渲染管线)
    - [2.3.1 场景图](#231-场景图)
    - [2.3.2 四阶段循环](#232-四阶段循环)
    - [2.3.3 批处理原理](#233-批处理原理)
    - [2.3.4 绘制调用代价](#234-绘制调用代价)
    - [2.3.5 综合案例](#235-综合案例)
- [2.4 双线程模型](#24-双线程模型)
    - [2.4.1 模型总览](#241-模型总览)
    - [2.4.2 同步阶段](#242-同步阶段)
...
- [2.5 嵌入式后端](#25-嵌入式后端)
    - [2.5.1 后端对比](#251-后端对比)
    - [2.5.2 EGLFS 原理](#252-eglfs-原理)
    - [2.5.3 降级策略](#253-降级策略)
    - [2.5.4 选型决策](#254-选型决策)
- [2.6 诊断工具](#26-诊断工具)
    - [2.6.1 可视化调试](#261-可视化调试)
    - [2.6.2 性能分析器](#262-性能分析器)
    - [2.6.3 环境变量](#263-环境变量)
- [2.7 引擎加载流程](#27-引擎加载流程)
    - [2.7.1 启动流程](#271-启动流程)
    - [2.7.2 对象树构造](#272-对象树构造)
    - [2.7.3 JIT编译缓存](#273-jit编译缓存)
    - [2.7.4 SG节点树](#274-sg节点树)
- [2.8 性能优化](#28-性能优化)
    - [2.8.1 减少绘制](#281-减少绘制)
    - [2.8.2 异步加载](#282-异步加载)
    - [2.8.3 绑定优化](#283-绑定优化)
    - [2.8.4 ListView优化](#284-listview优化)
- [2.9 新手陷阱](#29-新手陷阱)
- [2.10 训练题](#210-训练题)
