...
- [13.1 元类的底层机制](#131-元类的底层机制)
  ...
  - [13.1.4 MRO 方法解析顺序](#1314-mro-方法解析顺序)
- [13.2 描述符协议详解](#132-描述符协议详解)
  - [13.2.1 类型校验描述符](#1321-类型校验描述符)
  - [13.2.2 惰性缓存实现](#1322-惰性缓存实现)
- [13.3 鸭子类型与抽象基类](#133-鸭子类型与抽象基类)
  - [13.3.1 鸭子类型实战](#1331-鸭子类型实战)
  - [13.3.2 抽象基类 ABC](#1332-抽象基类-abc)
  - [13.3.3 Protocol 协议](#1333-protocol-协议)
  - [13.3.4 collections.abc](#1334-collectionsabc)
