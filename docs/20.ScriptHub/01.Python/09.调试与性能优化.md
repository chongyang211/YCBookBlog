...
#### 目录介绍
- [2.1 调试与日志](#21-调试与日志)
  - [2.1.1 print 调试法 vs 专业调试器](#211-print-调试法-vs-专业调试器)
  - [2.1.2 pdb：Python 内置调试器](#212-pdbpython-内置调试器)
  - [2.1.3 VS Code 调试实战](#213-vs-code-调试实战)
  - [2.1.4 logging 四大组件](#214-logging-四大组件)
  - [2.1.5 日志轮转与结构化日志](#215-日志轮转与结构化日志)
  - [2.1.6 loguru：一行搞定日志](#216-loguru一行搞定日志)
- [2.2 性能分析与优化](#22-性能分析与优化)
  - [2.2.1 timeit：精确计时](#221-timeit精确计时)
  - [2.2.2 cProfile：全程序性能剖析](#222-cprofile全程序性能剖析)
  - [2.2.3 line_profiler：逐行分析](#223-line_profiler逐行分析)
  - [2.2.4 memory_profiler：内存分析](#224-memory_profiler内存分析)
  - [2.2.5 8 个性能优化技巧](#225-8-个性能优化技巧)
- [2.3 新手陷阱 Top 5](#23-新手陷阱-top-5)
- [2.4 综合思考题](#24-综合思考题)


## 2.1 调试与日志

### 2.1.1 print 调试法 vs 专业调试器
