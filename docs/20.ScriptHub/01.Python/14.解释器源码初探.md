# 解释器源码初探——从 `a = [1,2,3]` 走进 CPython 的底层世界

> 一行 Python 代码在 CPython 内部经历了什么？本文不做纯理论讲授，而是一次**源码侦探之旅**：从你每天写的 Python 出发，逐层追问"为什么"，最终走进 C 源码验证你的猜想。
...
## 四、第三问：dict 的秘密——为什么 Python 3.7 保证插入顺序？
