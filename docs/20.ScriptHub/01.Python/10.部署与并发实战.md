...
#### 目录介绍
- [1.1 打包与分发](#11-打包与分发)
  - [1.1.1 setuptools 打包](#111-setuptools-打包)
  - [1.1.2 发布到 PyPI](#112-发布到-pypi)
  - [1.1.3 pyinstaller 打包](#113-pyinstaller-打包)
  - [1.1.4 Docker 容器化](#114-docker-容器化)
  - [1.1.5 版本管理策略](#115-版本管理策略)
- [1.2 并发编程](#12-并发编程)
  - [1.2.1 GIL 简介](#121-gil-简介)
  - [1.2.2 多线程用法](#122-多线程用法)
  - [1.2.3 多进程用法](#123-多进程用法)
  - [1.2.4 线程与进程池](#124-线程与进程池)
  - [1.2.5 asyncio 异步](#125-asyncio-异步)
  - [1.2.6 并发模型对比](#126-并发模型对比)
- [1.3 新手陷阱](#13-新手陷阱)
- [1.4 综合思考题](#14-综合思考题)
