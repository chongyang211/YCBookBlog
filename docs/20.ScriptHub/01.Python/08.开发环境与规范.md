...
# 第 1 章 开发环境
#### 目录介绍
- [1.1 虚拟环境与依赖管理](#11-虚拟环境与依赖管理)
  - [1.1.1 为什么需要虚拟环境？](#111-为什么需要虚拟环境)
  - [1.1.2 venv：Python 内置的虚拟环境](#112-venvpython-内置的虚拟环境)
  - [1.1.3 pip 依赖管理实战](#113-pip-依赖管理实战)
  - [1.1.4 依赖冲突的本质与解决](#114-依赖冲突的本质与解决)
  - [1.1.5 pipenv / poetry 现代方案](#115-pipenv--poetry-现代方案)
- [1.2 代码规范与风格](#12-代码规范与风格)
  - [1.2.1 PEP 8 核心规则速查](#121-pep-8-核心规则速查)
  - [1.2.2 命名约定全景](#122-命名约定全景)
  - [1.2.3 文档字符串（docstring）规范](#123-文档字符串docstring规范)
  - [1.2.4 类型注解（Type Hints）](#124-类型注解type-hints)
  - [1.2.5 自动格式化工具链](#125-自动格式化工具链)
