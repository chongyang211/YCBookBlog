...
# 第 3 章 办公自动化实战
#### 目录介绍
- [3.1 问题引入：一份"不可能"的周报任务](#31-问题引入一份不可能的周报任务)
- [3.2 Excel 自动化处理](#32-excel-自动化处理)
  - [3.2.1 openpyxl 读写 Excel](#321-openpyxl-读写-excel)
  - [3.2.2 单元格样式与公式](#322-单元格样式与公式)
  - [3.2.3 批量处理报表](#323-批量处理报表)
  - [3.2.4 pandas 读写 Excel](#324-pandas-读写-excel)
- [3.3 办公自动化脚本集](#33-办公自动化脚本集)
  - [3.3.1 文件批量重命名](#331-文件批量重命名)
  - [3.3.2 PDF 合并与拆分（pypdf）](#332-pdf-合并与拆pypdf)
  - [3.3.3 Word 文档生成（python-docx）](#333-word-文档生成python-docx)
  - [3.3.4 邮件发送（smtplib）](#334-邮件发送smtplib)
- [3.4 定时任务与调度](#34-定时任务与调度)
  - [3.4.1 schedule 轻松定时](#341-schedule-轻松定时)
  - [3.4.2 APScheduler 高级调度](#342-apscheduler-高级调度)
  - [3.4.3 系统级定时：cron / 任务计划](#343-系统级定时cron--任务计划)
- [3.5 综合实战：周报自动化系统](#35-综合实战周报自动化系统)
  - [3.5.1 数据采集模块](#351-数据采集模块)
  - [3.5.2 Excel 生成模块](#352-excel-生成模块)
  - [3.5.3 Word 报告模块](#353-word-报告模块)
  - [3.5.4 邮件发送 + 定时调度](#354-邮件发送--定时调度)
- [3.6 新手陷阱 Top 5](#36-新手陷阱-top-5)
- [3.7 综合思考题](#37-综合思考题)


## 3.1 问题引入：一份"不可能"的周报任务
