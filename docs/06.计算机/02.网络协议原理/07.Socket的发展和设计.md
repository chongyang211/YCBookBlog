...
#### 目录介绍
- [01.工作案例引入](#01工作案例引入)
  - [1.1 聊天服务的七次崩溃](#11-聊天服务的七次崩溃)
  - [1.2 崩溃背后的Socket知识图谱](#12-崩溃背后的Socket知识图谱)
- [02.通信基础概念](#02通信基础概念)
  - [2.1 Socket基础理解](#21-Socket基础理解)
  - [2.2 TCP/IP简介](#22-TCP/IP简介)
  - [2.3 Socket与Http对比](#23-Socket与Http对比)
  - [2.4 Socket使用类型](#24-Socket使用类型)
  - [2.5 Socket和ServerSocket](#25-Socket和ServerSocket)
  - [2.6 一些问题思考](#26-一些问题思考)
- [03.TCP协议Socket深度解析](#03TCP协议Socket深度解析)
  - [3.1 理解四元组](#31-理解四元组)
  - [3.2 TCP Socket的特点](#32-TCP-Socket的特点)
  - [3.3 TCP通信的完整流程](#33-TCP通信的完整流程)
  - [3.4 TCP Socket的缓冲区](#34-TCP-Socket的缓冲区)
- [04.UDP协议Socket](#04UDP协议Socket)
  - [4.1 UDP Socket的特点](#41-UDP-Socket的特点)
  - [4.2 UDP通信流程](#42-UDP通信流程)
  - [4.3 TCP与UDP Socket对比](#43-TCP与UDP-Socket对比)
- [05.Socket操作步骤与实践](#05Socket操作步骤与实践)
  - [5.1 基础实践步骤](#51-基础实践步骤)
  - [5.2 Socket连接](#52-Socket连接)
  - [5.3 Socket中TLS连接](#53-Socket中TLS连接)
  - [5.4 Socket数据读写](#54-Socket数据读写)
  - [5.5 Socket断开连接](#55-Socket断开连接)
  - [5.6 Socket完整案例](#56-Socket完整案例)
- [06.IO多路复用与C10K](#06IO多路复用与C10K)
  - [6.1 为何需要IO多路复用](#61-为何需要IO多路复用)
  - [6.2 三种并发模型对比](#62-三种并发模型对比)
  - [6.3 select/poll/epoll演进](#63-select/poll/epoll演进)
  - [6.4 Socket在内核中的数据结构](#64-Socket在内核中的数据结构)
- [07.Socket选项与参数](#07Socket选项与参数)
  - [7.1 Socket选项的设计](#71-Socket选项的设计)
  - [7.2 地址复用选项](#72-地址复用选项)
  - [7.3 缓冲区大小调优](#73-缓冲区大小调优)
  - [7.4 超时与保活选项](#74-超时与保活选项)
  - [7.5 Nagle算法控制](#75-Nagle算法控制)
- [08.Socket编程常见问题](#08Socket编程常见问题)
  - [8.1 粘包和拆包问题](#81-粘包和拆包问题)
  - [8.2 半关闭状态处理](#82-半关闭状态处理)
  - [8.3 TIME_WAIT问题](#83-TIME_WAIT问题)
  - [8.4 异常断线检测](#84-异常断线检测)
- [09.Socket的演进与未来](#09Socket的演进与未来)
  - [9.1 Socket API的历史](#91-Socket-API的历史)
  - [9.2 从BIO到NIO到AIO](#92-从BIO到NIO到AIO)
  - [9.3 协程与Socket](#93-协程与Socket)
  - [9.4 QUIC对Socket的影响](#94-QUIC对Socket的影响)
- [10.综合案例：聊天服务的四次进化](#10综合案例：聊天服务的四次进化)
  - [10.1 案例背景与目标](#101-案例背景与目标)
  - [10.2 第一代：BIO单线程（阻塞的噩梦）](#102-第一代：BIO单线程（阻塞的噩梦）)
  - [10.3 第二代：多线程版本（线程的陷阱）](#103-第二代：多线程版本（线程的陷阱）)
  - [10.4 第三代：NIO+Selector（非阻塞的曙光）](#104-第三代：NIO+Selector（非阻塞的曙光）)
  - [10.5 第四代：epoll事件驱动（C10K的答案）](#105-第四代：epoll事件驱动（C10K的答案）)
  - [10.6 四种方案横向对比](#106-四种方案横向对比)
  - [10.7 从案例看Netty设计](#107-从案例看Netty设计)
  - [10.8 全文知识图谱回顾](#108-全文知识图谱回顾)
- [11.思考题与作业](#11思考题与作业)
...
TCP Socket从一个`CLOSED`状态开始，经过`connect()`进入`SYN_SENT`，对方回应后进入`ESTABLISHED`。关闭时经历`FIN_WAIT_1 → FIN_WAIT_2 → TIME_WAIT → CLOSED`（主动关闭方）。`TIME_WAIT`状态持续2MSL（约60-120秒），目的是确保最后的ACK能被对方收到。这就是为什么频繁创建短连接的服务器上会看到大量`TIME_WAIT`——它们在等待确认最后的挥手信号。理解这个状态机，你就理解了为什么服务器要`SO_REUSEADDR`、为什么连接池可以减少TIME_WAIT。
