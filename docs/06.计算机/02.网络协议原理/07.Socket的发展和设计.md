...
# 07.Socket的发展和设计
#### 目录介绍
- [01.工作案例引入](07.Socket的发展和设计.md#01.工作案例引入)
  - 1.1 聊天服务的七次崩溃
  - 1.2 崩溃背后的Socket知识图谱
- [02.通信基础概念](07.Socket的发展和设计.md#02.通信基础概念)
  - 2.1 Socket基础理解
  - 2.2 TCP/IP简介
  - 2.3 Socket与Http对比
  - 2.4 Socket使用类型
  ...
  - 2.6 一些问题思考
- [03.TCP协议Socket深度解析](07.Socket的发展和设计.md#03.TCP协议Socket深度解析)
  - 3.1 理解四元组
  - 3.2 TCP Socket的特点
  - 3.3 TCP通信的完整流程
  - 3.4 TCP Socket的缓冲区
- [04.UDP协议Socket](07.Socket的发展和设计.md#04.UDP协议Socket)
  - 4.1 UDP Socket的特点
  - 4.2 UDP通信流程
  - 4.3 TCP与UDP Socket对比
- [05.Socket操作步骤与实践](07.Socket的发展和设计.md#05.Socket操作步骤与实践)
  - 5.1 基础实践步骤
  - 5.2 Socket连接
  - 5.3 Socket中TLS连接
  - 5.4 Socket数据读写
  - 5.5 Socket断开连接
  - 5.6 Socket完整案例
- [06.IO多路复用与C10K](07.Socket的发展和设计.md#06.IO多路复用与C10K)
  - 6.1 为何需要IO多路复用
  - 6.2 三种并发模型对比
  - 6.3 select/poll/epoll演进
  - 6.4 Socket在内核中的数据结构
- [07.Socket选项与参数](07.Socket的发展和设计.md#07.Socket选项与参数)
  - 7.1 Socket选项的设计
  - 7.2 地址复用选项
  - 7.3 缓冲区大小调优
  - 7.4 超时与保活选项
  - 7.5 Nagle算法控制
- [08.Socket编程常见问题](07.Socket的发展和设计.md#08.Socket编程常见问题)
  - 8.1 粘包和拆包问题
  - 8.2 半关闭状态处理
  - 8.3 TIME_WAIT问题
  - 8.4 异常断线检测
- [09.Socket的演进与未来](07.Socket的发展和设计.md#09.Socket的演进与未来)
  - 9.1 Socket API的历史
  - 9.2 从BIO到NIO到AIO
  - 9.3 协程与Socket
  - 9.4 QUIC对Socket的影响
- [10.综合案例：聊天服务的四次进化](07.Socket的发展和设计.md#10.综合案例：聊天服务的四次进化)
  - 10.1 案例背景与目标
  ...
  - 10.7 从案例看Netty设计
  - 10.8 全文知识图谱回顾
- [11.思考题与作业](07.Socket的发展和设计.md#11.思考题与作业)
  - 11.1 基础思考题
  - 11.2 进阶思考题
  - 11.3 动手作业
## 01.工作案例引入
