...
# 15.如何去排查网络故障
#### 目录介绍
- [01.工作案例引入](15.如何去排查网络故障.md#01.工作案例引入)
  - 1.1 一次"服务挂了"的排查全记录
  - 1.2 故障背后的排查知识图谱
- [02.学会使用Ping工具](15.如何去排查网络故障.md#02.学会使用Ping工具)
  - 2.1 Ping工具是什么
  - 2.2 Ping工具的用途
  - 2.3 Ping工具使用
  - 2.4 Ping诊断结果分析
  - 2.5 Ping常见案例
  - 2.6 Ping基础的原理
- [03.用ifconfig查询网络](15.如何去排查网络故障.md#03.用ifconfig查询网络)
  - 3.1 ifconfig 是什么
- [04.netstat和lsof](15.如何去排查网络故障.md#04.netstat和lsof)
  - 4.1 netstat和lsof是什么
- [05.HTTP应用排查工具](15.如何去排查网络故障.md#05.HTTP应用排查工具)
  - 5.1 应用层排查工具
  - 5.2 找有问题服务端IP
  - 5.3 辅助排查网页慢问题
  - 5.4 解决失效Cookie
  - 5.5 查看证书的信息
- [06.传输层排查工具](15.如何去排查网络故障.md#06.传输层排查工具)
  - 6.1 路径可达性测试
  - 6.2 查看当前连接状况
  - 6.3 查看连接传输速率
  - 6.4 查看丢包和乱序等
- [07.网络层排查工具](15.如何去排查网络故障.md#07.网络层排查工具)
  - 7.1 查看网络路径状况
  - 7.2 查看路由信息
- [08.数据链路层排查](15.如何去排查网络故障.md#08.数据链路层排查)
  - 8.1 ARP相关排查
  - 8.2 查看网卡信息
  - 8.3 抓取链路层数据
- [09.CURL网络请求工具](15.如何去排查网络故障.md#09.CURL网络请求工具)
  - 9.1 CURL工具介绍
  - 9.2 CURL访问网络
  - 9.3 CURL的GET请求
  - 9.4 CURL的POST请求
  ...
  - 9.8 CURL通信过程
  - 9.9 CURL其他的实践
- [10.综合案例：一个完整故障的逐层排查实战](15.如何去排查网络故障.md#10.综合案例：一个完整故障的逐层排查实战)
  - 10.1 案例背景与目标
  - 10.2 第一层：用户侧验证（能访问吗？）
  ...
  - 10.7 排查全景总结
  - 10.8 全文知识图谱回顾
- [11.思考题与作业](15.如何去排查网络故障.md#11.思考题与作业)
  - 11.1 基础思考题
  - 11.2 进阶思考题
  - 11.3 动手作业
## 01.工作案例引入
