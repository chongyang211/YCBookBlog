...
# 11.HTTP协议设计思想
#### 目录介绍
- [01.工作案例引入](11.HTTP协议设计思想.md#01.工作案例引入)
  - 1.1 一个前后端分离项目的HTTP踩坑记
  - 1.2 踩坑背后的HTTP设计知识图谱
- [02.URI和URL设计思想](11.HTTP协议设计思想.md#02.URI和URL设计思想)
  - 2.1 如何访问网络资源
  - 2.2 什么是URI
  - 2.3 为何要设计URL
  - 2.4 常用网络协议
  ...
  - 2.6 HTTP之URL
  - 2.7 URL注意事项
- [03.理解HTTP超文本协议](11.HTTP协议设计思想.md#03.理解HTTP超文本协议)
  - 3.0 HTTP诞生历史
  - 3.1 HTTP协议介绍
  - 3.2 在OSI中设计
  - 3.3 什么叫超文本
  ...
  - 3.5 什么叫做无连接
  - 3.6 HTTP协议特点
- [04.HTTP请求与响应](11.HTTP协议设计思想.md#04.HTTP请求与响应)
  - 4.1 理解请求和响应
  - 4.2 请求包的设计
  - 4.3 响应包的设计
  - 4.4 报文空行设计
  - 4.5 看一个完整案例
- [05.HTTP一些场景](11.HTTP协议设计思想.md#05.HTTP一些场景)
  - 5.1 如何统计消息长度
  - 5.2 判断传输是否完成
  - 5.3 HTTP状态码设计
- [06.HTTP各个版本](11.HTTP协议设计思想.md#06.HTTP各个版本)
  - 6.1 Http1.0版本
  - 6.2 HTTP1.1版本
  - 6.3 Http2.0版本
- [07.HTTP方法的设计哲学](11.HTTP协议设计思想.md#07.HTTP方法的设计哲学)
  - 7.1 安全性与幂等性
  - 7.2 RESTful设计思想
  - 7.3 方法的实际应用
- [08.HTTP头部的设计艺术](11.HTTP协议设计思想.md#08.HTTP头部的设计艺术)
  - 8.1 内容协商机制
  - 8.2 条件请求设计
  - 8.3 跨域资源共享
- [09.综合案例：从0到1设计RESTful API](11.HTTP协议设计思想.md#09.综合案例：从0到1设计RESTfulAPI)
  - 9.1 案例背景与目标
  - 9.2 第一版：随意风格（能跑就行）
  ...
  - 9.8 全文知识图谱回顾
- [10.思考题与作业](11.HTTP协议设计思想.md#10.思考题与作业)
  - 10.1 基础思考题
  - 10.2 进阶思考题
  - 10.3 动手作业
## 01.工作案例引入
