...
# 08.传输数据的设计思想
#### 目录介绍
- [01.工作案例引入](08.传输数据的设计思想.md#01.工作案例引入)
  - 1.1 设备上报数据的五重Bug
  - 1.2 Bug背后的数据传输知识图谱
- [02.数据传递的流程](08.传输数据的设计思想.md#02.数据传递的流程)
  - 2.1 先看一个案例
  - 2.2 数据的发送处理
  - 2.3 数据接收处理
  - 2.4 为何要层层封装
- [03.数据传输设计](08.传输数据的设计思想.md#03.数据传输设计)
  - 3.1 封装和解析报文
  - 3.2 什么是TCP流
  - 3.3 数据传输流程设计
  - 3.4 用例子理解流程
  - 3.5 MTU与MSS的设计
  - 3.6 分片与重组机制
- [04.数据基础的设计](08.传输数据的设计思想.md#04.数据基础的设计)
  - 4.1 报文设计思想
  - 4.2 数据报/报文段
  - 4.3 数据包的设计
  - 4.4 帧Frame的设计
  - 4.5 各层PDU对比
- [05.数据传输中的问题](08.传输数据的设计思想.md#05.数据传输中的问题)
  - 5.1 大端和小端序
  - 5.2 网络字节序
  - 5.3 数据校验机制
  - 5.4 数据完整性保证
- [06.数据传输的性能](08.传输数据的设计思想.md#06.数据传输的性能)
  - 6.1 带宽和吞吐量
  - 6.2 延迟的组成
  - 6.3 数据传输优化
  - 6.4 零拷贝技术
- [07.数据序列化设计](08.传输数据的设计思想.md#07.数据序列化设计)
  - 7.1 为何需要序列化
  - 7.2 常见序列化方案
  - 7.3 协议缓冲区设计
  - 7.4 序列化性能对比
- [08.综合案例：文件传输协议的四次进化](08.传输数据的设计思想.md#08.综合案例：文件传输协议的四次进化)
  - 8.1 案例背景与目标
  ...
  - 8.7 从案例看主流框架设计
  - 8.8 全文知识图谱回顾
- [09.思考题与作业](08.传输数据的设计思想.md#09.思考题与作业)
  - 9.1 基础思考题
  - 9.2 进阶思考题
  - 9.3 动手作业
## 01.工作案例引入
