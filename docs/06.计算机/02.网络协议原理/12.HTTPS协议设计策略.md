...
# 12.Https协议设计策略
#### 目录介绍
- [01.工作案例引入](12.HTTPS协议设计策略.md#01.工作案例引入)
  - 1.1 一个小程序上线的HTTPS五连击
  - 1.2 事故背后的HTTPS安全知识图谱
- [02.为何会有Https](12.HTTPS协议设计策略.md#02.为何会有Https)
  - 2.1 Http的缺点
  - 2.2 Http缺点解决方案
  - 2.3 Http的风险
  - 2.4 如何避免风险
- [03.解决方案分析](12.HTTPS协议设计策略.md#03.解决方案分析)
  - 3.1 Https加密方式
  - 3.2 SSL是什么
  - 3.3 SSL原理是什么
- [04.SSL存在隐患](12.HTTPS协议设计策略.md#04.SSL存在隐患)
  - 4.1 RSA验证的隐患
  - 4.2 中间方伪造公钥和私钥
  - 4.3 存在两类问题
- [05.CA证书解决SSL隐患](12.HTTPS协议设计策略.md#05.CA证书解决SSL隐患)
  - 5.1 如何解决SSL隐患
  - 5.2 CA证书流程原理
- [06.Https工作流程](12.HTTPS协议设计策略.md#06.Https工作流程)
  - 6.1 工作流程图
  - 6.2 详细流程说明
- [07.Https真安全吗](12.HTTPS协议设计策略.md#07.Https真安全吗)
  - 7.1 Https代理了解
  - 7.2 charles抓包流程
- [08.Https性能分析](12.HTTPS协议设计策略.md#08.Https性能分析)
  - 8.1 HTTPS性能损耗
  - 8.2 HTTPS接入优化
- [09.TLS协议深度解析](12.HTTPS协议设计策略.md#09.TLS协议深度解析)
  - 9.1 TLS记录协议
  - 9.2 TLS握手协议详解
  - 9.3 密钥导出过程
  - 9.4 TLS 1.3的改进
- [10.HTTPS安全攻防](12.HTTPS协议设计策略.md#10.HTTPS安全攻防)
  - 10.1 SSL剥离攻击
  - 10.2 降级攻击防护
  - 10.3 证书固定(Pinning)
  - 10.4 HPKP的兴衰
- [11.HTTPS部署实践](12.HTTPS协议设计策略.md#11.HTTPS部署实践)
  - 11.1 证书申请与管理
  - 11.2 服务器配置最佳实践
  - 11.3 安全评估与测试
  - 11.4 常见问题排查
- [12.综合案例：从0到1部署生产级HTTPS服务](12.HTTPS协议设计策略.md#12.综合案例：从0到1部署生产级HTTPS服务)
  - 12.1 案例背景与目标
  ...
  - 12.8 全文知识图谱回顾
- [13.思考题与作业](12.HTTPS协议设计策略.md#13.思考题与作业)
  - 13.1 基础思考题
  - 13.2 进阶思考题
  - 13.3 动手作业
## 01.工作案例引入
