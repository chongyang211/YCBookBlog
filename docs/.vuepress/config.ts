  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/computer/',
        items: [
          { text: '计算机原理', link: '/pages/computer/' },
          { text: '操作系统', link: '/pages/os/' },
          { text: '网络协议', link: '/pages/network/' },
          { text: '数据库原理', link: '/pages/database/' },
        ],
      },
      {
        text: '编程',
      ...
      },
      {
        ...
        link: '/algorithm/',
        items: [
          { text: '基础认知', link: '/pages/algobase/' },
          { text: '线性结构', link: '/pages/linear/' },
          { text: '树与哈希', link: '/pages/tree/' },
          { text: '工业级实现', link: '/pages/industrial/' },
          { text: '算法思想', link: '/pages/thinking/' },
          { text: '实战与综合', link: '/pages/practice/' },
          { text: '算法题考核', link: '/pages/problems/' },
        ],
      },
      {
        text: 'CodeX',
