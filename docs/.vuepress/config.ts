    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '数组算法题', link: '/pages/algo-array/' },
          { text: '链表算法题', link: '/pages/algo-linked/' },
          { text: '栈队列算法题', link: '/pages/algo-stack/' },
          { text: '哈希算法题', link: '/pages/algo-hash/' },
          { text: '二叉树算法题', link: '/pages/algo-tree/' },
          { text: '堆算法题', link: '/pages/algo-heap/' },
          { text: '图算法题', link: '/pages/algo-graph/' },
          { text: '二分查找算法题', link: '/pages/algo-binary/' },
          { text: '双指针算法题', link: '/pages/algo-twopointer/' },
          { text: '排序算法题', link: '/pages/algo-sort/' },
          { text: '分治算法题', link: '/pages/algo-divide/' },
          { text: '贪心算法题', link: '/pages/algo-greedy/' },
          { text: '回溯算法题', link: '/pages/algo-backtrack/' },
          { text: '动规算法题', link: '/pages/algo-dp/' },
          { text: '位运算算法题', link: '/pages/algo-bit/' },
          { text: '数学算法题', link: '/pages/algo-math/' },
        ],
      },
      {
        text: 'C/C++',
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Shell&Bash教程', link: '/pages/shell-guide/' },
      ...
      },
      {
        ...
        link: '/more/',
        items: [
          { text: '关于我', link: '/pages/about-readme/' },
          { text: '自我精进', link: '/pages/grow-readme/' },
          { text: '职场管理', link: '/pages/career-readme/' },
          { text: '职场面试', link: '/pages/interview-readme/' },
          { text: '心情杂货', link: '/pages/mood-readme/' },
