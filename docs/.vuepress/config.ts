    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '数组算法题', link: '/pages/algo200-a001/' },
          { text: '链表算法题', link: '/pages/algo200-b001/' },
          { text: '栈队列算法题', link: '/pages/algo200-c001/' },
          { text: '哈希算法题', link: '/pages/algo200-d001/' },
          { text: '二叉树算法题', link: '/pages/algo200-e001/' },
          { text: '堆算法题', link: '/pages/algo200-f001/' },
          { text: '图算法题', link: '/pages/algo200-g001/' },
          { text: '二分查找算法题', link: '/pages/algo200-h001/' },
          { text: '双指针算法题', link: '/pages/algo200-i001/' },
          { text: '排序算法题', link: '/pages/algo200-j001/' },
          { text: '分治算法题', link: '/pages/algo200-k008/' },
          { text: '贪心算法题', link: '/pages/algo200-l001/' },
          { text: '回溯算法题', link: '/pages/algo200-m001/' },
          { text: '动规算法题', link: '/pages/algo200-n001/' },
          { text: '位运算算法题', link: '/pages/algo200-o001/' },
          { text: '数学算法题', link: '/pages/algo200-p001/' },
        ],
      },
      {
        text: 'C/C++',
