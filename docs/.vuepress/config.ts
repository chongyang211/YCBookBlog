    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '数组与链表', link: '/pages/algo200-a001/' },
          { text: '栈队列哈希', link: '/pages/algo200-c001/' },
          { text: '树', link: '/pages/algo200-e001/' },
          { text: '堆与图', link: '/pages/algo200-f001/' },
          { text: '二分查找', link: '/pages/algo200-h001/' },
          { text: '排序与贪心', link: '/pages/algo200-j001/' },
          { text: '回溯', link: '/pages/algo200-m001/' },
          { text: '动态规划', link: '/pages/algo200-n001/' },
          { text: '位运算', link: '/pages/algo200-o001/' },
          { text: '数学与双指针', link: '/pages/algo200-i001/' },
