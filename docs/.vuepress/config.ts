    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '数组与字符串', link: '/pages/algo200-a001/' },
          { text: '链表', link: '/pages/algo200-b001/' },
          { text: '栈与队列', link: '/pages/algo200-c001/' },
          { text: '哈希表与查找', link: '/pages/algo200-d001/' },
          { text: '树与二叉树', link: '/pages/algo200-e001/' },
          { text: '堆与优先队列', link: '/pages/algo200-f001/' },
          { text: '图', link: '/pages/algo200-g001/' },
          { text: '二分查找', link: '/pages/algo200-h001/' },
          { text: '双指针与滑动', link: '/pages/algo200-i001/' },
          { text: '排序', link: '/pages/algo200-j001/' },
          { text: '分治', link: '/pages/algo200-k008/' },
          { text: '贪心', link: '/pages/algo200-l001/' },
          { text: '回溯', link: '/pages/algo200-m001/' },
          { text: '动态规划', link: '/pages/algo200-n001/' },
          { text: '位运算', link: '/pages/algo200-o001/' },
          { text: '数学与思维', link: '/pages/algo200-p001/' },
        ],
      },
      {
        text: 'C/C++',
