    ...
    return {
      ...
      categories: [
        ...
        },
        {
          id: 'doc',
          title: '文档转化',
          desc: 'Markdown ↔ HTML、PDF 合并/拆分、文档模板',
          icon: '📄',
          link: '/tools/doc/',
          status: 'ready',
          hot: true,
          color1: '#9b59b6',
          color2: '#4a90d9',
          tools: ['MD → HTML', 'HTML → MD', 'PDF 合并', 'PDF 拆分', '文档模板'],
        },
        {
          id: 'minify',
          title: '代码压缩',
          desc: 'JS / CSS / HTML / JSON / SQL 压缩与美化、行处理',
          icon: '📦',
          link: '/tools/minify/',
          status: 'ready',
          color1: '#e67e22',
          color2: '#e74c3c',
          tools: ['JS 压缩', 'CSS 压缩', 'HTML 美化', 'JSON 格式化', 'SQL 格式化', '行处理'],
        },
        {
          id: 'crypto',
          title: '加解密',
          desc: 'AES / Base64 / Hash / HMAC / JWT / RSA · Web Crypto',
          icon: '🔐',
          link: '/tools/crypto/',
          status: 'ready',
          hot: true,
          color1: '#c0392b',
          color2: '#7b5fd9',
          tools: ['AES 加解密', 'Base64', 'MD5/SHA', 'HMAC', 'JWT 解码', 'RSA'],
        },
        {
          id: 'time',
          title: '时间日期',
          desc: '时间戳、世界时钟、Cron 表达式、日期计算、倒计时',
          icon: '⏰',
          link: '/tools/time/',
          status: 'ready',
          hot: true,
          color1: '#16a085',
          color2: '#4a90d9',
          tools: ['时间戳转换', '世界时钟', 'Cron 解析', '日期计算', '倒计时'],
        },
        {
          id: 'network',
          title: '网络工具',
          desc: 'URL / UA / HTTP / MIME / CIDR 子网计算',
          icon: '🌐',
          link: '/tools/network/',
          status: 'ready',
          color1: '#2980b9',
        ...
        },
        {
          id: 'qrcode',
          title: '二维码',
          desc: '生成 / 模板 / 加 Logo / 识别 / 条形码',
          icon: '📱',
          link: '/tools/qrcode/',
          status: 'ready',
          color1: '#34495e',
          color2: '#16a085',
          tools: ['二维码生成', 'WiFi/vCard 模板', '加 Logo', '扫码识别', '条形码生成'],
        },
        {
          id: 'dev',
          title: '开发实用',
          desc: 'UUID / 密码 / 进制 / 单位 / CSV',
          icon: '⚙️',
          link: '/tools/dev/',
          status: 'ready',
          hot: true,
