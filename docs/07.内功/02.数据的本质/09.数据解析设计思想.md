...
- 同卷上篇：[1.8 序列化数据的思想](https://yccoding.com/pages/9de8b4/) ｜[1.1 数据编码设计原理](https://yccoding.com/pages/27269c/)
- 解析 → 类型：[1.4 字符串设计的灵魂](https://yccoding.com/pages/4322cf/) ｜[1.7 容器型数据设计原理](./07.容器型数据设计原理.md)
- 解析 → 运行时：[3.7 类的加载核心原理](../pages/74953e/)
- 解析 → 内存：[4.5 内存回收机制设计](https://yccoding.com/pages/8327cf/)
