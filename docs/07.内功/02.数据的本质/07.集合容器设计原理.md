...
> 🔗 **延伸阅读**：← [1.6 泛型设计灵魂思想](https://yccoding.com/pages/f4bb3e/) · → [1.8 序列化数据的思想](https://yccoding.com/pages/9de8b4/) · → [4.2 缓存与局部性原理](..../05.内存的真相/) · → [3.x 并发容器与无锁设计](..../04.并发的设计/)
...
> 这部分的深入留给 [1.8 序列化数据的思想](https://yccoding.com/pages/9de8b4/) 和数据库专题。
...
> 无锁数据结构的深入讨论留给 [3.x 内存模型与原子操作](..../04.并发的设计/)。
...
这就是下一篇 [1.8 序列化数据的思想](https://yccoding.com/pages/9de8b4/) 要回答的——**从内存对象到字节流的"格式之战"**。
...
- 同卷上篇：[1.6 泛型设计灵魂思想](https://yccoding.com/pages/f4bb3e/)
- 同卷下篇：[1.8 序列化数据的思想](https://yccoding.com/pages/9de8b4/) ｜ [1.9 数据解析设计思想](https://yccoding.com/pages/6c6e3e/)
- 内存布局：[4.4 内存对齐与缓存局部性](..../05.内存的真相/) ｜ [4.2 缓存与局部性原理](..../05.内存的真相/)
- 并发容器深入：[3.x 内存模型与原子操作](..../04.并发的设计/) ｜ [3.x 锁与无锁数据结构](..../04.并发的设计/)
