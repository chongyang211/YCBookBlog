...
> 🔗 **延伸阅读**：← [3.11 异步和同步的设计](https://yccoding.com/pages/5a0952/) · ← [3.12 单线程模型的思想](https://yccoding.com/pages/5069b5/) · → [3.14 Actor 与 CSP 并发模型](https://yccoding.com/pages/ff832c/) · → [3.18 结构化并发设计思想](https://yccoding.com/pages/218459/) · → [2.4 函数调用栈与栈帧设计](../02.运行时模型/2.4.函数调用栈与栈帧设计.md)
