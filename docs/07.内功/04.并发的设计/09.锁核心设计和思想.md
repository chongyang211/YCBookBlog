...
- [5.锁架构设计](#5锁架构设计)
  ...
  - [5.9 锁粒度设计](#59-锁粒度设计)
- [6.锁的演进史](#6锁的演进史)
  - [6.1 第一代：纯软件互斥Dekker/Peterson](#61-第一代纯软件互斥dekkerpeterson)
  - [6.2 第二代：自旋锁Test-and-Set](#62-第二代自旋锁test-and-set)
  - [6.3 第三代：TTAS + 退避](#63-第三代ttas--退避)
  - [6.4 第四代：MCS / CLH 队列锁](#64-第四代mcs--clh-队列锁)
  - [6.5 第五代：futex / 两阶段锁](#65-第五代futex--两阶段锁)
  - [6.6 第六代：分级锁与JVM锁优化](#66-第六代分级锁与jvm锁优化)
  - [6.7 演进规律](#67-演进规律)
- [7.锁的工程陷阱](#7锁的工程陷阱)
  - [7.1 陷阱清单](#71-陷阱清单)
  - [7.2 经典反模式](#72-经典反模式)
  - [7.3 死锁的检测与预防](#73-死锁的检测与预防)
  - [7.4 工程纪律](#74-工程纪律)
- [8.锁的内核实现：用户态到内核态](#8锁的内核实现用户态到内核态)
  - [8.1 Linux futex：现代锁的基石](#81-linux-futex现代锁的基石)
  - [8.2 glibc pthread_mutex多模式](#82-glibc-pthread_mutex多模式)
  - [8.3 Java synchronized的JVM实现](#83-java-synchronized的jvm实现)
- [9.锁的跨语言对比](#9锁的跨语言对比)
  - [9.1 Go：不鼓励锁，鼓励 channel](#91-go不鼓励锁鼓励-channel)
  - [9.2 Rust：所有权消除大部分锁](#92-rust所有权消除大部分锁)
  - [9.3 Erlang/Elixir：Actor模型无锁](#93-erlangelixiractor模型无锁)
  - [9.4 跨语言对比表](#94-跨语言对比表)
- [10.案例驱动的锁深度剖析](#10案例驱动的锁深度剖析)
  - [10.1 案例：synchronized(String)隐形死锁](#101-案例synchronizedstring隐形死锁)
  - [10.2 案例：ReentrantLock忘unlock雪崩](#102-案例reentrantlock忘unlock雪崩)
  - [10.3 案例：读写锁的"写者饥饿"](#103-案例读写锁的写者饥饿)
- [11.锁的可观测性与调优实战](#11锁的可观测性与调优实战)
  - [11.1 锁竞争的观测](#111-锁竞争的观测)
  - [11.2 锁性能的衡量指标](#112-锁性能的衡量指标)
  - [11.3 锁优化的五条决策树](#113-锁优化的五条决策树)
- [12.锁设计的未来方向](#12锁设计的未来方向)
  - [12.1 硬件辅助：Intel TSX事务内存](#121-硬件辅助intel-tsx事务内存)
  - [12.2 OS辅助：Linux futex2与Robust Mutex](#122-os辅助linux-futex2与robust-mutex)
  - [12.3 语言层抽象：结构化锁](#123-语言层抽象结构化锁)
- [13.跨语言锁陷阱速查表](#13跨语言锁陷阱速查表)
- [14.七字真言 × 多语言映射](#14七字真言--多语言映射)
...
### 10.1 案例：synchronized(String)隐形死锁
...
### 10.2 案例：ReentrantLock忘unlock雪崩
...
### 12.2 OS辅助：Linux futex2与Robust Mutex
