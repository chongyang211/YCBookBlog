...
> 🔗 **延伸阅读**：← [06.JIT与运行时优化](https://yccoding.com/pages/f551ab/) · → [08.异常机制核心设计](https://yccoding.com/pages/7f86db/) · → [05.字节码虚拟机执行](https://yccoding.com/pages/d0c877/)
...
- ← [03.对象和函数访问原理](https://yccoding.com/pages/126560/)：理解了 vtable，反射 `invoke` 的分派原理就一目了然
- ← [06.JIT与运行时优化](https://yccoding.com/pages/f551ab/)：反射的去虚化与内联缓存正是 JIT 优化的极致体现
- → [08.异常机制核心设计](https://yccoding.com/pages/7f86db/)：反射调用如何穿透异常栈展开
- → [05.内存回收机制设计](https://yccoding.com/pages/8327cf/)：对象销毁的话题并入 GC 卷，此处不再单列
