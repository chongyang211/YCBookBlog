...
> 🔗 **延伸阅读**：← [34.多种引用技术设计](https://yccoding.com/pages/9ff724/) · → [40.窗口核心设计思想](https://yccoding.com/pages/2f009c/) · → [03.值型变量和引用](./03.值型变量和引用.md)
...
- [07.数组与集合的拷贝](#07数组与集合的拷贝)
  - [7.1 双层独立性](#71-双层独立性)
  - [7.2 数组集合速查](#72-数组集合速查)
  - [7.3 Java最小示例](#73-java最小示例)
- [08.跨语言拷贝机制对比](#08跨语言拷贝机制对比)
  - [8.1 拷贝机制总览](#81-拷贝机制总览)
  - [8.2 JavaScript的拷贝](#82-javascript的拷贝)
  - [8.3 C++的拷贝与移动](#83-c的拷贝与移动)
  - [8.4 写时复制COW](#84-写时复制cow)
  - [8.5 五语言API速查](#85-五语言api速查)
- [09.综合案例串讲](#09综合案例串讲)
  - [9.1 可视编辑背景](#91-可视编辑背景)
  - [9.2 v1直接共享](#92-v1直接共享)
  - [9.3 v2全量deepcopy](#93-v2全量deepcopy)
  - [9.4 v3 Builder方案](#94-v3-builder方案)
  - [9.5 v4 Immer终局](#95-v4-immer终局)
  - [9.6 四版本策略对比](#96-四版本策略对比)
  - [9.7 多语言对照](#97-多语言对照)
  - [9.8 知识点回归](#98-知识点回归)
  - [9.9 一句话提炼](#99-一句话提炼)
- [10.经典陷阱反模式](#10经典陷阱反模式)
  - [10.1 Cloneable契约糟](#101-cloneable契约糟)
  - [10.2 序列化静默丢失](#102-序列化静默丢失)
  - [10.3 循环引用溢出](#103-循环引用溢出)
  - [10.4 浅拷+不可变假独](#104-浅拷不可变假独)
  - [10.5 多线程clone不原子](#105-多线程clone不原子)
- [11.一句话总结](#11一句话总结)
  - [11.1 决策树与性能](#111-决策树与性能)
  - [11.2 三层认知阶梯](#112-三层认知阶梯)
  - [11.3 决策清单](#113-决策清单)
  - [11.4 设计哲学一句话](#114-设计哲学一句话)
  - [11.5 七字真言映射](#115-七字真言映射)
  - [11.6 与本卷的呼应](#116-与本卷的呼应)
  - [11.7 延伸阅读](#117-延伸阅读)
