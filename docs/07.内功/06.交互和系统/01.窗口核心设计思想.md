...
- [01.概述与背景](#01概述与背景)
  ...
  - [1.2 不为人知的窗口史](#12-不为人知的窗口史任何应用开发者都应记住的演进线)
  - [1.3 为何需要窗口](#13-为何需要窗口)
  - [1.4 主要解决问题](#14-主要解决问题)
  - [1.5 警醒的资源数字](#15-警醒的资源数字为什么窗口不是view)
  - [1.6 窗口设计目标](#16-窗口设计目标)
  - [1.7 设计哲学思想](#17-设计哲学思想)
- [02.不同平台窗口机制](#02各平台窗口机制)
  - [2.1 Android窗口机制](#21-android窗口机制)
  - [2.2 iOS窗口机制](#22-ios窗口机制)
  - [2.3 Web窗口机制](#23-web窗口机制)
  - [2.4 Flutter窗口机制](#24-flutter窗口机制)
  - [2.5 Qt / 桌面窗口机制](#25-qt--桌面窗口机制)
  - [2.6 嵌入式窗口机制](#26-嵌入式窗口机制lvgl--wayland--rtos)
  - [2.7 平台对比分析](#27-平台对比分析)
  - [2.8 通用抽象提炼：四元组模型](#28-通用抽象提炼四元组通用模型)
...
- [04.窗口类型设计](#04窗口类型设计)
  - [4.1 为什么要区分窗口类型](#41-为何区分窗口类型)
  - [4.2 应用窗口](#42-应用窗口)
  - [4.3 子窗口](#43-子窗口)
  - [4.4 系统窗口](#44-系统窗口)
  - [4.5 窗口类型与Z序设计](#45-窗口类型与z序设计)
  - [4.6 类型设计的权衡](#46-类型设计的权衡)
  - [4.7 跨平台层级体系对照](#47-跨平台层级体系对照任意开发者一图通用)
- [05.窗口属性设计](#05窗口属性设计)
...
- [09.窗口生命周期设计](#09窗口生命周期设计)
  ...
  - [9.4 各端窗口生命周期对照](#94-各端窗口生命周期对照通用心智)
  - [9.5 窗口泄漏与防护](#95-窗口泄漏与防护)
...
- [11.经典陷阱与生产级反模式](#11经典陷阱与生产级反模式)
  - [11.1 陷阱一（Android）：AppContext创建业务窗口](#111-陷阱一appcontext创建业务窗口)
  - [11.2 陷阱二（Android）：父窗口销毁后dismiss子窗口](#112-陷阱二父窗口销毁后dismiss子窗口)
  - [11.3 陷阱三（Android）：滥用APPLICATION_OVERLAY](#113-陷阱三滥用application_overlay)
  - [11.4 陷阱四（Android）：onCreate中获窗口尺寸](#114-陷阱四oncreate中获窗口尺寸)
  - [11.5 陷阱五（Android）：依赖设备Z序表现](#115-陷阱五依赖设备z序表现)
  - [11.6 陷阱六（Android）：输入法弹起遮挡输入框](#116-陷阱六输入法弹起遮挡输入框)
  - [11.7 陷阱七（Android）：SurfaceView销毁后lockCanvas](#117-陷阱七surfaceview销毁后lockcanvas)
  - [11.8 陷阱八（iOS）：多 Scene 下 keyWindow 失效](#118-陷阱八ioskeywindow-在多-scene-下的找不到)
  - [11.9 陷阱九（Web）：iframe 内 z-index 永远盖不过宿主](#119-陷阱九webiframe-内的-z-index-永远盖不过宿主)
  - [11.10 陷阱十（Flutter）：dispose 后还在 setState](#1110-陷阱十flutterdispose-后还在-setstate)
- [12.一句话总结：窗口设计的认知阶梯](#12一句话总结窗口设计的认知阶梯)
  - [12.1 三层认知](#121-三层认知)
  - [12.2 设计哲学一句话](#122-设计哲学一句话)
  - [12.3 跨端通用术语对照](#123-跨端通用术语对照一图带走)
  - [12.4 与本卷其它章节的呼应](#124-与本卷其它章节的呼应)
  - [12.5 延伸阅读](#125-延伸阅读)
...
### 2.6 嵌入式窗口机制（LVGL / 裸 framebuffer / RTOS）
...
### 11.8 陷阱八（iOS）：keyWindow 在多 Scene 下的"找不到"
...
### 11.9 陷阱九（Web）：iframe 内的 z-index 永远盖不过宿主
...
### 11.10 陷阱十（Flutter）：dispose 后还在 setState
