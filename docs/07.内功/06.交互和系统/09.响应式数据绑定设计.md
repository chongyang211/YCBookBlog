...
| §3.9 生命周期 | [5.7 组件生命周期](https://yccoding.com/pages/lifecycle/) | LifecycleOwner 是响应式自动解绑的依赖 |
| §6.4 SwiftUI | [5.8 页面导航](https://yccoding.com/pages/navigation/) | NavigationPath 本质就是响应式数组 |
| §3.3 通知 | [5.5 消息机制设计](https://yccoding.com/pages/message/) | 通知最终走 Handler/RunLoop/Microtask 队列 |
| §9 反模式 | [4.x 内存的真相](../04.内存的真相/) | 订阅未解 = 强引用链 = OOM 根源 |
