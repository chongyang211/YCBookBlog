...
- [02.手势事件总架构](#02手势事件总架构)
  ...
  - [2.5 手势通用契约与跨端阶段矩阵](#25-手势通用契约与跨端阶段矩阵)
- [03.手势事件元素](#03手势事件元素)
  - [3.1 触摸事件](#31-触摸事件)
...
- [04.手势事件传递](#04手势事件传递)
  ...
  - [4.5 事件分发模型矩阵](#45-事件分发模型矩阵五端横向对比)
- [05.手势事件处理](#05手势事件响应)
  - [5.1 事件处理思路](#51-事件处理思路)
  - [5.2 事件处理策略](#52-事件处理策略)
  - [5.3 设计哲学分析](#53-设计哲学分析)
  - [5.4 手势事件设计的核心启示](#54-手势事件设计的核心启示)
- [06.多手势冲突与竞争解决](#06多手势冲突与竞争解决)
  - [6.1 手势冲突的三种典型场景](#61-手势冲突的三种典型场景)
  - [6.2 Android 解法：disallowIntercept](#62-android解法disallowintercept)
  - [6.3 iOS 解法：require + delegate](#63-ios解法requiredelegate)
  - [6.4 三种可重用的冲突解决模式](#64-三种可重用的冲突解决模式)
  - [6.5 冲突解决模式全谱](#65-冲突解决模式全谱六种通用解法)
- [07.跨平台手势体系全景对比](#07跨平台手势体系全景对比)
  - [7.1 五个平台手势设计全景](#71-五个平台手势设计全景)
  - [7.2 Flutter Gesture Arena 最优雅设计](#72-flutter-gesture-arena最优雅设计)
  - [7.3 Web touch-action 表达手势意图](#73-web-touch-action表达手势意图)
  - [7.4 鸿蒙 ArkUI / 桌面端 / 嵌入式补全](#74-鸿蒙-arkui--桌面端--嵌入式补全)
- [08.经典陷阱与生产级反模式](#08经典陷阱与生产级反模式)
  - [8.1 (Android) onTouchEvent 返 false 后不再收事件](#81-陷阱一ontouchevent返false后不再收事件)
  - [8.2 (Android) 不处理 CANCEL](#82-陷阱二不处理cancel0)
  - [8.3 (Android) 多点触控只看 DOWN](#83-陷阱三多点触控只看down)
  - [8.4 (Android) dispatchTouch 打日志 ANR](#84-陷阱四dispatchtouch打日志导致anr)
  - [8.5 (Web) click 事件 300ms 延迟](#85-陷阱五web-click事件300ms延迟)
  - [8.6 (iOS) 嵌套 ScrollView 不响应](#86-陷阱六ios嵌套scrollview不响应)
  - [8.7 (Flutter) Detector 嵌套 InkWell](#87-陷阱七flutter-detector嵌套inkwell)
  - [8.8 (iOS) 识别器 cancelsTouchesInView 副作用](#88-陷阱八ios-cancelstouchesinview-副作用)
  - [8.9 (Web) pointer-events: none 误用](#89-陷阱九web-pointer-events-none-误用)
  - [8.10 (嵌入式) 按键抖动未 debounce](#810-陷阱十嵌入式按键抖动未-debounce)
- [09.一句话总结：手势设计阶梯](#09一句话总结手势设计阶梯)
  - [9.1 三层认知](#91-三层认知)
  - [9.2 设计哲学一句话](#92-设计哲学一句话)
  - [9.3 与本卷其它章节的呼应](#93-与本卷其它章节的呼应)
  - [9.4 跨端通用术语对照](#94-跨端通用术语对照一图带走)
  - [9.5 延伸阅读](#95-延伸阅读)
...
### 8.8 陷阱八（iOS）：cancelsTouchesInView 副作用
...
### 8.9 陷阱九（Web）：pointer-events: none 误用
