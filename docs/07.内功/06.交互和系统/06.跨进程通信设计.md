...
> 🔗 **延伸阅读**：← [5.1 窗口核心设计思想](https://yccoding.com/pages/2f009c/) · ← [5.2 视图加载渲染设计](https://yccoding.com/pages/070bb8/) · ← [5.3 图形渲染管线原理](https://yccoding.com/pages/eef9d2/) · ← [5.4 手势事件设计灵魂](https://yccoding.com/pages/5b96db/) · ← [5.5 消息机制设计思想](https://yccoding.com/pages/0aed31/) · → [5.7 组件生命周期管理](https://yccoding.com/pages/aaaaaa/) · ↔ [3.x 并发之道](../03.并发的设计/) · ↔ [4.x 内存的真相](../04.内存的真相/)
...
- [02.IPC 的范式分类](#02ipc-的范式分类)
  ...
  - [2.4 IPC 通用四件套契约与跨端名词矩阵](#24-ipc-通用四件套契约与跨端名词矩阵)
...
- [09.分布式IPC：单机到集群](#09分布式ipc单机到集群)
  ...
  - [9.4 IPC 架构横向对比矩阵（七端 × 八维度）](#94-ipc-架构横向对比矩阵七端--八维度)
  - [9.5 现代演进：io_uring / eBPF / RDMA / DPDK](#95-现代演进io_uring--ebpf--rdma--dpdk)
- [10.IPC 选型决策与设计哲学](#10ipc-选型决策与设计哲学)
  ...
  - [10.7 通用心智总结（七句口诀）](#107-通用心智总结七句口诀)
...
### 9.5 现代演进：io_uring / eBPF / RDMA / DPDK ★
