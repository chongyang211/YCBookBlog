...
> 🔗 **延伸阅读**：← [5.1 窗口核心设计思想](https://yccoding.com/pages/2f009c/) · ← [5.2 视图加载渲染设计](https://yccoding.com/pages/070bb8/) · ← [5.3 图形渲染管线原理](https://yccoding.com/pages/318066/) · ← [5.4 手势事件设计灵魂](https://yccoding.com/pages/5b96db/) · → [5.6 跨进程通信设计](https://yccoding.com/pages/e09fe7/) · ↔ [4.x 单线程模型的思想](https://yccoding.com/pages/5069b5/)
...
- [7.Looper 设计](#7looper-设计)
  ...
  - [7.4 ThreadLocal 绑定](#74-threadlocal-绑定)
...
- [9.性能优化](#9性能优化)
  ...
  - [9.4 IdleHandler 巧设](#94-idlehandler-巧设)
