...
> 📍 **本篇位置**：第 5 卷 · 交互与系统 · 第 5 篇（贯穿全卷的「心跳」基础设施）
...
> 🔗 **延伸阅读**：← [5.1 窗口核心设计思想](https://yccoding.com/pages/2f009c/) · ← [5.2 视图加载渲染设计](https://yccoding.com/pages/070bb8/) · ← [5.3 图形渲染管线原理](https://yccoding.com/pages/eef9d2/) · ← [5.4 手势事件设计灵魂](https://yccoding.com/pages/5b96db/) · → [5.6 跨进程通信设计](https://yccoding.com/pages/aaaaaa/) · ↔ [4.x 单线程模型的思想](https://yccoding.com/pages/5069b5/)
...
- [02.不同平台机制](#02不同平台机制)
  ...
  - [2.8 事件循环通用契约与跨端名词矩阵](#28-事件循环通用契约与跨端名词矩阵)
- [03.消息机制架构](#03消息机制架构)
  - [3.1 整体架构图](#31-整体架构图)
...
- [07.Looper设计原理](#07looper设计原理)
  ...
  - [7.7 事件循环架构矩阵（五端横向对比）](#77-事件循环架构矩阵五端横向对比)
...
- [09.性能优化设计思想](#09性能优化设计思想)
  ...
  - [9.5 典型陷阱与生产级反模式](#95-典型陷阱与生产级反模式)
- [10.设计思想总结与演进](#10设计思想总结与演进)
  ...
  - [10.5 跨端通用术语对照（一图带走）](#105-跨端通用术语对照一图带走)
  - [10.6 与本卷其它章节的呼应](#106-与本卷其它章节的呼应)
  - [10.7 通用心智总结（六句口诀）](#107-通用心智总结六句口诀)
