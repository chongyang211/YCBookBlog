...
| # | 案例 | 难度 | 时长 | 核心主题 | 卷一前置 |
|---|------|------|------|----------|---------|
| 01 | [学生通讯录系统](https://blog.csdn.net/m0_37700275/article/details/103251722) | ★☆☆☆☆ | 3 h | C 风格起步：`struct` + 数组 + 函数拆分 + `cin/cout` | **第 2-7 章** |
| 02 | [银行账户管理系统](https://blog.csdn.net/m0_37700275/article/details/103463225) | ★★★☆☆ | 8 h | OOP 进化：`class` 封装 + **多态**（普通/VIP/储蓄账户）+ CSV 持久化 | **第 8-10、13 章** |
| 03 | [校园身份预约系统](https://blog.csdn.net/m0_37700275/article/details/103627302) | ★★★★☆ | 10 h | 抽象身份 + **STL 全家桶**（vector/map/multimap）+ 多模块文件矩阵 + lambda 排序 | **第 9-10、13、16 章** |
