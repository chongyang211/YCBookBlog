...
> 💡 **为什么先写异常类？** —— 后面所有模块（Parser/Node/Db）都会 throw 异常。先把"地基"打好，写后续代码时一旦出错就有现成的异常类型可用，不必中途回头补。

---

### Step 1.1：JsonError 基类骨架
...
### Step 2.4：先写"裸 std::get"访问器（故意不抛友好异常）
...
### Step 2.5：升级访问器——抛友好的 TypeMismatchError
...
### Step 3.2：解析字面量 null / true / false
...
### Step 4.3：parseArray + parseObject（递归调用）
...
### Step 5.2：实现 Array/Object 与缩进美化
