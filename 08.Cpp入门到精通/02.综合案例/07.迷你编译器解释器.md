...
- [06.Visitor 类型检查](#06visitor-类型检查) 【阶段⑤访问者模式⭐】
  ...
  - [6.4 符号表栈](#64-符号表栈)
- [07.Codegen 字节码生成](#07codegen-字节码生成) 【阶段⑥指令集设计】
  - [7.1 灵魂三问：为什么不直接树遍历](#71-灵魂三问为什么不直接树遍历)
  - [7.2 OpCode 36 条指令](#72-opcode-36-条指令)
  - [7.3 Codegen 访问者](#73-codegen-访问者)
  - [7.4 跳转回填技术](#74-跳转回填技术)
  - [7.5 函数编译](#75-函数编译)
- [08.VM 栈式虚拟机](#08vm-栈式虚拟机) 【阶段⑦执行引擎⭐】
  - [8.1 灵魂三问：栈式 vs 寄存器式](#81-灵魂三问栈式-vs-寄存器式)
  - [8.2 Value 与求值栈](#82-value-与求值栈)
  - [8.3 主调度 switch 派发](#83-主调度-switch-派发)
  - [8.4 故意造 bug：跳转偏移错误](#84-故意造-bug跳转偏移错误)
  - [8.5 函数调用栈帧](#85-函数调用栈帧)
- [09.异常体系与 REPL 完善](#09异常体系与-repl-完善) 【阶段⑧收官】
  - [9.1 四级异常类树](#91-四级异常类树)
  - [9.2 接入文件模式](#92-接入文件模式)
  - [9.3 完整端到端验证](#93-完整端到端验证)
- [10.项目总结分析](#10项目总结分析)
- [11.项目技术思考](#11项目技术思考)
  - [11.1 AST 用 shared_ptr 还是 unique_ptr](#111-ast-用-shared_ptr-还是-unique_ptr)
  - [11.2 Visitor 模式的两种风格](#112-visitor-模式的两种风格)
  - [11.3 字节码 vs 树解释 vs JIT](#113-字节码-vs-树解释-vs-jit)
- [12.衔接与延伸](#12衔接与延伸)
  - [12.1 与 06 案例的差异](#121-与-06-案例的差异)
