...
- [4. stable_sort 的归并实现](#4-stable_sort-的归并实现)
  ...
  - [4.2 内存分配策略——原地 vs 分配缓冲区](#42-内存分配策略原地-vs-分配缓冲区)
...
- [6. 通用算法的核心范型](#6-通用算法的核心范型)
  - [6.1 find / count / search —— 线性扫描族](#61-find--count--search--线性扫描族)
  - [6.2 copy / move / transform —— 变换族](#62-copy--move--transform--变换族)
  - [6.3 unique / remove / erase —— 过滤族](#63-unique--remove--erase--过滤族)
  - [6.4 heap / merge / permutation —— 排序周边族](#64-heap--merge--permutation--排序周边族)
...
### 3.5 introsort 的汇编层证据——为什么 median-of-3 抗排序输入
...
### 6.4 heap / merge / permutation —— 排序周边族
