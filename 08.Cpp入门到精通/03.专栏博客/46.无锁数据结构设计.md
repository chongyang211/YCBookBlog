...
- [2. 架构概览](#2-架构概览)
  - [2.1 lock-free 的精确定义——不是"没有锁"是"至少一个线程在有限时间内推进"](#21-lock-free-的精确定义不是没有锁是至少一个线程在有限时间内推进)
  - [2.2 为何这么切——CAS 是唯一积木、内存序是胶水、内存回收是地基](#22-为何这么切cas-是唯一积木内存序是胶水内存回收是地基)
...
### 2.1 lock-free 的精确定义——不是"没有锁"是"至少一个线程在有限时间内推进"
...
### 2.2 为何这么切——CAS 是唯一积木、内存序是胶水、内存回收是地基
