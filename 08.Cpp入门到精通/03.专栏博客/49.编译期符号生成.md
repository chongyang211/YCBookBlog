...
- [2. 架构概览](#2-架构概览)
  - [2.1 为什么需要 name mangling——C 的全局符号空间 vs C++ 的命名空间+重载](#21-为什么需要-name-manglingc-的全局符号空间-vs-c-的命名空间重载)
  - [2.2 为何这么切——不同平台的 mangling 规则必然不同、extern \"C\" 是共同语言](#22-为何这么切不同平台的-mangling-规则必然不同extern-c-是共同语言)
...
### 2.1 为什么需要 name mangling——C 的全局符号空间 vs C++ 的命名空间+重载
...
### 2.2 为何这么切——不同平台的 mangling 规则必然不同、extern "C" 是共同语言
