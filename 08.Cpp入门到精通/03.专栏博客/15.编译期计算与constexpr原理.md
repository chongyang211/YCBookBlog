...
#### 目录介绍
- [引言](#引言)
- [一、为什么需要编译期计算？](#一为什么需要编译期计算)
- [二、模板元编程（TMP）](#二模板元编程tmp)
- [三、constexpr函数](#三constexpr函数)
- [四、constexpr变量与对象](#四constexpr变量与对象)
- [五、if constexpr（编译期分支）](#五if-constexpr编译期分支)
- [六、consteval和constinit (C++20)](#六consteval和constinit-c20)
- [七、C++20的constexpr增强](#七c20的constexpr增强)
- [八、折叠表达式 (C++17)](#八折叠表达式-c17)
- [九、编译期字符串与反射](#九编译期字符串与反射)
- [十、编译期计算的实际应用](#十编译期计算的实际应用)
- [十一、用户自定义字面量](#十一用户自定义字面量)
- [十二、编译期计算的性能影响](#十二编译期计算的性能影响)
- [十三、总结](#十三总结)
