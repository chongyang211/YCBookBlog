...
- [2. 架构概览](#2-架构概览)
  ...
  - [2.2 为何这么切——文本处理必须在语义分析之前](#22-为何这么切文本处理必须在语义分析之前)
...
> **下一篇**：预处理完成了——编译器拿到的是纯净的 C++ 文本。下一篇进入 [49.编译期符号生成](49.编译期符号生成.md)——name mangling 规则、Itanium ABI 命名、extern "C" 边界、重载在符号层的体现、demangle 工具——从文本到符号的下一步。
