...
### 9.13.2 三法则（Rule of Three, C++98 起）
...
### 9.13.3 五法则（Rule of Five, C++11 起）
...
### 9.13.4 零法则（Rule of Zero, 现代 C++ 推荐）
...
- 卷一第 11 章 [`11.内存模型`](./11.内存模型.md) —— 对象生命周期与构造/析构时机
- 卷一第 12 章 [`12.动态内存.md`](./12.动态内存.md) —— 智能指针与 RAII
- 卷一 [`18.特性图谱`](./18.特性图谱.md) §C++11 移动语义部分
