...
#### 目录介绍
- [2.1 C++快速介绍](#21-c快速介绍)
  - [2.1.1 C++语言介绍](#211-c语言介绍)
  - [2.1.2 C++的特点](#212-c的特点)
  - [2.1.3 C++标准库](#213-c标准库)
  - [2.1.4 C++应用领域](#214-c应用领域)
  - [2.1.5 C++的版本](#215-c的版本)
  - [2.1.6 综合案例与思考](#216-综合案例与思考)
- [2.2 C++编译器](#22-c编译器)
  - [2.2.1 编译器是什么](#221-编译器是什么)
  - [2.2.2 GCC编译器](#222-gcc编译器)
  - [2.2.3 Clang编译器](#223-clang编译器)
  - [2.2.4 MSVC编译器](#224-msvc编译器)
  - [2.2.5 IDE开发环境](#225-ide开发环境)
  - [2.2.6 在线编译器](#226-在线编译器)
  - [2.2.7 综合案例与思考](#227-综合案例与思考)
- [2.3 helloWorld](#23-helloworld)
  - [2.3.1 第一个案例](#231-第一个案例)
  - [2.3.2 编译代码](#232-编译代码)
  - [2.3.3 代码解读](#233-代码解读)
  - [2.3.4 综合案例与思考](#234-综合案例与思考)
- [2.4 编译C++](#24-编译c)
  - [2.4.0 最简单编译](#240-最简单编译)
  - [2.4.1 编译单个文件](#241-编译单个文件)
  - [2.4.2 编译多个文件](#242-编译多个文件)
  - [2.4.3 指定C++标准](#243-指定c标准)
  - [2.4.4 启用优化](#244-启用优化)
  - [2.4.5 生成调试信息](#245-生成调试信息)
  - [2.4.6 综合案例与思考](#246-综合案例与思考)
- [2.5 多种注释使用](#25-多种注释使用)
  - [2.5.1 单行注释](#251-单行注释)
  - [2.5.2 多行注释](#252-多行注释)
  - [2.5.3 文档注释工具](#253-文档注释工具)
  - [2.5.4 综合案例与思考](#254-综合案例与思考)
- [2.6 命名空间](#26-命名空间)
  - [2.6.1 命名空间概念](#261-命名空间概念)
  - [2.6.2 定义命名空间](#262-定义命名空间)
  - [2.6.3 访问命名空间成员](#263-访问命名空间成员)
  - [2.6.4 嵌套命名空间](#264-嵌套命名空间)
  - [2.6.5 匿名命名空间](#265-匿名命名空间)
  - [2.6.6 命名空间别名](#266-命名空间别名)
  - [2.6.7 标准命名空间](#267-标准命名空间)
  - [2.6.8 综合练习题](#268-综合练习题)
  - [2.6.9 综合案例与思考](#269-综合案例与思考)
- [2.7 头文件](#27-头文件)
  - [2.7.1 头文件扩展名](#271-头文件扩展名)
  - [2.7.2 头文件和实现类](#272-头文件和实现类)
  - [2.7.3 头文件保护](#273-头文件保护)
  - [2.7.4 模板类头文件](#274-模板类头文件)
  - [2.7.5 综合案例与思考](#275-综合案例与思考)
- [2.8 修饰符和标志符](#28-修饰符和标志符)
  - [2.8.1 访问控制修饰符](#281-访问控制修饰符)
  - [2.8.2 存储类型修饰符](#282-存储类型修饰符)
  - [2.8.3 类型限定符](#283-类型限定符)
  - [2.8.4 函数修饰符](#284-函数修饰符)
  - [2.8.5 类修饰符](#285-类修饰符)
  - [2.8.6 其他修饰符](#286-其他修饰符)
  - [2.8.7 标志符](#287-标志符)
  - [2.8.8 综合案例与思考](#288-综合案例与思考)
- [2.9 关键字](#29-关键字)
  - [2.9.1 数据类型关键字](#291-数据类型关键字)
  - [2.9.2 存储类型关键字](#292-存储类型关键字)
  - [2.9.3 控制语句关键字](#293-控制语句关键字)
  - [2.9.4 类和对象关键字](#294-类和对象关键字)
  - [2.9.5 异常处理关键字](#295-异常处理关键字)
  - [2.9.6 类型转换关键字](#296-类型转换关键字)
  - [2.9.7 操作符相关关键字](#297-操作符相关关键字)
  - [2.9.8 模板相关关键字](#298-模板相关关键字)
  - [2.9.9 命名空间相关关键字](#299-命名空间相关关键字)
  - [2.9.10 其他关键字](#2910-其他关键字)
  - [2.9.11 综合案例与思考](#2911-综合案例与思考)
...
## 2.X 卷一改造增补：从 Hello World 到现代 C++ 工程

> 本节为卷一新增。本章带你迈出第一步，但要写出能在团队、面试、生产环境立得住的现代 C++，还要补这几块。

### 2.X.1 现代 C++ 的 Hello World
...
- 卷一 [`01.Cpp简史`](./01.Cpp简史.md) —— 选哪个 C++ 版本上车
- 卷一 [`18.特性图谱`](./18.特性图谱.md) —— 学习路径地图
