...
- [16.5 STL迭代器](#165-stl迭代器)
  - [16.5.1 迭代器的分类](#1651-迭代器的分类)
  - [16.5.2 常用迭代器操作](#1652-常用迭代器操作)
  - [16.5.3 迭代器示例](#1653-迭代器示例)
  - [16.5.4 特殊迭代器](#1654-特殊迭代器)
  - [16.5.5 迭代器适配器](#1655-迭代器适配器)
- [16.6 STL适配器](#166-stl适配器)
- [16.7 STL函数对象](#167-stl函数对象)
...
## 16.X 卷一改造增补：STL 选型决策表 + Ranges 速览
...
- 卷一 [`18.特性图谱`](./18.特性图谱.md) §C++20 Ranges
