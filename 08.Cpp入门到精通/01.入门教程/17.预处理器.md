...
- [17.1 头文件](#171-头文件)
  ...
  - [17.1.3 头文件包含](#1713-头文件包含)
  - [17.1.4 综合案例与思考](#1714-综合案例与思考)
- [17.2 宏定义](#172-宏定义)
  - [17.2.1 什么是宏](#1721-什么是宏)
  - [17.2.2 基本语法](#1722-基本语法)
  - [17.2.3 宏的使用](#1723-宏的使用)
  - [17.2.4 宏的作用域](#1724-宏的作用域)
  - [17.2.5 宏与函数区别](#1725-宏与函数区别)
  - [17.2.6 宏的优缺点](#1726-宏的优缺点)
  - [17.2.7 综合案例与思考](#1727-综合案例与思考)
...
## 17.X 卷一改造增补：用现代特性替代宏 + C++20 Modules 展望
...
### 17.X.3 C++20 Modules：宏与头文件的终结者（展望）
...
- 卷一 [`18.特性图谱`](./18.特性图谱.md) §C++20 Modules
- 卷一 [`01.Cpp简史`](./01.Cpp简史.md) §C++20 四大支柱
