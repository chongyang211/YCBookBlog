# 16.IO流和File
#### 目录介绍
- [16.1 输入输出介绍](#161-输入输出介绍)
  - [16.1.1 输入输出流](#1611-输入输出流)
  - [16.1.2 I/O库头文件](#1612-io库头文件)
  - [16.1.3 标准输出流cout](#1613-标准输出流cout)
  - [16.1.4 标准输入流cin](#1614-标准输入流cin)
  - [16.1.5 标准错误流cerr](#1615-标准错误流cerr)
  - [16.1.6 标准日志流clog](#1616-标准日志流clog)
  - [16.1.7 综合案例与思考](#1617-综合案例与思考)
- [16.2 文件操作实践](#162-文件操作实践)
  - [16.2.1 文件是什么](#1621-文件是什么)
  - [16.2.2 文件类型分类](#1622-文件类型分类)
  - [16.2.3 操作文件类](#1623-操作文件类)
  - [16.2.4 文本文件写](#1624-文本文件写)
  - [16.2.5 文本文件读](#1625-文本文件读)
  - [16.2.6 文本文件读和写](#1626-文本文件读和写)
  - [16.2.7 二进制文件写](#1627-二进制文件写)
  - [16.2.8 二进制文件读](#1628-二进制文件读)
  - [16.2.9 综合案例与思考](#1629-综合案例与思考)
- [16.3 文件读写指针](#163-文件读写指针)
  - [16.3.1 文件错误与状态](#1631-文件错误与状态)
  - [16.3.2 文件的追加](#1632-文件的追加)
  - [16.3.3 文件结尾的判断](#1633-文件结尾的判断)
  - [16.3.4 在指定位置读/写文件](#1634-在指定位置读写文件)
  - [16.3.5 综合案例与思考](#1635-综合案例与思考)
- [16.4 错误处理](#164-错误处理)
  - [16.4.1 检查文件状态](#1641-检查文件状态)
  - [16.4.3 综合案例与思考](#1643-综合案例与思考)
- [16.5 IO综合案例](#165-io综合案例)
  - [16.5.1 键盘输入写文本文件](#1651-键盘输入写文本文件)
  - [16.5.2 实现文件复制](#1652-实现文件复制)
  - [16.5.3 合并两个文件信息](#1653-合并两个文件信息)
  - [16.5.4 文件加密](#1654-文件加密)
  - [16.5.5 在文件中查找关键词](#1655-在文件中查找关键词)
- [16.6 IO流底层原理](#166-io流底层原理)
  - [16.6.1 流缓冲区机制](#1661-流缓冲区机制)
  - [16.6.2 文件系统调用](#1662-文件系统调用)
  - [16.6.3 格式化输出的底层](#1663-格式化输出的底层)
- [16.7 IO流训练题](#167-io流训练题)
- [16.8 综合思考题](#168-综合思考题)
...
- 卷一 [`A4.Cpp11至Cpp23特性速览图谱`](./A4.Cpp11至Cpp23特性速览图谱.md) §C++17 / C++20 / C++23
- 卷一第 10 章 [`10.动态内存.md`](./10.动态内存.md) §10.11 RAII —— 文件流的 RAII 本质
