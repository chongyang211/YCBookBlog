...
- [5.2 选择结构](#52-选择结构)
  ...
  - [5.2.8 选择结构底层原理](#528-选择结构底层原理)
  - [5.2.9 选择结构训练题](#529-选择结构训练题)
  - [5.2.10 综合案例与思考](#5210-综合案例与思考)
- [5.3 循环结构](#53-循环结构)
  - [5.3.1 while循环语句](#531-while循环语句)
  - [5.3.2 do...while循环语句](#532-dowhile循环语句)
  - [5.3.3 for循环语句](#533-for循环语句)
  - [5.3.4 嵌套循环](#534-嵌套循环)
  - [5.3.5 循环结构底层原理](#535-循环结构底层原理)
  - [5.3.6 循环结构训练题](#536-循环结构训练题)
...
### 5.7.3 结构化绑定（Structured Bindings, C++17）
...
- 卷一 [`A4.Cpp11至Cpp23特性速览图谱`](./A4.Cpp11至Cpp23特性速览图谱.md) §C++17 部分
- 卷一第 9 章 [`09.函数提高.md`](./09.函数提高.md) —— 多返回值与 tuple
