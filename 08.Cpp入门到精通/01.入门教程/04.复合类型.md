...
#### 目录介绍
- [4.1 复合类型](#41-复合类型)
  - [4.1.1 复合数据类型](#411-复合数据类型)
  - [4.1.2 综合案例与思考](#412-综合案例与思考)
- [4.2 字符串](#42-字符串)
  - [4.2.1 字符串表示](#421-字符串表示)
  - [4.2.2 C风格字符串](#422-c风格字符串)
  - [4.2.3 C++风格字符串](#423-c风格字符串)
  - [4.2.4 综合案例与思考](#424-综合案例与思考)
- [4.3 string类](#43-string类)
  - [4.3.1 string类](#431-string类)
  - [4.3.2 声明和初始化](#432-声明和初始化)
  - [4.3.3 常用操作](#433-常用操作)
  - [4.3.4 字符串转换](#434-字符串转换)
  - [4.3.5 字符串输入](#435-字符串输入)
  - [4.3.6 字符串输出](#436-字符串输出)
  - [4.3.7 综合案例与思考](#437-综合案例与思考)
- [4.4 数组](#44-数组)
  - [4.4.1 数组基本概念](#441-数组基本概念)
  - [4.4.2 数组的声明](#442-数组的声明)
  - [4.4.3 数组初始化](#443-数组初始化)
  - [4.4.4 访问数组元素](#444-访问数组元素)
  - [4.4.5 多维数组](#445-多维数组)
  - [4.4.6 数组作为函数参数](#446-数组作为函数参数)
  - [4.4.7 动态数组](#447-动态数组)
  - [4.4.8 数组的总结](#448-数组的总结)
  - [4.4.9 综合案例与思考](#449-综合案例与思考)
- [4.5 联合体](#45-联合体)
  - [4.5.1 什么是联合体](#451-什么是联合体)
  - [4.5.2 联合体定义](#452-联合体定义)
  - [4.5.3 联合体特点](#453-联合体特点)
  - [4.5.4 联合体使用](#454-联合体使用)
  - [4.5.5 联合体与结构体](#455-联合体与结构体)
  - [4.5.6 匿名联合体](#456-匿名联合体)
  - [4.5.7 联合体应用场景](#457-联合体应用场景)
  - [4.5.8 注意事项](#458-注意事项)
  - [4.5.9 综合案例与思考](#459-综合案例与思考)
- [4.6 枚举](#46-枚举)
  - [4.6.1 无作用域枚举](#461-无作用域枚举)
  - [4.6.2 有作用域枚举](#462-有作用域枚举)
  - [4.6.3 枚举底层类型](#463-枚举底层类型)
  - [4.6.4 枚举应用场景](#464-枚举应用场景)
  - [4.6.5 枚举注意事项](#465-枚举注意事项)
  - [4.6.6 类型安全性](#466-类型安全性)
  - [4.6.7 综合案例与思考](#467-综合案例与思考)
- [4.7 结构体](#47-结构体)
  - [4.7.1 结构体定义](#471-结构体定义)
  - [4.7.2 结构体创建](#472-结构体创建)
  - [4.7.3 结构体与函数](#473-结构体与函数)
  - [4.7.4 结构体数组](#474-结构体数组)
  - [4.7.5 结构体嵌套](#475-结构体嵌套)
  - [4.7.6 结构体案例](#476-结构体案例)
  - [4.7.7 综合案例与思考](#477-综合案例与思考)
- [4.8 容器](#48-容器)
  - [4.8.1 vector](#481-vector)
  - [4.8.2 list](#482-list)
  - [4.8.4 map](#484-map)
  - [4.8.4 unordered_map](#484-unordered_map)
  - [4.8.5 array](#485-array)
  - [4.8.6 综合案例与思考](#486-综合案例与思考)
- [4.9 练习题](#49-练习题)
  - [4.9.1 数组冒泡排序](#491-数组冒泡排序)
  - [4.9.1 数组成绩统计](#491-数组成绩统计)
...
## 4.X 卷一改造增补：用现代容器替代裸数组与裸 union

> 本节为卷一新增。下面这些「老写法」在新代码里基本不该再出现。

### 4.X.1 数组 → `std::array` / `std::vector`
...
### 4.X.2 字符串视图 `std::string_view`（C++17）
...
- 卷一 §2.9 [`02.数据类型.md`](./02.数据类型.md) —— `byte`/`optional`/`variant`/`any`
- 卷一 [`A4.Cpp11至Cpp23特性速览图谱`](./A4.Cpp11至Cpp23特性速览图谱.md) §C++17 / C++20
