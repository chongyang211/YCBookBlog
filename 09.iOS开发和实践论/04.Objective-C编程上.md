...
1. @property关键字用于声明属性。
2. nonatomic关键字用于指定非原子性访问，提高性能。
3. strong、weak、copy等关键字用于指定属性的内存管理方式。
4. readonly关键字用于指定只读属性，只生成getter方法。
5. readwrite关键字用于指定可读写属性，生成getter和setter方法。
...
- Objective-C学习笔记:https://www.cnblogs.com/pannengzhi/p/objc-basics.html
- 
