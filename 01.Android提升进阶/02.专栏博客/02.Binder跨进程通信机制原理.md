...
#### 目录介绍
- [一、引言：为什么Android选择Binder](#一引言为什么android选择binder)
- [二、Linux传统IPC机制对比](#二linux传统ipc机制对比)
- [三、Binder的整体架构](#三binder的整体架构)
- [四、Binder驱动的内核实现](#四binder驱动的内核实现)
- [五、mmap与一次拷贝原理](#五mmap与一次拷贝原理)
- [六、Binder通信协议与数据传输](#六binder通信协议与数据传输)
- [七、ServiceManager的角色与实现](#七servicemanager的角色与实现)
- [八、AIDL与Proxy-Stub模式](#八aidl与proxy-stub模式)
- [九、Binder线程池管理](#九binder线程池管理)
- [十、Binder中的引用计数与生命周期](#十binder中的引用计数与生命周期)
- [十一、Binder的安全机制](#十一binder的安全机制)
- [十二、Binder在Framework层的应用](#十二binder在framework层的应用)
- [十三、Binder的性能分析与优化](#十三binder的性能分析与优化)
