...
#### 目录介绍
- [一、引言：从setContentView到像素显示](#一引言从setcontentview到像素显示)
- [二、View树与ViewRootImpl](#二view树与viewrootimpl)
- [三、Measure过程深度剖析](#三measure过程深度剖析)
- [四、Layout过程深度剖析](#四layout过程深度剖析)
- [五、Draw过程深度剖析](#五draw过程深度剖析)
- [六、MeasureSpec的设计原理](#六measurespec的设计原理)
- [七、自定义View的绘制流程](#七自定义view的绘制流程)
- [八、硬件加速渲染原理](#八硬件加速渲染原理)
- [九、VSync与Choreographer](#九vsync与choreographer)
- [十、Surface与SurfaceFlinger](#十surface与surfaceflinger)
- [十一、RenderThread与GPU渲染](#十一renderthread与gpu渲染)
- [十二、invalidate与requestLayout的区别](#十二invalidate与requestlayout的区别)
- [十三、布局优化与渲染性能](#十三布局优化与渲染性能)
- [十四、面试高频问题与深度分析](#十四面试高频问题与深度分析)
- [十五、总结](#十五总结)
