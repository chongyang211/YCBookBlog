...
ssh-keygen -t rsa -b 4096 -C "chongyyang@tencent.com"

ssh-copy-id -i ~/.ssh/id_rsa.pub chongyyang@9.135.180.168

ssh chongyyang@9.135.180.168

git config --global user.name "chongyyang"
git config --global user.email "chongyyang@tencent.com"
