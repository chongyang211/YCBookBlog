...
- 1.2 遇到问题说明：如何理解`FPS`，`FPS`是怎么计算的。如何完成一桢的交互工作？
- 2.1 什么是流畅度：`Android`系统要求每一帧都要在 16ms 内绘制完成，是指UI屏幕上的呈现过程中的连贯性和平滑性，对体验很重要！
- 2.3 影响流畅度因素：有许多因素影响流畅度，比如帧率，UI线程阻塞，内存，优化绘制，动画设计等。
