...
#### 目录介绍
- [01.桥接模式基础](#01桥接模式基础)
  - [1.1 桥接模式由来](#11-桥接模式由来)
  - [1.2 桥接模式定义](#12-桥接模式定义)
  - [1.3 桥接模式场景](#13-桥接模式场景)
  - [1.4 桥接模式思考](#14-桥接模式思考)
  - [1.5 解决的问题](#15-解决的问题)
- [02.桥接模式实现](#02桥接模式实现)
  - [2.1 罗列一个场景](#21-罗列一个场景)
  - [2.2 桥接结构](#22-桥接结构)
  - [2.3 桥接基本实现](#23-桥接基本实现)
...
- [04.桥接实现方式](#04桥接实现方式)
  - [4.1 继承和组合](#41-继承和组合)
  - [4.2 接口和内部类](#42-接口和内部类)
- [05.桥接模式分析](#05桥接模式分析)
  - [5.1 桥接模式优点](#51-桥接模式优点)
  - [5.2 桥接模式缺点](#52-桥接模式缺点)
  - [5.3 适用环境](#53-适用环境)
  - [5.4 模式拓展](#54-模式拓展)
- [06.外观代理总结](#06外观代理总结)
