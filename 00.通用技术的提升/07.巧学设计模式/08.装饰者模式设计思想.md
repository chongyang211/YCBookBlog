# 08.装饰者模式设计思想
#### 目录介绍
- [01.装饰者模式基础](#01装饰者模式基础)
    - [1.1 装饰者模式由来](#11-装饰者模式由来)
    - [1.2 装饰者模式定义](#12-装饰者模式定义)
    - [1.3 装饰者模式场景](#13-装饰者模式场景)
    - [1.4 装饰者模式思考](#14-装饰者模式思考)
- [02.装饰者模式实现](#02装饰者模式实现)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 装饰者结构](#22-装饰者结构)
    - [2.3 装饰者基本实现](#23-装饰者基本实现)
- [03.装饰者实例演示](#03装饰者实例演示)
    - [3.1 需求分析](#31-需求分析)
    - [3.2 案例基础实现](#32-案例基础实现)
    - [3.3 演变设计思想](#33-演变设计思想)
    - [3.4 使用装饰者模式](#34-使用装饰者模式)
    - [3.5 装饰器能否精简](#35-装饰器能否精简)
    - [3.6 透明性的要求](#36-透明性的要求)
    - [3.7 半透明装饰者模式](#37-半透明装饰者模式)
- [04.装饰器模式场景](#04装饰器模式场景)
    - [4.1 IO流中装饰者模式](#41-io流中装饰者模式)
    - [4.2 IO流设计结构](#42-io流设计结构)
    - [4.3 半透明装饰者模式](#43-半透明装饰者模式)
    - [4.4 InputStream装饰者模式](#44-inputstream装饰者模式)
- [05.装饰器模式分析](#05装饰器模式分析)
    - [5.1 装饰模式优点](#51-装饰模式优点)
    - [5.2 装饰模式缺点](#52-装饰模式缺点)
    - [5.3 总结一下学习](#53-总结一下学习)
    - [5.4 更多内容推荐](#54-更多内容推荐)
