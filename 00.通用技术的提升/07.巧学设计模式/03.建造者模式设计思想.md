# 03.建造者模式设计思想
#### 目录介绍
- [01.建造者模式介绍](#01建造者模式介绍)
    - [1.1 建造者模式由来](#11-建造者模式由来)
    - [1.2 建造者模式定义](#12-建造者模式定义)
    - [1.3 建造者模式场景](#13-建造者模式场景)
    - [1.4 建造者模式思考](#14-建造者模式思考)
- [02.建造者模式实现](#02建造者模式实现)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 创造对象弊端场景](#22-创造对象弊端场景)
    - [2.3 案例演变分析](#23-案例演变分析)
    - [2.4 用例子理解建造者](#24-用例子理解建造者)
- [03.建造者模式分析](#03建造者模式分析)
    - [3.1 建造者模式结构图](#31-建造者模式结构图)
    - [3.2 建造者模式时序图](#32-建造者模式时序图)
    - [3.3 基本代码实现](#33-基本代码实现)
- [04.建造者案例实践](#04建造者案例实践)
    - [4.1 盖房子案例开发](#41-盖房子案例开发)
    - [4.2 普通盖房子开发](#42-普通盖房子开发)
    - [4.3 构造者优化盖房子](#43-构造者优化盖房子)
- [05.建造者模式拓展](#05建造者模式拓展)
    - [5.1 建造者能简化吗](#51-建造者能简化吗)
    - [5.2 和工厂模式区别](#52-和工厂模式区别)
- [06.建造者优缺点分析](#06建造者优缺点分析)
    - [6.1 优点有哪些](#61-优点有哪些)
    - [6.2 不足的点分析](#62-不足的点分析)
- [07.构造者模式总结](#07构造者模式总结)
    - [7.1 该模式总结](#71-该模式总结)
