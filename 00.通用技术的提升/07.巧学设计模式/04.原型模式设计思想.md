...
#### 目录介绍
- [01.原型模式介绍](#01原型模式介绍)
    - [1.1 原型模式由来](#11-原型模式由来)
    - [1.2 原型模式定义](#12-原型模式定义)
    - [1.3 原型模式场景](#13-原型模式场景)
    - [1.4 原型模式思考](#14-原型模式思考)
- [02.原型模式原理与实现](#02原型模式原理与实现)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 用例子理解原型](#22-用例子理解原型)
    - [2.3 案例演变分析](#23-案例演变分析)
    - [2.4 原型模式基本实现](#24-原型模式基本实现)
- [03.原型模式分析](#03原型模式分析)
    - [3.1 原型模式VS工厂模式](#31-原型模式vs工厂模式)
    - [3.2 原型模式VS深拷贝](#32-原型模式vs深拷贝)
- [04.原型模式应用解析](#04原型模式应用解析)
    - [4.1 使用clone方法](#41-使用clone方法)
    - [4.2 实现接口Cloneable](#42-实现接口cloneable)
    - [4.3 深克隆和浅克隆](#43-深克隆和浅克隆)
- [05.原型模式总结](#05原型模式总结)
    - [5.1 优缺点分析](#51-优缺点分析)
    - [5.2 有哪些弊端](#52-有哪些弊端)
    - [5.3 应用环境说明](#53-应用环境说明)
- [06.原型模式拓展应用](#06原型模式拓展应用)
    - [6.1 模式扩展](#61-模式扩展)
    - [6.2 原型模式总结](#62-原型模式总结)
    - [6.3 更多内容推荐](#63-更多内容推荐)
