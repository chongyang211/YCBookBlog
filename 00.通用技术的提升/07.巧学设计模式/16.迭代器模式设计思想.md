# 16.迭代器模式设计思想
#### 目录介绍
- [01.迭代器模式基础](#01迭代器模式基础)
  - [1.1 迭代器模式由来](#11-迭代器模式由来)
  - [1.2 迭代器模式定义](#12-迭代器模式定义)
  - [1.3 迭代器模式场景](#13-迭代器模式场景)
  - [1.4 迭代器模式思考](#14-迭代器模式思考)
  - [1.5 主要解决的问题](#15-主要解决的问题)
- [02.迭代器模式原理](#02迭代器模式原理)
  - [2.1 罗列一个场景](#21-罗列一个场景)
  - [2.2 用例子理解迭代器](#22-用例子理解迭代器)
  - [2.3 案例实现过程](#23-案例实现过程)
  - [2.4 迭代器实现步骤](#24-迭代器实现步骤)
- [03.迭代器模式结构](#03迭代器模式结构)
  - [3.1 迭代器标准案例](#31-迭代器标准案例)
  - [3.2 迭代器模式结构图](#32-迭代器模式结构图)
  - [3.3 迭代器模式时序图](#33-迭代器模式时序图)
- [04.迭代器模式案例](#04迭代器模式案例)
  - [4.1 Java中Iterator接口](#41-java中iterator接口)
  - [4.2 迭代器遍历案例](#42-迭代器遍历案例)
  - [4.3 遍历时不建议删除元素](#43-遍历时不建议删除元素)
  - [4.4 for循环VS迭代器](#44-for循环vs迭代器)
  - [4.5 迭代器原理介绍](#45-迭代器原理介绍)
  - [4.6 迭代器模式优势](#46-迭代器模式优势)
- [05.迭代器者模式分析](#05迭代器者模式分析)
  - [5.1 迭代器模式优点](#51-迭代器模式优点)
  - [5.2 迭代器模式缺点](#52-迭代器模式缺点)
  - [5.3 适用环境](#53-适用环境)
  - [5.4 思考题考察](#54-思考题考察)
- [06.观察者模式总结](#06观察者模式总结)
  - [6.1 总结一下学习](#61-总结一下学习)
  - [6.2 更多内容推荐](#62-更多内容推荐)
