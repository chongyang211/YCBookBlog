# 06.动态代理设计模式
#### 目录介绍
- [01.为何要动态代理](#01为何要动态代理)
    - [1.1 为何要动态代理](#11-为何要动态代理)
    - [1.2 动态代理思考](#12-动态代理思考)
- [02.动态代理的概念](#02动态代理的概念)
    - [2.1 动态代理定义](#21-动态代理定义)
    - [2.2 动态代理类比理解](#22-动态代理类比理解)
    - [2.3 动态代理参与者](#23-动态代理参与者)
    - [2.4 动态代理步骤](#24-动态代理步骤)
- [03.动态代理的实现](#03动态代理的实现)
    - [3.1 罗列一个场景](#31-罗列一个场景)
    - [3.2 用一个例子理解代理](#32-用一个例子理解代理)
    - [3.3 基于接口动态代理](#33-基于接口动态代理)
    - [3.4 基于类动态代理](#34-基于类动态代理)
    - [3.5 动态代理模版代码](#35-动态代理模版代码)
- [04.动态代理案例](#04动态代理案例)
    - [4.1 动态代理和反射](#41-动态代理和反射)
    - [4.2 Java中代理](#42-java中代理)
    - [4.3 Retrofit核心思想](#43-retrofit核心思想)
- [05.动态代理思想和原理](#05动态代理思想和原理)
    - [5.1 动态代理实现机制](#51-动态代理实现机制)
    - [5.2 动态代理思想](#52-动态代理思想)
    - [5.3 动态代理存在的问题](#53-动态代理存在的问题)
    - [5.4 动态代理的优势](#54-动态代理的优势)
- [06.动态代理总结](#06动态代理总结)
