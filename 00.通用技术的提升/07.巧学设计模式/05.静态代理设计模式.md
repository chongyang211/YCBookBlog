# 05.静态代理设计模式
#### 目录介绍
- [01.静态代理模式基础](#01静态代理模式基础)
    - [1.1 静态代理由来](#11-静态代理由来)
    - [1.2 静态代理定义](#12-静态代理定义)
    - [1.3 静态代理场景](#13-静态代理场景)
    - [1.4 静态代理思考](#14-静态代理思考)
- [02.静态代理原理与实现](#02静态代理原理与实现)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 用一个例子理解代理](#22-用一个例子理解代理)
    - [2.3 案例演变分析](#23-案例演变分析)
- [03.静态代理分析](#03静态代理分析)
    - [3.1 静态代理结构图](#31-静态代理结构图)
    - [3.2 静态代理时序图](#32-静态代理时序图)
- [04.代理模式优势](#04代理模式优势)
    - [4.1 如何降低耦合](#41-如何降低耦合)
    - [4.2 保护真实对象使用权限](#42-保护真实对象使用权限)
- [05.静态代理不足](#05静态代理不足)
    - [5.1 静态代理类优缺点](#51-静态代理类优缺点)
    - [5.2 静态代理缺乏灵活](#52-静态代理缺乏灵活)
    - [5.3 静态代理复用难](#53-静态代理复用难)
    - [5.4 难以动态添加功能](#54-难以动态添加功能)
    - [5.5 无法实现多态](#55-无法实现多态)
    - [5.6 思考一下局限性](#56-思考一下局限性)
    - [5.7 动态代理弥补不足](#57-动态代理弥补不足)
- [06.静态代理总结](#06静态代理总结)
