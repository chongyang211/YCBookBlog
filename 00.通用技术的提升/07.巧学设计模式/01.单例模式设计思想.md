# 01.单例模式设计思想
#### 目录介绍
- [01.单例模式基础介绍](#01单例模式基础介绍)
  - [1.1 模式的动机](#11-模式的动机)
  - [1.2 单例模式特点](#12-单例模式特点)
  - [1.3 单例模式定义](#13-单例模式定义)
  - [1.4 单例使用场景](#14-单例使用场景)
  - [1.5 单例模式思考](#15-单例模式思考)
- [02.单例模式设计思考](#02单例模式设计思考)
  - [2.1 为何要用单例](#21-为何要用单例)
  - [2.2 处理资源访问冲突](#22-处理资源访问冲突)
  - [2.3 表示全局唯一类](#23-表示全局唯一类)
- [03.如何实现单例模式](#03如何实现单例模式)
  - [3.1 如何实现一个单例](#31-如何实现一个单例)
  - [3.2 饿汉式实现方式](#32-饿汉式实现方式)
  - [3.3 懒汉式实现方式](#33-懒汉式实现方式)
  - [3.4 双重DCL校验模式](#34-双重dcl校验模式)
  - [3.5 静态内部类方式](#35-静态内部类方式)
  - [3.6 枚举方式单例](#36-枚举方式单例)
  - [3.7 容器实现单例模式](#37-容器实现单例模式)
  - [3.8 优缺点分析](#38-优缺点分析)
- [04.单例模式有那些不友好](#04单例模式有那些不友好)
  - [4.1 单例是反模式吗](#41-单例是反模式吗)
  - [4.2 单例对OOP不友好](#42-单例对oop不友好)
  - [4.3 隐藏类之间依赖](#43-隐藏类之间依赖)
  - [4.4 代码扩展性不友好](#44-代码扩展性不友好)
  - [4.5 可测试性不友好](#45-可测试性不友好)
  - [4.6 不支持有参构造函数](#46-不支持有参构造函数)
  - [4.7 有何替代解决方案](#47-有何替代解决方案)
- [05.最后总结一下](#05最后总结一下)
  - [5.1 适用环境分析](#51-适用环境分析)
  - [5.2 对单例总结下](#52-对单例总结下)
