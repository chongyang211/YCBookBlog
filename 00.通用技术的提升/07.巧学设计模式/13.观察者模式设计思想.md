# 13.观察者模式设计思想
#### 目录介绍
- [01.观察者模式基础](#01观察者模式基础)
    - [1.1 观察者模式由来](#11-观察者模式由来)
    - [1.2 观察者模式定义](#12-观察者模式定义)
    - [1.3 观察者模式场景](#13-观察者模式场景)
    - [1.4 观察者模式思考](#14-观察者模式思考)
- [02.观察者模式实现](#02观察者模式实现)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 用例子理解观察者](#22-用例子理解观察者)
    - [2.3 案例演变分析](#23-案例演变分析)
    - [2.4 观察者模式基本实现](#24-观察者模式基本实现)
- [03.观察者模式分析](#03观察者模式分析)
    - [3.1 观察者模式案例](#31-观察者模式案例)
    - [3.2 观察者模式结构图](#32-观察者模式结构图)
    - [3.3 观察者模式时序图](#33-观察者模式时序图)
- [04.观察者模式优缺点](#04观察者模式优缺点)
    - [4.1 优点分析](#41-优点分析)
    - [4.2 缺点分析](#42-缺点分析)
    - [4.3 符合设计原则分析](#43-符合设计原则分析)
- [05.观察者模式使用](#05观察者模式使用)
