...
#### 目录介绍
- [01.模版模式基础](#01模版模式基础)
    - [1.1 模版模式由来](#11-模版模式由来)
    - [1.2 模版模式定义](#12-模版模式定义)
    - [1.3 模版模式场景](#13-模版模式场景)
    - [1.4 模版模式思考](#14-模版模式思考)
    - [1.5 模版模式特点](#15-模版模式特点)
    - [1.6 理解模版唯一性](#16-理解模版唯一性)
    - [1.7 主要解决问题](#17-主要解决问题)
- [02.模版模式原理](#02模版模式原理)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 用例子理解模版](#22-用例子理解模版)
    - [2.3 需求普通实现](#23-需求普通实现)
    - [2.4 案例演变实现](#24-案例演变实现)
    - [2.5 模版模式实现步骤](#25-模版模式实现步骤)
- [03.模版模式结构](#03模版模式结构)
    - [3.1 模版标准案例](#31-模版标准案例)
    - [3.2 模版模式结构](#32-模版模式结构)
    - [3.3 模版模式时序图](#33-模版模式时序图)
- [04.模版模式案例分析](#04模版模式案例分析)
    - [4.1 角色分析](#41-角色分析)
    - [4.2 拓展一个场景](#42-拓展一个场景)
    - [4.3 模版模式实践](#43-模版模式实践)
- [05.模版者模式分析](#05模版者模式分析)
    - [5.1 模版模式优点](#51-模版模式优点)
    - [5.2 模版模式缺点](#52-模版模式缺点)
    - [5.3 使用建议说明](#53-使用建议说明)
    - [5.4 思考题考察](#54-思考题考察)
