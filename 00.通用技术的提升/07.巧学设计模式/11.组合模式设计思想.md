...
#### 目录介绍
- [01.组合模式基础](#01组合模式基础)
    - [1.1 组合模式由来](#11-组合模式由来)
    - [1.2 组合模式定义](#12-组合模式定义)
    - [1.3 组合模式场景](#13-组合模式场景)
    - [1.4 组合模式思考](#14-组合模式思考)
    - [1.5 解决的问题](#15-解决的问题)
- [02.组合模式实现](#02组合模式实现)
    - [2.1 罗列一个场景](#21-罗列一个场景)
    - [2.2 组合结构](#22-组合结构)
    - [2.3 组合基本实现](#23-组合基本实现)
    - [2.4 有哪些注意点](#24-有哪些注意点)
- [03.组合实例演示](#03组合实例演示)
    - [3.1 需求分析](#31-需求分析)
    - [3.2 代码案例实现](#32-代码案例实现)
    - [3.3 是否可以优化](#33-是否可以优化)
    - [3.4 组合设计](#34-组合设计)
    - [3.5 演变代码案例](#35-演变代码案例)
- [04.组合实现方式](#04组合实现方式)
    - [4.1 组合模式分类](#41-组合模式分类)
    - [4.2 案例分析](#42-案例分析)
    - [4.3 透明式组合](#43-透明式组合)
    - [4.4 安全式组合](#44-安全式组合)
- [05.组合模式分析](#05组合模式分析)
    - [5.1 组合模式优点](#51-组合模式优点)
    - [5.2 组合模式缺点](#52-组合模式缺点)
    - [5.3 适用环境](#53-适用环境)
    - [5.4 模式拓展](#54-模式拓展)
    - [5.5 使用建议说明](#55-使用建议说明)
- [06.外观代理总结](#06外观代理总结)
