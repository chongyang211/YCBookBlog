...
#### 目录介绍
- [00.从一次"用户密码被脱库"事故说起](#00从一次用户密码被脱库事故说起)
...
- [04.对称加密：从 DES 到 AES 与 ChaCha20](#04对称加密从-des-到-aes-与-chacha20)
...
- [05.非对称加密：RSA 的数学魔法](#05非对称加密rsa-的数学魔法)
...
- [11.量子计算的威胁与后量子密码](#11量子计算的威胁与后量子密码)
    - [11.1 Shor 算法的杀伤力](#111-shor-算法的杀伤力)
    - [11.2 后量子密码标准](#112-后量子密码标准)
- [12.一句话总结：加密的设计哲学](#12一句话总结加密的设计哲学)
...
## 04.对称加密：从 DES 到 AES 与 ChaCha20

### 4.1 DES 的兴衰：56 位密钥的悲剧
...
### 9.3 iOS Keychain 与 Secure Enclave
