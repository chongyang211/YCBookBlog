...
#### 目录介绍
- [00.从一次"Activity has leaked window"事故说起](#00从一次activity-has-leaked-window事故说起)
...
- [11.经典陷阱与生产级反模式](#11经典陷阱与生产级反模式)
  - [11.1 陷阱一：用 Application Context 创建业务窗口](#111-陷阱一：用-application-context-创建业务窗口)
  - [11.2 陷阱二：父窗口已销毁后 dismiss 子窗口（§0 现场）](#112-陷阱二：父窗口已销毁后-dismiss-子窗口（§0-现场）)
  - [11.3 陷阱三：滥用 TYPE_APPLICATION_OVERLAY](#113-陷阱三：滥用-type_application_overlay)
  - [11.4 陷阱四：在 onCreate 中获取窗口尺寸](#114-陷阱四：在-oncreate-中获取窗口尺寸)
  - [11.5 陷阱五：依赖不同设备的 Z 序表现](#115-陷阱五：依赖不同设备的-z-序表现)
  - [11.6 陷阱六：输入法弹起遮挡输入框](#116-陷阱六：输入法弹起遮挡输入框)
  - [11.7 陷阱七：SurfaceView 已销毁后继续 lockCanvas](#117-陷阱七：surfaceview-已销毁后继续-lockcanvas)
...
## 00.从一次"Activity has leaked window"事故说起
...
### 11.1 陷阱一：用 Application Context 创建业务窗口
...
### 11.2 陷阱二：父窗口已销毁后 dismiss 子窗口（§0 现场）
...
### 11.3 陷阱三：滥用 TYPE_APPLICATION_OVERLAY
...
### 11.7 陷阱七：SurfaceView 已销毁后继续 lockCanvas
