...
#### 目录介绍
- [00.从一次"Activity 泄漏 200MB"事故说起](#00从一次activity-泄漏-200mb事故说起)
...
- [03.可达性模型：GC 看到的世界](#03可达性模型gc-看到的世界)
  ...
  - [3.3 引用计数 vs 追踪式的语义差异](#33-引用计数-vs-追踪式的语义差异)
- [04.强引用：默认却最危险](#04强引用默认却最危险)
  - [4.1 为什么强引用是默认](#41-为什么强引用是默认)
  - [4.2 引用计数实现：shared_ptr 的控制块](#42-引用计数实现shared_ptr-的控制块)
...
### 6.4 weak vs unowned：Swift 的精细化
