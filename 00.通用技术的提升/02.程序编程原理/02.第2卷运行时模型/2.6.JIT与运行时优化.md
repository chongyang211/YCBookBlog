...
> 🔗 **延伸阅读**：← [2.5 字节码与虚拟机执行原理](./2.5.字节码与虚拟机执行原理.md) · → [2.7 反射与元编程核心设计](./2.7.反射与元编程核心设计.md) · → [2.8 异常机制设计原理](./2.8.异常机制设计原理.md) · → [4.x 缓存局部性原理](../04.第4卷内存的真相/)
...
### 2.3 OSR（On-Stack Replacement）：栈上替换
...
### 5.5 Class Hierarchy Analysis（CHA）：JIT 的"单态宣言"
...
- 内存视角：[4.x 缓存局部性原理](../04.第4卷内存的真相/) ｜ [4.x 内存模型技术设计](../04.第4卷内存的真相/)
- 经典文献：
