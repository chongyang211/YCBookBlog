...
#### 目录介绍
- [00.真实事故引入](#00真实事故引入)
- [01.虚拟机的本质：建造一台"逻辑 CPU"](#01虚拟机的本质建造一台逻辑-cpu)
- [02.字节码到底长什么样](#02字节码到底长什么样)
- [03.栈式 VM vs 寄存器式 VM](#03栈式-vm-vs-寄存器式-vm)
- [04.解释器的进化之路](#04解释器的进化之路)
- [05.字节码验证与沙箱安全](#05字节码验证与沙箱安全)
- [06.WebAssembly：把 VM 思想推到极致](#06webassembly把-vm-思想推到极致)
...
### 3.1 栈式 VM：JVM、CPython、WebAssembly
...
### 3.2 寄存器式 VM：Lua、Dalvik、V8 Ignition
...
### 4.2 Direct Threading（直接线索）：解释器的飞跃
...
### 5.1 为什么 Java applet 在 1996 年震惊业界
...
### 7.2 陷阱二：动态加载的字节码可能绕过 SecurityManager
