...
- [2.通信设计哲学](#2通信设计哲学)
  ...
  - [2.5 设计决策树](#25-设计决策树)
- [3.通信原理深析](#3通信原理深析)
  - [3.1 数学本质：Happens-Before 偏序](#31-数学本质happens-before-偏序)
...
- [4.共享内存模型深度剖析](#4共享内存模型深度剖析)
  ...
  - [4.2 等待与通知：Condition Variable](#42-等待与通知condition-variable)
...
- [6.Java 线程通信全景](#6java-线程通信全景)
  - [6.1 wait/notify 与 Object Monitor](#61-waitnotify-与-object-monitor)
  - [6.2 Lock + Condition](#62-lock--condition)
  - [6.3 BlockingQueue](#63-blockingqueue)
  - [6.4 CountDownLatch / CyclicBarrier / Phaser](#64-countdownlatch--cyclicbarrier--phaser)
  - [6.5 Semaphore](#65-semaphore)
  - [6.6 Future / CompletableFuture](#66-future--completablefuture)
...
- [7.C++/Go/Rust 通信对比](#7cgorust-通信对比)
  ...
  - [7.3 Rust：所有权 + 编译期防数据竞争](#73-rust所有权--编译期防数据竞争)
...
### 6.1 wait/notify 与 Object Monitor
...
### 6.4 CountDownLatch / CyclicBarrier / Phaser
...
### 9.2 案例：BlockingQueue vs Disruptor 的 100 倍差距
