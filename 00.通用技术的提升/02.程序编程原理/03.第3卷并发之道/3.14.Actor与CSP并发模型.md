...
> 🔗 **延伸阅读**：← [3.13 协程核心设计思想](./3.13.协程核心设计思想.md) · ← [3.9 锁核心设计和思想](./3.9.锁核心设计和思想.md) · → [3.15 线程池的设计思想](./3.15.线程池的设计思想.md) · → [3.18 结构化并发设计思想](./3.18.结构化并发设计思想.md) · → [5.x 消息机制设计思想](../05.第5卷交互系统/)
...
- 第 5 卷视角：[5.x 消息机制设计思想](../05.第5卷交互系统/)（事件循环 + 消息队列的实战）
- 经典文献：
