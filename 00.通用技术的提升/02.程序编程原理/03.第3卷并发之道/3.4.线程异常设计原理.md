...
- [5.线程异常的核心问题](#5线程异常的核心问题)
  ...
  - [5.3 UncaughtExceptionHandler 全景](#53-uncaughtexceptionhandler-全景)
  - [5.4 InterruptedException 的特殊地位](#54-interruptedexception-的特殊地位)
- [6.异常整体框架](#6异常整体框架)
...
- [7.异常捕获原理](#7异常捕获原理)
  ...
  - [7.3 fillInStackTrace 与性能陷阱](#73-fillinstacktrace-与性能陷阱)
...
### 5.3 UncaughtExceptionHandler 全景
...
### 5.4 InterruptedException 的特殊地位
...
### 9.3 案例：Go panic 跨 goroutine 不传染
