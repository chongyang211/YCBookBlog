...
#### 目录介绍
- [00.真实事故引入](#00真实事故引入)
- [01.Executor 框架的设计哲学](#01executor-框架的设计哲学)
- [02.ThreadPoolExecutor 解剖：源码级](#02threadpoolexecutor-解剖源码级)
- [03.execute 流程的"三段论"设计](#03execute-流程的三段论设计)
- [04.Worker 内部类：复用与不可重入的精妙](#04worker-内部类复用与不可重入的精妙)
- [05.状态流转：5 状态 4 转换的状态机](#05状态流转5-状态-4-转换的状态机)
- [06.跨语言线程池实现对照](#06跨语言线程池实现对照)
- [07.源码级经典陷阱](#07源码级经典陷阱)
- [08.一句话总结](#08一句话总结)
...
### 1.4 ThreadPoolExecutor 的 7 个核心参数
...
## 02.ThreadPoolExecutor 解剖：源码级

### 2.1 ctl 变量：把"状态 + 线程数"塞进一个 int
...
### 7.1 陷阱一：Executors 工厂方法的内存炸弹（§0.1）
...
### 7.2 陷阱二：core == max 让 keepAliveTime 无意义
...
### 7.4 陷阱四：prestartCoreThread 的存在意义
