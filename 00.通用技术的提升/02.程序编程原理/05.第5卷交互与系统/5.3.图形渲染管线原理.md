...
#### 目录介绍
- [00.真实事故引入](#00真实事故引入)
- [01.像素的完整旅程：8 阶段流水线](#01像素的完整旅程8-阶段流水线)
- [02.双缓冲与 VSync：撕裂与卡顿的工程权衡](#02双缓冲与-vsync撕裂与卡顿的工程权衡)
- [03.合成器（Compositor）：分层渲染的革命](#03合成器compositor分层渲染的革命)
- [04.从 OpenGL 到 Vulkan：图形 API 的代际更替](#04从-opengl-到-vulkan图形-api-的代际更替)
- [05.Skia：跨平台 2D 渲染的事实标准](#05skia跨平台-2d-渲染的事实标准)
...
### 0.2 一个"看似 60fps"的列表，profiler 却说"频繁丢帧"
...
## 03.合成器（Compositor）：分层渲染的革命

### 3.1 §0.4 第四题：为什么需要"分层"
...
## 04.从 OpenGL 到 Vulkan：图形 API 的代际更替
