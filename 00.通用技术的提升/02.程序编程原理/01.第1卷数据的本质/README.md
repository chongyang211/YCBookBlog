...
| 序号 | 文档 | 核心矛盾 |
|------|------|---------|
| 1.1 | [数据编码设计原理](./1.1.数据编码设计原理.md) | 全人类文字如何在 0/1 上达成共识？ASCII → Unicode → UTF-8 |
| 1.2 | [整型与位运算原理](./1.2.整型与位运算原理.md) | 为什么是补码？整数溢出与位运算背后的硬件约束 |
| 1.3 | [浮点型数据设计灵魂](./1.3.浮点型数据设计灵魂.md) | IEEE 754 是工程妥协而非数学真理 |
| 1.4 | [字符串设计的灵魂](./1.4.字符串设计的灵魂.md) | 为何字符串要不可变？常量池、StringBuilder 的真正动机 |
| 1.5 | [值型变量和引用](./1.5.值型变量和引用.md) | 值传递、引用传递、共享可变状态的本源 |
| 1.6 | [泛型设计灵魂思想](./1.6.泛型设计灵魂思想.md) | 类型擦除 vs 单态化——同一个目标的两条工程路线 |
| 1.7 | [集合与容器设计原理](./1.7.集合与容器设计原理.md) | 数组 / 链表 / 哈希 / 树——一组关于时间空间的根本权衡 |
| 1.8 | [序列化数据的思想](./1.8.序列化数据的思想.md) | JSON / XML / Protobuf / Thrift 的体积与可读性 trade-off |
| 1.9 | [数据解析设计思想](./1.9.数据解析设计思想.md) | 词法 / 语法 / SIMD —— 解析器为何能差出 100 倍 |
