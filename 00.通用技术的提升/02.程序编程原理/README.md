...
### 🌍 序卷｜方法论与导读 · [📁 进入](00.序卷和方法论/)

> 不教知识，先教看世界的方法。决定后续 5 卷的吸收效率。

| 文档 | 核心问题 |
|------|---------|
| [专栏的导读和绪论](00.序卷和方法论/专栏的导读和绪论.md) | 为什么"看见设计"比"会用 API"更值钱 |
| [全专栏内容介绍](00.序卷和方法论/全专栏地图与索引) | 5 卷 50 篇全景式索引与学习路径 |

---

### 🔢 第 1 卷｜数据的本质（万物起源） · [📁 进入](01.第1卷数据本质/) · 9 篇

> 计算机如何用有限的位表示无限的信息——一切设计的起点。

| 序号 | 文档 | 核心矛盾 |
|------|------|---------|
| 1.1 | [数据编码设计原理](01.第1卷数据本质/1.1.数据编码设计原理.md) | 全人类文字如何在 0/1 上达成共识 |
| 1.2 | [整型与位运算原理](01.第1卷数据本质/1.2.整型与位运算原理.md) | 二进制补码的几何美学 |
| 1.3 | [浮点型数据设计灵魂](01.第1卷数据本质/1.3.浮点数据设计灵魂) | 为何 0.1+0.2≠0.3 |
| 1.4 | [字符串设计的灵魂](01.第1卷数据本质/1.4.字符串设计的灵魂.md) | 为何字符串要不可变 |
| 1.5 | [值型变量和引用](01.第1卷数据本质/1.5.值型变量和引用.md) | 值传递、引用传递的本质 |
| 1.6 | [泛型设计灵魂思想](01.第1卷数据本质/1.6.泛型设计灵魂思想.md) | 类型擦除 vs 单态化 |
| 1.7 | [集合与容器设计原理](01.第1卷数据本质/1.7.集合与容器设计原理.md) | 数组、链表、哈希、树的统一抽象 |
| 1.8 | [序列化数据的思想](01.第1卷数据本质/1.8.序列化数据的思想.md) | JSON / Protobuf / XML 的取舍 |
| 1.9 | [数据解析设计思想](01.第1卷数据本质/1.9.数据解析设计思想.md) | 解析器为何能差出 100 倍 |

---

### 🧬 第 2 卷｜运行时模型（从类到对象） · [📁 进入](02.第2卷运行模型/) · 8 篇

> 程序运行时究竟发生了什么？

| 序号 | 文档 | 核心矛盾 |
|------|------|---------|
| 2.1 | [类的加载核心原理](02.第2卷运行模型/2.1.类的加载核心原理.md) | 双亲委派为何而生 |
| 2.2 | [对象创建流程原理](02.第2卷运行模型/2.2.对象创建流程原理.md) | new 一个对象到底发生多少步 |
| 2.3 | [对象和函数访问原理](02.第2卷运行模型/2.3.对象和函数访问原理.md) | vtable / itable / 静态分派 |
| 2.4 | [函数调用栈与栈帧设计](02.第2卷运行模型/2.4.函数调用栈与栈帧设计.md) | 栈帧的物理布局与调用约定 |
| 2.5 | [字节码与虚拟机执行原理](02.第2卷运行模型/2.5.字节码与虚拟机执行原理.md) | 解释 vs 编译，VM 的执行引擎 |
| 2.6 | [JIT 与运行时优化](02.第2卷运行模型/2.6.JIT与运行时优化.md) | C2 / Graal 凭什么能"超过 C++" |
| 2.7 | [反射与元编程核心设计](02.第2卷运行模型/2.7.反射与元编程核心设计.md) | 反射 / Emit / Proxy 的共同本质 |
| 2.8 | [异常机制设计原理](02.第2卷运行模型/2.8.异常机制设计原理.md) | 异常从硬件中断到语言层 |
...
### 💾 第 4 卷｜内存的真相 · [📁 进入](04.第4卷内存真相/) · 8 篇

> 从虚拟内存到垃圾回收——理解程序运行的物理基础。

| 序号 | 文档 | 核心矛盾 |
|------|------|---------|
| 4.1 | [虚拟内存与地址空间](04.第4卷内存真相/4.1.虚拟内存与地址空间.md) | MMU / 页表 / TLB / COW —— 现代内存的根本骨架 |
| 4.2 | [内存模型技术设计](04.第4卷内存真相/4.2.内存模型技术设计.md) | 冯·诺依曼到现代 JMM 的演进 |
| 4.3 | [堆和栈内存的设计](04.第4卷内存真相/4.3.堆和栈内存的设计.md) | 栈帧、malloc、glibc chunk/bin |
| 4.4 | [内存对齐与缓存局部性](04.第4卷内存真相/4.4.内存对齐与缓存局部性.md) | Cache Line / Padding / 伪共享 |
| 4.5 | [内存回收机制设计](04.第4卷内存真相/4.5.内存回收机制设计.md) | 标记清除 → 分代 → ZGC |
| 4.6 | [多种引用技术设计](04.第4卷内存真相/4.6.多种引用技术设计.md) | 强 / 软 / 弱 / 虚引用 |
| 4.7 | [内存泄漏与诊断原理](04.第4卷内存真相/4.7.内存泄漏与诊断原理.md) | GC Roots / 支配树 / Heap Dump / Profiler |
| 4.8 | [数据拷贝设计原理](04.第4卷内存真相/4.8.数据拷贝设计原理.md) | 浅 / 深 / Copy-on-Write |

---

### 🖼 第 5 卷｜交互与系统 · [📁 进入](05.第5卷交互系统/) · 7 篇

> 从硬件触点到屏幕像素——用户交互背后的事件驱动架构。

| 序号 | 文档 | 核心矛盾 |
|------|------|---------|
| 5.1 | [窗口核心设计思想](05.第5卷交互系统/5.1.窗口核心设计思想.md) | 矩形 + 事件 + 坐标系 |
| 5.2 | [视图加载渲染设计](05.第5卷交互系统/5.2.视图加载渲染设计.md) | measure / layout / draw 三阶段 |
| 5.3 | [图形渲染管线原理](05.第5卷交互系统/5.3.图形渲染管线原理.md) | GPU 流水线 / VSync / 合成器 / Skia |
| 5.4 | [手势事件设计灵魂](05.第5卷交互系统/5.4.手势事件设计灵魂.md) | 触点流 → 状态机 → 手势语义 |
| 5.5 | [消息机制设计思想](05.第5卷交互系统/5.5.消息机制设计思想.md) | Handler / Looper / MessageQueue |
| 5.6 | [跨进程通信设计](05.第5卷交互系统/5.6.跨进程通信设计.md) | 进程隔离 vs 协作通信·管道/shm/Binder |
| 5.7 | [数据加密和解密](05.第5卷交互系统/5.7.数据加密和解密.md) | 对称 / 非对称 / 哈希 |
