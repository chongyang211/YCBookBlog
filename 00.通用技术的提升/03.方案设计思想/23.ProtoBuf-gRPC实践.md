# ProtoBuf与gRPC实践
#### 目录介绍
- [01.网络请求库背景](#01网络请求库背景)
    - [1.1 网络库的大背景](#11-网络库的大背景)
    - [1.2 网络库的对比](#12-网络库的对比)
    - [1.3 网络库收益分析](#13-网络库收益分析)
    - [1.4 学习计划说明](#14-学习计划说明)
- [02.ProtoBuf的介绍](#02protobuf的介绍)
    - [2.1 ProtoBuf是什么](#21-protobuf是什么)
    - [2.2 ProtoBuf和json](#22-protobuf和json)
    - [2.3 ProtoBuf问题思考](#23-protobuf问题思考)
    - [2.4 ProtoBuf优缺点](#24-protobuf优缺点)
    - [2.5 创建proto文件](#25-创建proto文件)
    - [2.6 ProtoBuf核心思想](#26-protobuf核心思想)
- [03.gRPC实践的介绍](#03grpc实践的介绍)
    - [3.1 gRPC简单介绍](#31-grpc简单介绍)
    - [3.2 为何要用gRPC](#32-为何要用grpc)
    - [3.3 gRPC定义服务](#33-grpc定义服务)
    - [3.4 gRPC生成代码](#34-grpc生成代码)
    - [3.5 gRPC如何使用](#35-grpc如何使用)
    - [3.6 同步和异步操作](#36-同步和异步操作)
    - [3.7 gRPC一些操作](#37-grpc一些操作)
- [04.gRPC通信实践](#04grpc通信实践)
    - [4.1 gRPC通信技术点](#41-grpc通信技术点)
    - [4.2 核心设计思路](#42-核心设计思路)
    - [4.3 定义ProtoBuf消息](#43-定义protobuf消息)
    - [4.4 请求/响应的读写](#44-请求响应的读写)
    - [4.5 网络日志打印](#45-网络日志打印)
    - [4.6 如何做网络缓存](#46-如何做网络缓存)
- [05.ProtoBuf核心原理](#05protobuf核心原理)
    - [5.1 ProtoBuf数据结构](#51-protobuf数据结构)
    - [5.2 ProtoBuf编码方式](#52-protobuf编码方式)
    - [5.3](#53) 
- [06.gRPC核心原理](#06grpc核心原理)
    - [6.1](#61) 
