# App磁盘沙盒实践
#### 目录介绍
- [01.磁盘沙盒的概述](#01磁盘沙盒的概述)
    - [1.1 项目背景说明](#11-项目背景说明)
    - [1.2 沙盒作用](#12-沙盒作用)
    - [1.3 设计目标](#13-设计目标)
    - [1.4 收益分析](#14-收益分析)
- [02.Android存储概念](#02android存储概念)
    - [2.1 存储划分介绍](#21-存储划分介绍)
    - [2.2 机身内部存储](#22-机身内部存储)
    - [2.3 机身外部存储](#23-机身外部存储)
    - [2.4 SD卡外部存储](#24-sd卡外部存储)
    - [2.5 总结和梳理下](#25-总结和梳理下)
    - [2.6 ADB导出日志](#26-adb导出日志)
- [03.方案基础设计](#03方案基础设计)
    - [3.1 整体架构图](#31-整体架构图)
    - [3.2 UML设计图](#32-uml设计图)
    - [3.3 关键流程图](#33-关键流程图)
    - [3.4 接口设计图](#34-接口设计图)
    - [3.5 模块间依赖关系](#35-模块间依赖关系)
- [04.一些技术要点说明](#04一些技术要点说明)
    - [4.1 使用队列管理Fragment栈](#41-使用队列管理fragment栈)
    - [4.2 File文件列表](#42-file文件列表)
    - [4.3 不同版本访问权限](#43-不同版本访问权限)
    - [4.4 访问文件操作](#44-访问文件操作)
    - [4.5 10和11权限说明](#45-10和11权限说明)
    - [4.6 分享文件给第三方](#46-分享文件给第三方)
    - [4.7 打开图片资源](#47-打开图片资源)
    - [4.8 为何需要FileProvider](#48-为何需要fileprovider)
    - [4.9 跨进程IPC通信](#49-跨进程ipc通信)
- [05.其他设计实践说明](#05其他设计实践说明)
    - [5.1 性能设计](#51-性能设计)
    - [5.2 稳定性设计](#52-稳定性设计)
    - [5.3 debug依赖设计](#53-debug依赖设计)
