...
- [01.整体概述](#01整体概述)
    ...
    - [1.4 设计目标](#14-设计目标)
    - [1.5 收益分析](#15-收益分析)
- [02.Window概念](#02window概念)
    - [2.1 Window添加View](#21-window添加view)
    - [2.2 Window的概念](#22-window的概念)
    - [2.3 LayoutParams](#23-layoutparams)
    - [2.4 WMS流程梳理](#24-wms流程梳理)
- [03.悬浮窗技术要点](#03悬浮窗技术要点)
    - [3.1 业务思考点分析](#31-业务思考点分析)
    - [3.2 关键技术要点](#32-关键技术要点)
    - [3.3 应用悬浮窗](#33-应用悬浮窗)
    - [3.4 添加浮窗源码流程](#34-添加浮窗源码流程)
    - [3.5 理解WMS原理](#35-理解wms原理)
    - [3.6 拖拽回弹吸附](#36-拖拽回弹吸附)
- [04.开发重要步骤](#04开发重要步骤)
    - [4.1 悬浮窗实现流程](#41-悬浮窗实现流程)
    - [4.2 请求悬浮窗权限](#42-请求悬浮窗权限)
    - [4.3 初始化悬浮窗](#43-初始化悬浮窗)
    - [4.4 设置悬浮窗参数](#44-设置悬浮窗参数)
    - [4.5 添加View到悬浮窗](#45-添加view到悬浮窗)
    - [4.6 悬浮窗拖拽实现](#46-悬浮窗拖拽实现)
    - [4.8 悬浮窗权限适配](#48-悬浮窗权限适配)
    - [4.9 LayoutParam坑](#49-layoutparam坑)
- [05.方案基础设计](#05方案基础设计)
    - [5.1 整体架构图](#51-整体架构图)
...
- [06.其他设计说明](#06其他设计说明)
    ...
    - [6.2 稳定性设计](#62-稳定性设计)
    - [6.3 异常设计](#63-异常设计)
    - [6.4 事件上报设计](#64-事件上报设计)
- [07.遇到的问题和坑](#07遇到的问题和坑)
    - [7.1 处理输入法层级关系](#71-处理输入法层级关系)
    - [7.2 边界逻辑关闭悬浮窗](#72-边界逻辑关闭悬浮窗)
    - [7.3 点击多次打开页面](#73-点击多次打开页面)
    - [7.4 Home键遇到的问题](#74-home键遇到的问题)
