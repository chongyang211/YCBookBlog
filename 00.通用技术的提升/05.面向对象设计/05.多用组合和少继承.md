# 05.多用组合和少继承
#### 目录介绍
- [01.前言思考的介绍](#01前言思考的介绍)
  - [1.1 组合优于继承思考](#11-组合优于继承思考)
  - [1.2 实际中的案例](#12-实际中的案例)
  - [1.3 思考继承的争议](#13-思考继承的争议)
- [02.绘图应用程序案例](#02绘图应用程序案例)
  - [2.1 案例的背景](#21-案例的背景)
  - [2.2 用继承实现多形状](#22-用继承实现多形状)
  - [2.3 用组合实现多形状](#23-用组合实现多形状)
- [03.不同鸟类程序案例](#03不同鸟类程序案例)
  - [3.1 案例的背景](#31-案例的背景)
  - [3.2 用继承实现多鸟类](#32-用继承实现多鸟类)
  - [3.3 继承的问题暴露](#33-继承的问题暴露)
  - [3.4 用组合实现多鸟类](#34-用组合实现多鸟类)
- [04.多组合少继承](#04多组合少继承)
  - [4.1 组合VS继承](#41-组合vs继承)
  - [4.2 多组合少继承场景](#42-多组合少继承场景)
  - [4.3 多组合少继承原因](#43-多组合少继承原因)
- [05.如何选择组合或继承](#05如何选择组合或继承)
  - [5.1 如何去选择](#51-如何去选择)
  - [5.2 使用组合方式](#52-使用组合方式)
  - [5.3 使用继承方式](#53-使用继承方式)
- [06.多组合少继承总结](#06多组合少继承总结)
