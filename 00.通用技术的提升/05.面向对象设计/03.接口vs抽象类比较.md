...
- [00.先回答上篇思考题](#00先回答上篇思考题)
  ...
  - [0.2 日志器被改了47次](#02-日志器被改了47次)
  - [0.3 五次反转排查](#03-五次反转排查)
  - [0.4 灵魂五连问](#04-灵魂五连问)
...
- [06.总结与延伸](#06总结与延伸)
- [07.综合实战案例](#07综合实战案例)
  - [7.1 支付网关接需求](#71-支付网关接需求)
  - [7.2 纯接口方案的坎](#72-纯接口方案的坎)
  - [7.3 抽象类提炼模板](#73-抽象类提炼模板)
  - [7.4 接口+抽象类双层](#74-接口抽象类双层)
  - [7.5 类图与时序图](#75-类图与时序图)
  - [7.6 留下三道思考题](#76-留下三道思考题)
- [08.认知跃迁总结](#08认知跃迁总结)
...
上一篇 [02.面向对象的特性](./02.面向对象的特性.md) 末尾留下了三道题：
