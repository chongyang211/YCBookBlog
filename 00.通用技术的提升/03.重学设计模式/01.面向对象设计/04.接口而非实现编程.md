...
#### 目录介绍
- [00.先回答上篇思考题](#00先回答上篇思考题)
  - [0.1 上篇遗留三道题](#01-上篇遗留三道题)
  - [0.2 云迁移6万行代码](#02-云迁移6万行代码)
  - [0.3 五次反转补锅](#03-五次反转补锅)
  - [0.4 灵魂五连问](#04-灵魂五连问)
...
- [07.总结与延伸](#07总结与延伸)
- [08.综合实战案例](#08综合实战案例)
  - [8.1 货运推送接需求](#81-货运推送接需求)
  - [8.2 依赖实现的崩塌](#82-依赖实现的崩塌)
  - [8.3 接口化三步重构](#83-接口化三步重构)
  - [8.4 类图与可测性](#84-类图与可测性)
...
上一篇 [03.接口vs抽象类比较](03.接口vs抽象类比较.md) 末尾留下了三道题：
...
下一篇 [05.多用组合和少继承](05.多用组合和少继承.md)——你会发现：接口能解决「调用方锁死」，但解不了「**多个能力拼装**」。后者需要 OOP 最被滥用也最被误解的机制：继承 vs 组合。