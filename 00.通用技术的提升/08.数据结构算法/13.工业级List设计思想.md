...
- [02.List设计的核心挑战](#02list设计的核心挑战)
- [03.ArrayList底层存储结构](#03arraylist底层存储结构)
- [04.添加元素与自动扩容](#04添加元素与自动扩容)
- [05.删除元素与内存泄漏](#05删除元素与内存泄漏)
- [06.随机访问与RandomAccess](#06随机访问与randomaccess)
- [07.线程安全与fail-fast](#07线程安全与fail-fast)
- [08.容量管理与扩容因子](#08容量管理与扩容因子)
- [09.ArrayList vs LinkedList工业级对比](#09arraylist-vs-linkedlist工业级对比)
