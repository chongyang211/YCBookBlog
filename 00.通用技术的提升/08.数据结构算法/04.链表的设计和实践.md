...
- [03.链表的多种分类](#03链表的多种分类)
  - [3.1 单链表使用](#31-单链表使用)
  - [3.2 双链表使用](#32-双链表使用)
  - [3.3 循环链表使用](#33-循环链表使用)
- [04.链表的性能分析](#04链表的性能分析)
  - [4.1 插入元素性能](#41-插入元素性能)
  - [4.2 删除元素性能](#42-删除元素性能)
  - [4.3 检索元素性能](#43-检索元素性能)
- [05.链表使用场景](#05链表使用场景)
  - [5.1 哪些用到链表](#51-哪些用到链表)
- [06.链表实际示例](#06链表实际示例)
  - [6.1 链表实现队列](#61-链表实现队列)
  - [6.2 实现浏览器记录](#62-实现浏览器记录)
  - [6.3 实现LRU缓存](#63-实现lru缓存)
