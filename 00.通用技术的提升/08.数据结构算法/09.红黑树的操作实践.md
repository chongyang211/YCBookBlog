...
- [02. 为什么 AVL 还不够](#02-为什么-avl-还不够)
- [03. 红黑树的五大性质](#03-红黑树的五大性质)
- [04. 旋转：保证有序的原子操作](#04-旋转保证有序的原子操作)
- [05. 插入与修复](#05-插入与修复)
- [06. 删除与修复](#06-删除与修复)
- [07. 红黑树的工业级应用](#07-红黑树的工业级应用)
- [08. 完整实现与复杂度](#08-完整实现与复杂度)
    ...
    while x is not self.root and x.color == BLACK:
        if x is x.parent.left:
            ...
            if s.color == RED:                                   # 情况1
                ...
                s = x.parent.right
            if s.left.color == BLACK and s.right.color == BLACK: # 情况2
                s.color = RED
                x = x.parent
            else:
...
class RedBlackTree:
    ...
    # _left_rotate / _right_rotate / _insert_fixup / delete / _delete_fixup
    # 见 05、06 章节
```
