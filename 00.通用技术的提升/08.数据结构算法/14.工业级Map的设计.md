...
- [02.Map设计的核心挑战](#02map设计的核心挑战)
- [03.HashMap三层存储结构](#03hashmap三层存储结构)
- [04.哈希函数与扰动设计](#04哈希函数与扰动设计)
- [05.put与扩容机制](#05put与扩容机制)
- [06.get与三层过滤查找](#06get与三层过滤查找)
- [07.remove与树退化](#07remove与树退化)
- [08.线程安全与ConcurrentHashMap演进](#08线程安全与concurrenthashmap演进)
- [09.容量规划与工程陷阱](#09容量规划与工程陷阱)
- [10.本篇收获与案例回扣](#10本篇收获与案例回扣)
- [11.思考题](#11思考题)
- [12.课后作业](#12课后作业)
