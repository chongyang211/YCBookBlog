...
- [02.Glide加载优化](#02glide加载优化)
  - [2.1 绑定生命周期](#21-绑定生命周期)
  - [2.2 避免使用圆角控件](#22-避免使用圆角控件)
  - [2.3 滑动列表图片优化](#23-滑动列表图片优化)
- [03.lint检查去除无效代码](#03lint检查去除无效代码)
- [04.代码规范优化](#04代码规范优化)
  - [4.1 避免创建不必要对象](#41-避免创建不必要对象)
  - [4.2 静态优于抽象](#42-静态优于抽象)
  - [4.3 常量使用static final](#43-常量使用static-final)
  - [4.4 基本数据类型优先](#44-基本数据类型优先)
- [05.View异常优化](#05view异常优化)
  - [5.1 自定义控件状态保存](#51-自定义控件状态保存)
  - [5.2 去除编译警告](#52-去除编译警告)
- [06.合理使用集合](#06合理使用集合)
...
- [08.Service使用优化](#08service使用优化)
  ...
  - [8.2 Service替代方案](#82-service替代方案)
- [09.线程优化说明](#09线程优化说明)
  - [9.1 创建Thread弊端](#91-创建thread弊端)
  - [9.2 为何要用线程池](#92-为何要用线程池)
  - [9.3 那些地方使用线程池](#93-那些地方使用线程池)
- [10.静态变量保存数据的风险](#10静态变量保存数据的风险)
- [11.如何查询重复库](#11如何查询重复库)
- [12.使用注解限定传入类型](#12使用注解限定传入类型)
- [13.懒加载优化](#13懒加载优化)
  - [13.1 什么是懒加载](#131-什么是懒加载)
  - [13.2 关于ViewPager与Fragment懒加载](#132-关于viewpager与fragment懒加载)
- [14.四种引用优化](#14四种引用优化)
- [15.反射优化](#15反射优化)
  - [15.1 反射的性能问题](#151-反射的性能问题)
  - [15.2 反射优化方案](#152-反射优化方案)
- [16.代码优化设计总结](#16代码优化设计总结)
  - [16.1 代码优化核心原则](#161-代码优化核心原则)
  - [16.2 跨平台代码优化对比](#162-跨平台代码优化对比)
  - [16.3 代码优化的常见误区](#163-代码优化的常见误区)
  - [16.4 代码质量检测工具](#164-代码质量检测工具)
- [17.跨平台代码优化对比](#17跨平台代码优化对比)
  - [17.1 各平台代码优化策略](#171-各平台代码优化策略)
  - [17.2 通用代码优化原则](#172-通用代码优化原则)
...
- 为什么必须重视编译警告
    ...
    警告数量      团队行为变化              后果
    ─────────────────────────────────────────────────
    0-10个        每个警告都被关注修复       代码质量高
    10-50个       新增警告不被注意           开始劣化
    50-200个      "反正已经有这么多了"       快速劣化
    200+个        完全无视警告               严重Bug隐藏其中
    
    真实案例: 某项目忽略了"unchecked cast"警告
    → 运行时ClassCastException → 线上崩溃率飙升0.5%
    ```
- 常见的淡黄色警告及处理方式
...
- 编译警告治理的优先级排序
    | 优先级 | 警告类型 | 风险等级 | 处理策略 |
    |-------|---------|---------|---------|
    | P0 | 资源未关闭(Resource leak) | 高-内存泄漏 | 立即修复 |
    | P0 | 可能的空指针(Nullable) | 高-崩溃 | 立即修复 |
    | P1 | 未检查类型转换(Unchecked) | 中-运行时异常 | 尽快修复 |
    | P2 | 废弃API(Deprecated) | 中-兼容性 | 版本迭代中修复 |
    | P3 | 未使用变量/导入(Unused) | 低-代码整洁 | Code Review时修复 |
