...
#### 目录介绍
- [00.工作案例引入](#00工作案例引入)
  - [0.1 一次 "CPU 很闲但 QPS 上不去" 的故障](#01-一次-cpu-很闲但-qps-上不去-的故障)
  - [0.2 初步结论](#02-初步结论)
  - [0.3 本文要回答的问题](#03-本文要回答的问题)
- [01.IO基础概念理解](#01io基础概念理解)
  - [1.1 什么是IO操作](#11-什么是io操作)
  - [1.2 为何IO是瓶颈](#12-为何io是瓶颈)
  - [1.3 IO操作的分类](#13-io操作的分类)
  - [1.4 用户态与内核态](#14-用户态与内核态)
  - [1.5 IO操作的本质流程](#15-io操作的本质流程)
- [02.阻塞与非阻塞IO](#02阻塞与非阻塞io)
  - [2.1 疑惑：程序读文件时CPU在干什么](#21-疑惑程序读文件时cpu在干什么)
  - [2.2 阻塞IO模型](#22-阻塞io模型)
  - [2.3 非阻塞IO模型](#23-非阻塞io模型)
  - [2.4 阻塞与非阻塞的本质区别](#24-阻塞与非阻塞的本质区别)
  - [2.5 案例：餐厅点餐理解两种模型](#25-案例餐厅点餐理解两种模型)
- [03.同步与异步IO](#03同步与异步io)
  - [3.1 疑惑：同步非阻塞和异步有什么区别](#31-疑惑同步非阻塞和异步有什么区别)
  - [3.2 同步IO的定义](#32-同步io的定义)
  - [3.3 异步IO的定义](#33-异步io的定义)
  - [3.4 四种IO模型对比](#34-四种io模型对比)
  - [3.5 论证：从系统调用看本质差异](#35-论证从系统调用看本质差异)
- [04.IO多路复用深度解析](#04io多路复用深度解析)
  - [4.1 疑惑：一个线程如何处理成千上万连接](#41-疑惑一个线程如何处理成千上万连接)
  - [4.2 IO多路复用的由来](#42-io多路复用的由来)
  - [4.3 select机制详解](#43-select机制详解)
  - [4.4 poll机制详解](#44-poll机制详解)
  - [4.5 epoll机制详解](#45-epoll机制详解)
  - [4.6 select/poll/epoll对比](#46-selectpollepoll对比)
  - [4.7 kqueue与IOCP](#47-kqueue与iocp)
  - [4.8 技术演变：从select到epoll的进化之路](#48-技术演变从select到epoll的进化之路)
- [05.零拷贝技术原理](#05零拷贝技术原理)
  - [5.1 疑惑：读文件发网络为何要拷贝四次](#51-疑惑读文件发网络为何要拷贝四次)
  - [5.2 传统IO的数据拷贝路径](#52-传统io的数据拷贝路径)
  - [5.3 mmap内存映射](#53-mmap内存映射)
  - [5.4 sendfile系统调用](#54-sendfile系统调用)
  - [5.5 splice与tee](#55-splice与tee)
  - [5.6 零拷贝在实际框架中的应用](#56-零拷贝在实际框架中的应用)
- [06.文件系统与IO](#06文件系统与io)
  - [6.1 文件描述符的本质](#61-文件描述符的本质)
  - [6.2 VFS虚拟文件系统](#62-vfs虚拟文件系统)
  - [6.3 Page Cache页缓存](#63-page-cache页缓存)
  - [6.4 直接IO与缓冲IO](#64-直接io与缓冲io)
  - [6.5 文件IO的写入保证](#65-文件io的写入保证)
- [07.网络IO架构演进](#07网络io架构演进)
  - [7.1 疑惑：高并发服务器如何设计](#71-疑惑高并发服务器如何设计)
  - [7.2 多进程模型](#72-多进程模型)
  - [7.3 多线程模型](#73-多线程模型)
  - [7.4 Reactor模式](#74-reactor模式)
  - [7.5 Proactor模式](#75-proactor模式)
  - [7.6 主流框架的IO模型选择](#76-主流框架的io模型选择)
  - [7.7 技术演变：从Apache到Nginx的架构革命](#77-技术演变从apache到nginx的架构革命)
- [08.IO性能优化实践](#08io性能优化实践)
  - [8.1 IO性能衡量指标](#81-io性能衡量指标)
  - [8.2 磁盘IO优化策略](#82-磁盘io优化策略)
  - [8.3 网络IO优化策略](#83-网络io优化策略)
  - [8.4 编程语言中的IO优化](#84-编程语言中的io优化)
- [09.综合案例：Nginx 响应一个静态文件请求](#09综合案例nginx-响应一个静态文件请求)
- [10.思考题与动手作业](#10思考题与动手作业)


## 00.工作案例引入

### 0.1 一次 "CPU 很闲但 QPS 上不去" 的故障
