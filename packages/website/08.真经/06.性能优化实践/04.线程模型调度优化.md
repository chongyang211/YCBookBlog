...
- **前置阅读**：
  - [`卷二·01 CPU 监控与分析`](https://yccoding.com/pages/af0b85/)（线程是 CPU 的使用者）
  - [`卷三·03 卡顿捕获与归因`](https://yccoding.com/pages/b16f1c/)（线程问题导致卡顿）
...
- [`卷二·01 CPU 监控与分析`](https://yccoding.com/pages/af0b85/)：线程是 CPU 的使用者
- [`卷二·02 内存监控与治理`](https://yccoding.com/pages/01936d/)：每个线程占栈 1MB
- [`卷二·03 OOM 与低内存治理`](https://yccoding.com/pages/ea200a/)：线程数耗尽是 D 类 OOM
- [`卷三·03 卡顿捕获与归因`](https://yccoding.com/pages/b16f1c/)：线程问题导致卡顿
- [`卷三·04 ANR 监控与治理`](https://yccoding.com/pages/3c584b/)：死锁 → ANR
- [`卷四·05 功耗与电量优化`](https://yccoding.com/pages/98337a/)：线程数 → 切换 → 功耗

---

> **下一篇预告**：[`卷二·05 进程与多进程优化`](https://yccoding.com/pages/890d67/) —— 比线程更重的"隔离"工具。
