...
- **前置阅读**：
  - [`卷二·02 内存监控与治理`](https://yccoding.com/pages/01936d/)（OOM 是内存治理失败的兜底信号）
...
- [`卷二·02 内存监控与治理`](https://yccoding.com/pages/01936d/)：OOM 是内存治理失败的兜底信号
- [`卷二·01 CPU 监控与分析`](https://yccoding.com/pages/af0b85/)：内存分配频率影响 GC，间接影响 OOM
- [`卷二·04 线程模型调度优化`](https://yccoding.com/pages/218aca/)：线程数耗尽是 D 类 OOM
- [`卷四·03 图片性能解码优化`](https://yccoding.com/pages/babc84/)：图片是 OOM 主要来源
- [`卷四·05 功耗与电量优化`](https://yccoding.com/pages/98337a/)：内存压力与功耗关联
- [`卷五·01 崩溃捕获设计实践`](https://yccoding.com/pages/2c813d/)：OOM 是崩溃的一种

---

> **下一篇预告**：[`卷二·04 线程模型调度优化`](https://yccoding.com/pages/218aca/) —— 把"线程"这个被滥用的工具用对。
