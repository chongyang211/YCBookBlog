...
# 第 10 章 部署与并发
#### 目录介绍
- [10.1 打包与分发](#101-打包与分发)
  - [10.1.1 setuptools 打包](#1011-setuptools-打包)
  - [10.1.2 发布到 PyPI](#1012-发布到-pypi)
  - [10.1.3 pyinstaller 打包](#1013-pyinstaller-打包)
  - [10.1.4 Docker 容器化](#1014-docker-容器化)
  - [10.1.5 版本管理策略](#1015-版本管理策略)
- [10.2 并发编程](#102-并发编程)
  - [10.2.1 GIL 简介](#1021-gil-简介)
  - [10.2.2 多线程用法](#1022-多线程用法)
  - [10.2.3 多进程用法](#1023-多进程用法)
  - [10.2.4 线程与进程池](#1024-线程与进程池)
  - [10.2.5 asyncio 异步](#1025-asyncio-异步)
  - [10.2.6 并发模型对比](#1026-并发模型对比)
- [10.3 新手陷阱](#103-新手陷阱)
- [10.4 综合思考题](#104-综合思考题)
...
[project.urls]
Homepage = "https://yccoding.com//my-utils"
```
