...
---
#### 目录介绍
  - [10.1.1 启动外部进程](#1011-启动外部进程)
  - [10.1.2 异步读取输出](#1012-异步读取输出)
  - [10.1.3 发送输入到进程](#1013-发送输入到进程)
  - [10.1.4 获取进程状态](#1014-获取进程状态)
  - [10.1.5 常用的信号](#1015-常用的信号)
  - [10.1.6 如何终止进程](#1016-如何终止进程)
  - [10.1.7 QProcess总结](#1017-qprocess总结)
- [10.2 进程环境变量](#102-进程环境变量)
  - [10.2.1 设置环境变量](#1021-设置环境变量)
  - [10.2.2 获取系统环境变量](#1022-获取系统环境变量)
  - [10.2.3 清空环境变量](#1023-清空环境变量)
