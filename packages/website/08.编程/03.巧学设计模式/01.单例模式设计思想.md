...
- [03.单例基础介绍](#03单例基础介绍)
  - [3.1 从四次失败中提炼的需求](#31-从四次失败中提炼的需求)
  - [3.2 单例模式的标准骨架](#32-单例模式的标准骨架)
  - [3.3 典型使用场景（用 AppConfig 验证）](#33-典型使用场景用-appconfig-验证)
- [04.六种实现对比](#04六种实现对比)
...
- [06.反面踩坑实录](#06反面踩坑实录)
  ...
  - [6.5 三套替代方案](#65-三套替代方案)
    - [方案①：依赖注入（推荐）](#方案依赖注入推荐)
    - [方案②：Spring Bean 单例](#方案spring-bean-单例)
    - [方案③：静态工具方法（仅当无状态时）](#方案静态工具方法仅当无状态时)
    - [三套方案选型决策](#三套方案选型决策)
- [07.决策树与选型](#07决策树与选型)
