...
- [2. 架构概览](#2-架构概览)
  ...
  - [2.3 链接器不在](#23-链接器不在)
- [3. 编译四阶段全景](#3-编译四阶段全景)
  - [3.1 预处理：.c → .i](#31-预处理：.c-→-.i)
  - [3.2 编译：.i → .s](#32-编译：.i-→-.s)
  - [3.3 汇编：.s → .o](#33-汇编：.s-→-.o)
  - [3.4 链接：.o → executable](#34-链接：.o-→-executable)
- [4. 六步流水线](#4-六步流水线)
  - [4.1 词法分析](#41-词法分析)
  - [4.2 语法分析：从令牌到AST](#42-语法分析：从令牌到AST)
  - [4.3 语义分析](#43-语义分析)
  - [4.4 中间代码生成：GIMPLE与SSA](#44-中间代码生成：GIMPLE与SSA)
  - [4.5 优化流水线](#45-优化流水线)
  - [4.6 代码生成](#46-代码生成)
- [5. 汇编读写实战](#5-汇编读写实战)
...
预处理器已经在 [第 12 章](https://yccoding.com/pages/cc012/) 详细讲解。这里做最小回顾——用一段代码跑完预处理：
