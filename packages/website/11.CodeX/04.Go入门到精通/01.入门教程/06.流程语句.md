---
title: 流程语句
date: 2026-05-21 20:06:38
permalink: /pages/79a386/
categories:
  - book
  - Go入门到精通
  - 入门教程
...
> ➡ 卷三第 12 章 [迭代器与 range func](https://yccoding.com/pages/39644a/) 详讲。
...
### 卷内
- 第 5 章 [复合类型](https://yccoding.com/pages/dbb4ca/)（map 遍历的随机性）
- 第 7 章 [函数](https://yccoding.com/pages/d2b384/)（`defer` 替代 goto cleanup）
- 第 12 章 [并发 goroutine](https://yccoding.com/pages/f7872e/)（`select` 详讲）
- 第 13 章 [通道 channel](https://yccoding.com/pages/8dba21/)（`for range ch`）

### 跨卷
- 卷三第 12 章 [迭代器与 range func](https://yccoding.com/pages/39644a/)（Go 1.23 新特性）
