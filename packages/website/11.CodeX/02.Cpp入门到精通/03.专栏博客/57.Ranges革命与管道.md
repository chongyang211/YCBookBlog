---
title: Ranges革命与管道
date: 2026-06-06 14:37:12
permalink: /pages/ce479f/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：数据处理管道说清了。下一篇进入 [58.format与print体系](https://yccoding.com/pages/766386/)——`std::format` 语法、扩展格式化、locale 无关、与 `printf`/`iostream` 性能对比——把 C++ 的输入输出也现代化。
