...
> **下一篇**：ODR 保证了「定义一致」——但符号的可见性决定了「谁可以看到这些符号」。下一篇进入 [52.动态库与符号可见性](https://yccoding.com/pages/5aae0c/)——`-fvisibility=hidden`、`__attribute__((visibility))`、PLT/GOT、`dlopen/dlsym`——把符号暴露控制在需要的最小范围。
