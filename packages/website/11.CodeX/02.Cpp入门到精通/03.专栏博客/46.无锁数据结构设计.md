---
title: 无锁数据结构设计
date: 2026-06-06 11:32:27
permalink: /pages/286978/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：无锁结构把原子操作和内存序用到了极致。下一篇进入卷六收官篇 [47.协程coroutine原理](https://yccoding.com/pages/5a4d43/)——C++20 协程三角（promise_type/awaiter/handle）、栈less协程、co_await/co_yield/co_return——把异步从「线程」抽象到「函数暂停与恢复」的新一层。
