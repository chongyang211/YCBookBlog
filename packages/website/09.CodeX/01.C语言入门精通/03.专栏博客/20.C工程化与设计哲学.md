...
- [3. 编译单元与链接属性](#3-编译单元与链接属性)
  ...
  - [3.2 `static` 封装：不让外面看到](#32-`static`-封装：不让外面看到)
  - [3.3 `extern` 暴露：让外面能看到](#33-`extern`-暴露：让外面能看到)
...
- [4. Opaque Pointer 信息隐藏](#4-Opaque-Pointer-信息隐藏)
  ...
  - [4.3 编译防火墙](#43-编译防火墙)
  - [4.4 真实案例：从公开 struct 到 Opaque](#44-真实案例：从公开-struct-到-Opaque)
- [5. 接口与实现分离](#5-接口与实现分离)
...
- [6. 四卷 20 篇知识体系回望](#6-四卷-20-篇知识体系回望)
  - [6.1 卷1语法基础](#61-卷1语法基础)
  - [6.2 卷2底层原理](#62-卷2底层原理)
  - [6.3 卷3编译工程](#63-卷3编译工程)
  - [6.4 卷4运行时](#64-卷4运行时)
- [7. C 设计哲学终章回顾](#7-C-设计哲学终章回顾)
  - [7.1 信任程序员](#71-信任程序员)
  - [7.2 零成本抽象 vs 类型安全](#72-零成本抽象-vs-类型安全)
  - [7.3 简洁即力量：KISS in C](#73-简洁即力量：KISS-in-C)
  - [7.4 C 的"不适用的场景"](#74-C-的"不适用的场景")
- [8. 综合案例串讲](#8-综合案例串讲)
  - [8.1 案例真相揭晓](#81-案例真相揭晓)
  - [8.2 单文件到工程](#82-单文件到工程)
