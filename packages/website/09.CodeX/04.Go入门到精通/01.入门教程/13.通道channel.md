...
| 本章概念 | 卷三对应篇 |
|---|---|
| `make(chan T)` 创建的 `hchan` 结构 | [09.通道 channel 源码剖析](https://yccoding.com/pages/6e9697/) |
| 环形缓冲区、sendq/recvq 等待队列 | [09.通道 channel 源码剖析](https://yccoding.com/pages/6e9697/) |
| `select` 的随机化实现（`runtime.selectgo`） | [09.通道 channel 源码剖析](https://yccoding.com/pages/6e9697/) |
| channel 与 GMP 调度器的交互 | [08.GMP 协程调度器机制](https://yccoding.com/pages/08cdd1/) |
| `close(ch)` 的底层状态变更 | [09.通道 channel 源码剖析](https://yccoding.com/pages/6e9697/) |
...
- 入门卷：[第 12 章 并发 goroutine](https://yccoding.com/pages/f7872e/)——goroutine 起步、WaitGroup、context
- 入门卷：[第 14 章 sync 包](https://yccoding.com/pages/e36f54/)——Mutex、RWMutex、Once、Pool
- 卷三：[09.通道 channel 源码剖析](https://yccoding.com/pages/6e9697/)——hchan 结构、send/recv/close 源码级拆解
- 卷三：[08.GMP 协程调度器机制](https://yccoding.com/pages/08cdd1/)——goroutine 如何被调度
- 卷三：[16.并发设计模式详解](https://yccoding.com/pages/go-conc-patterns/)——Pipeline、Fan-out/Fan-in 源码级讲解
