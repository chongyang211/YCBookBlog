---
title: 拷贝与移动控制
date: 2026-06-05 20:41:58
permalink: /pages/cbc04f/
categories:
  - book
  - Cpp入门到精通
  - 专栏博客
...
> **下一篇**：拷贝控制的理论说清了。下一篇进入 [28.unique_ptr 原理剖析](https://yccoding.com/pages/425bb9/)——独占语义的零成本实现：deleter 的类型擦除如何做到零 sizeof 开销、`make_unique` 为什么比 `new` 更安全、数组版本 `unique_ptr<T[]>` 与 `shared_ptr<T[]>` 的差异。
