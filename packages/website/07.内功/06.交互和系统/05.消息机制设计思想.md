...
- [9.性能优化](#9性能优化)
  ...
  - [9.4 空闲回调](#94-idlehandler-巧设)
  - [9.5 典型陷阱与反模式](#95-典型陷阱与反模式)
    - [Handler泄漏](#陷阱一androidhandler-内存泄漏)
    - [ANR三宗罪](#陷阱二android主线程-anr-三宗罪)
    - [Mode误用](#陷阱三iosrunloop-mode-误用)
    - [微任务死循](#陷阱四webmicrotask-死循环饿死宏任务)
    - [单帧超时](#陷阱五flutter单帧超时导致-jank)
    - [定时器反转](#陷阱六嵌入式定时器优先级反转)
- [10.总结与演进](#10总结与演进)
