...
帮我写一份消息事件机制的技术设计文档，在Android，iOS等都有消息机制，技术方案要求详细、完整，而且有架构图、时序图等图表，图片使用mermaid画，最终结果需要输出到一份markdown文档中。

1.为什么要设计消息机制，背景是什么，主要为了解决什么问题？
2.消息机制中的消息，是如何设计的，有同步消息和异步消息，设计理念和原理是什么？
3.消息是如何发送，是怎么进行管理消息，一般有消息队列，这个消息队列是如何设计的？
4.消息的发送和处理，这种消息处理者是如何设计的？
5.消息泵，一般指looper，looper设计思想是什么？它是如何从消息队列中取出消息，然后分发消息？应用可以有多个Looper吗？为什么？
