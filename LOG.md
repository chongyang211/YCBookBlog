...
在很多端，比如Android，iOS，前端web，都会涉及到架构设计。帮我抽象通用的架构设计方案，技术方案要求详细、完整，而且有架构图、时序图等图表，图片使用mermaid画，最终结果需要输出到一份markdown文档中。

1.为什么要做架构设计，主要解决什么问题？
2.架构设计核心思想是什么？
3.架构设计的通用能力是什么，如何设计分层，其通用思想是什么？
4.架构演变过程，比如MVC，MVP，MVVM，说一下每一种架构设计灵魂和思想，用案例来说一下优缺点？
5.在架构设计中需要注意什么问题？
