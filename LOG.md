...
帮我写一篇 JavaScript 如何做性能优化 技术文档。要求详细、完整，而且有架构图、时序图等图表，图片使用mermaid画，最终结果需要输出到一份markdown文档中。

1. 函数执行机制深度解析
2. 闭包的内存模型，低层实现原理


以IotService为入口，帮我分析 iot服务核心流程，指令处理，OTA，上报等。可以多阅读代码。要求详细、完整，而且有架构图、时序图等图表，图片使用mermaid画，最终结果需要输出到一份markdown文档中。

1.iot服务核心流程设计流程，思想，原理
2.指令处理流程是什么
3.OTA如何触发，处理流程
4.上报流程
5.每一段分析可以补充一些简单代码辅助
